/**
 * renderers/input-boolean-card.js - Renderer for input_boolean entities.
 *
 * Identical semantics to SwitchCard: a toggle button and state label.
 * Uses the input_boolean turn_on/turn_off/toggle ALLOWED_SERVICES.
 */
