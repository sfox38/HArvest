(()=>{var Jr=(y,g,l)=>{if(!g.has(y))throw TypeError("Cannot "+l)};var t=(y,g,l)=>(Jr(y,g,"read from private field"),l?l.call(y):g.get(y)),r=(y,g,l)=>{if(g.has(y))throw TypeError("Cannot add the same private member more than once");g instanceof WeakSet?g.add(y):g.set(y,l)},n=(y,g,l,Rt)=>(Jr(y,g,"write to private field"),Rt?Rt.call(y,l):g.set(y,l),l);var h=(y,g,l)=>(Jr(y,g,"access private method"),l);(function(){"use strict";var jt,E,Ti,I,ot,_,Y,Te,qe,ht,Lt,dt,lt,te,De,G,ct,ee,qi,Ie,Kr,jn,A,dr,ys,lr,xs,cr,ws,pr,Cs,Pe,Br,ze,Rr,ur,_s,ie,sr,vr,As,fr,Ss,Di,Qr,Ii,ts,mr,$s,it,j,gr,P,Be,V,pt,ut,vt,z,S,Vt,kt,B,$,re,Re,Pi,je,jr,se,nr,zi,es,Ve,Vr,Bi,is,Ri,rs,Ot,Mi,br,Ls,yr,ks,ji,ss,Vi,ns,xr,Ms,Oi,as,wr,Hs,U,Mt,ft,Oe,Ft,Fe,Ne,Ze,O,F,We,Ye,Ge,Ue,Ht,Xe,ne,N,mt,Ke,Je,Qe,gt,Nt,ae,ti,ei,ii,ri,si,Fi,ni,Ni,os,Cr,Es,_r,Ts,ai,Or,Zi,hs,oi,Fr,Ar,qs,Sr,Ds,Wi,ds,Yi,ls,$r,Is,Lr,Ps,bt,oe,he,yt,L,de,le,ce,Et,xt,Gi,Ui,Xi,hi,Nr,kr,zs,pe,Tt,T,D,di,Zt,Wt,qt,q,X,rt,Dt,Yt,Mr,Bs,Hr,Rs,Gt,Hi,li,Zr,Er,js,Ut,Ei,ci,wt,Ki,It,ue,Tr,Vs,Ji,cs,Pt,pi,ui,ve,fe,Ct,k,me,ge,be,_t,zt,ye,xe,Qi,vi,Wr,qr,Os,fi,mi,gi,At,bi,we,J,Bt,Xt,Kt,Ce,yi,xi,st,wi,Dr,Fs,Ir,Ns,Pr,Zs,_e,ar,Ci,St,Ae,Se,_i,$e,Ai,Si,$i,Li,Q,$t,tt,ki,Z,Jt,Yr,Le,ke,tr,ps,er,us,ir,vs,zr,Ws;const y=window.HArvest;if(!y||!y.renderers||!y.renderers.BaseCard){console.warn("[HArvest Minimus] HArvest not found - pack not loaded.");return}const g=y.renderers.BaseCard;function l(p){return String(p??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Rt(p,v){let e=null;return function(...i){e&&clearTimeout(e),e=setTimeout(()=>{e=null,p.apply(this,i)},v)}}function Me(p){return p?p.charAt(0).toUpperCase()+p.slice(1).replace(/_/g," "):""}const K=`
    [part=companion-zone] {
      display: flex;
      flex-wrap: wrap;
  ...
  `;function W(p){p.querySelectorAll("[part=companion]").forEach(v=>{v.title=v.getAttribute("aria-label")??""})}const Ys=60,Gs=60,Qt=48,R=225,C=270,at=2*Math.PI*Qt*(C/360);function Us(p){return p*Math.PI/180}function et(p){const v=Us(p);return{x:Ys+Qt*Math.cos(v),y:Gs-Qt*Math.sin(v)}}function Xs(){const p=et(R),v=et(R-C);return`M ${p.x} ${p.y} A ${Qt} ${Qt} 0 1 1 ${v.x} ${v.y}`}const He=Xs(),Ee=["brightness","temp","color"],or=120;function fs(p){const v=C/or;let e="";for(let i=0;i<or;i++){const s=R-i*v,a=R-(i+1)*v,o=et(s),c=et(a),d=`M ${o.x} ${o.y} A ${Qt} ${Qt} 0 0 1 ${c.x} ${c.y}`,u=i===0||i===or-1?"round":"butt";e+=`<path d="${d}" stroke="${p(i/or)}" fill="none" stroke-width="8" stroke-linecap="${u}" />`}return e}const Ks=fs(p=>`hsl(${Math.round(p*360)},100%,50%)`),Js=fs(p=>{const e=Math.round(143+112*p),i=Math.round(255*p);return`rgb(255,${e},${i})`}),Gr=`
    [part=card] {
  ...
  `;class tn extends g{constructor(e,i,s,a){super(e,i,s,a);r(this,Kr);r(this,dr);r(this,lr);r(this,cr);r(this,pr);r(this,Pe);r(this,ze);r(this,ur);r(this,ie);r(this,vr);r(this,fr);r(this,Di);r(this,Ii);r(this,mr);r(this,jt,null);r(this,E,null);r(this,Ti,null);r(this,I,null);r(this,ot,null);r(this,_,null);r(this,Y,null);r(this,Te,null);r(this,qe,null);r(this,ht,0);r(this,Lt,4e3);r(this,dt,0);r(this,lt,!1);r(this,te,!1);r(this,De,null);r(this,G,0);r(this,ct,2e3);r(this,ee,6500);r(this,qi,void 0);r(this,Ie,new Map);r(this,A,[]);n(this,qi,Rt(h(this,mr,$s).bind(this),300))}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],s=this.config.displayHints??{},a=s.show_brightness!==!1&&i.includes("brightness"),o=s.show_color_temp!==!1&&i.includes("color_temp"),c=s.show_rgb!==!1&&i.includes("rgb_color"),d=e&&(a||o||c),u=[a,o,c].filter(Boolean).length,f=e&&u>1;n(this,ct,this.def.feature_config?.min_color_temp_kelvin??2e3),n(this,ee,this.def.feature_config?.max_color_temp_kelvin??6500);const x=et(R);this.root.innerHTML=`
        <style>${this.getSharedStyles()}${Gr}${Qs}</style>
        <div part="card">
              ...
              <div class="hrv-dial-column">
                <div class="hrv-dial-wrap" role="slider" aria-valuemin="0"
                  ...
                  <svg viewBox="0 0 120 120">
                    <g class="hrv-dial-segs hrv-dial-segs-color">${Ks}</g>
      ...
      `,n(this,jt,this.root.querySelector("[part=toggle-button]")),n(this,E,this.root.querySelector(".hrv-dial-fill")),n(this,Ti,this.root.querySelector(".hrv-dial-track")),n(this,I,this.root.querySelector(".hrv-dial-thumb")),n(this,ot,this.root.querySelector(".hrv-dial-pct")),n(this,_,this.root.querySelector(".hrv-dial-wrap")),n(this,De,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,Te,this.root.querySelector(".hrv-dial-segs-color")),n(this,qe,this.root.querySelector(".hrv-dial-segs-temp")),n(this,Y,this.root.querySelector(".hrv-mode-switch")),t(this,jt)&&this._attachGestureHandlers(t(this,jt),{onTap:()=>{const b=this.config.gestureConfig?.tap;if(b){this._runAction(b);return}this.config.card?.sendCommand("toggle",{})}}),t(this,_)&&(t(this,_).addEventListener("pointerdown",h(this,vr,As).bind(this)),t(this,_).addEventListener("pointermove",h(this,fr,Ss).bind(this)),t(this,_).addEventListener("pointerup",h(this,Di,Qr).bind(this)),t(this,_).addEventListener("pointercancel",h(this,Di,Qr).bind(this))),d&&h(this,dr,ys).call(this),t(this,Y)&&(t(this,Y).addEventListener("click",h(this,lr,xs).bind(this)),t(this,Y).addEventListener("keydown",h(this,pr,Cs).bind(this)),t(this,Y).addEventListener("mousemove",h(this,cr,ws).bind(this))),h(this,ze,Rr).call(this),this.root.querySelector("[part=ro-state-icon]")&&this.renderIcon(this.resolveIcon(this.def.icon,"mdi:lightbulb"),"ro-state-icon"),this.renderCompanions(),this.root.querySelectorAll("[part=companion]").forEach(b=>{b.title=b.getAttribute("aria-label")??"Companion";const M=b.getAttribute("data-entity");if(M&&t(this,Ie).has(M)){const w=t(this,Ie).get(M);b.setAttribute("data-on",String(w==="on"))}})}applyState(e,i){if(n(this,lt,e==="on"),n(this,ht,i?.brightness??0),i?.color_temp_kelvin!==void 0?n(this,Lt,i.color_temp_kelvin):i?.color_temp!==void 0&&i.color_temp>0&&n(this,Lt,Math.round(1e6/i.color_temp)),i?.hs_color)n(this,dt,Math.round(i.hs_color[0]));else if(i?.rgb_color){const[a,o,c]=i.rgb_color;n(this,dt,sn(a,o,c))}t(this,jt)&&t(this,jt).setAttribute("aria-pressed",String(t(this,lt)));const s=this.root.querySelector(".hrv-light-ro-circle");if(s){s.setAttribute("data-on",String(t(this,lt)));const a=t(this,lt)?"mdi:lightbulb":"mdi:lightbulb-outline",o=this.def.icon_state_map?.[e]??this.def.icon_state_map?.["*"]??this.def.icon??a;this.renderIcon(this.resolveIcon(o,a),"ro-state-icon");const c=i?.color_mode,d=c==="color_temp",u=c&&c!=="color_temp",f=this.root.querySelector('[data-attr="brightness"]');if(f){const M=Math.round(t(this,ht)/255*100);f.title=t(this,lt)?`Brightness: ${M}%`:"Brightness: off"}const x=this.root.querySelector('[data-attr="temp"]');x&&(x.title=`Color temperature: ${t(this,Lt)}K`,x.style.display=u?"none":"");const b=this.root.querySelector('[data-attr="color"]');if(b)if(b.style.display=d?"none":"",i?.rgb_color){const[M,w,rr]=i.rgb_color;b.style.background=`rgb(${M},${w},${rr})`,b.title=`Color: rgb(${M}, ${w}, ${rr})`}else b.style.background=`hsl(${t(this,dt)}, 100%, 50%)`,b.title=`Color: hue ${t(this,dt)}°`}h(this,Pe,Br).call(this)}predictState(e,i){return e==="toggle"?{state:t(this,lt)?"off":"on",attributes:{brightness:t(this,ht)}}:e==="turn_on"&&i.brightness!==void 0?{state:"on",attributes:{brightness:i.brightness}}:null}updateCompanionState(e,i,s){t(this,Ie).set(e,i),super.updateCompanionState(e,i,s)}}jt=new WeakMap,E=new WeakMap,Ti=new WeakMap,I=new WeakMap,ot=new WeakMap,_=new WeakMap,Y=new WeakMap,Te=new WeakMap,qe=new WeakMap,ht=new WeakMap,Lt=new WeakMap,dt=new WeakMap,lt=new WeakMap,te=new WeakMap,De=new WeakMap,G=new WeakMap,ct=new WeakMap,ee=new WeakMap,qi=new WeakMap,Ie=new WeakMap,Kr=new WeakSet,jn=function(){const e=this.def.supported_features??[],i=[];return e.includes("brightness")&&i.push("brightness"),e.includes("color_temp")&&i.push("temp"),e.includes("rgb_color")&&i.push("color"),i.length>0?i:["brightness"]},A=new WeakMap,dr=new WeakSet,ys=function(){const e=this.def.supported_features??[],i=[e.includes("brightness"),e.includes("color_temp"),e.includes("rgb_color")];n(this,A,[]),i[0]&&t(this,A).push(0),i[1]&&t(this,A).push(1),i[2]&&t(this,A).push(2),t(this,A).length===0&&t(this,A).push(0),t(this,A).includes(t(this,G))||n(this,G,t(this,A)[0])},lr=new WeakSet,xs=function(e){const i=t(this,Y).getBoundingClientRect(),s=e.clientY-i.top,a=i.height/3;let o;s<a?o=0:s<a*2?o=1:o=2,o=Math.min(o,t(this,A).length-1),n(this,G,t(this,A)[o]),t(this,Y).setAttribute("data-pos",String(o)),h(this,ze,Rr).call(this),h(this,Pe,Br).call(this)},cr=new WeakSet,ws=function(e){const i={brightness:"Brightness",temp:"Color Temperature",color:"Color"},s=t(this,Y).getBoundingClientRect(),a=Math.min(Math.floor((e.clientY-s.top)/(s.height/t(this,A).length)),t(this,A).length-1),o=Ee[t(this,A)[Math.max(0,a)]];t(this,Y).title=`Dial mode: ${i[o]??o}`},pr=new WeakSet,Cs=function(e){const i=t(this,A).indexOf(t(this,G));let s=i;if(e.key==="ArrowUp"||e.key==="ArrowLeft")s=Math.max(0,i-1);else if(e.key==="ArrowDown"||e.key==="ArrowRight")s=Math.min(t(this,A).length-1,i+1);else return;e.preventDefault(),n(this,G,t(this,A)[s]),t(this,Y).setAttribute("data-pos",String(s)),h(this,ze,Rr).call(this),h(this,Pe,Br).call(this)},Pe=new WeakSet,Br=function(){t(this,I)&&(t(this,I).style.transition="none"),t(this,E)&&(t(this,E).style.transition="none"),h(this,ur,_s).call(this),t(this,I)?.getBoundingClientRect(),t(this,E)?.getBoundingClientRect(),t(this,I)&&(t(this,I).style.transition=""),t(this,E)&&(t(this,E).style.transition="")},ze=new WeakSet,Rr=function(){if(!t(this,E))return;const e=Ee[t(this,G)],i=e==="color"||e==="temp";t(this,Ti).style.display=i?"none":"",t(this,E).style.display=i?"none":"",t(this,Te)&&t(this,Te).classList.toggle("hrv-dial-segs-visible",e==="color"),t(this,qe)&&t(this,qe).classList.toggle("hrv-dial-segs-visible",e==="temp"),e==="brightness"&&t(this,E).setAttribute("stroke-dasharray",String(at));const s={brightness:"brightness",temp:"color temperature",color:"color"},a={brightness:"Drag to adjust brightness",temp:"Drag to adjust color temperature",color:"Drag to adjust color"};t(this,_)?.setAttribute("aria-label",`${l(this.def.friendly_name)} ${s[e]}`),t(this,_)&&(t(this,_).title=a[e])},ur=new WeakSet,_s=function(){const e=Ee[t(this,G)];if(e==="brightness"){const i=t(this,lt)?t(this,ht):0;h(this,ie,sr).call(this,Math.round(i/255*100))}else if(e==="temp"){const i=Math.round((t(this,Lt)-t(this,ct))/(t(this,ee)-t(this,ct))*100);h(this,ie,sr).call(this,Math.max(0,Math.min(100,i)))}else{const i=Math.round(t(this,dt)/360*100);h(this,ie,sr).call(this,i)}},ie=new WeakSet,sr=function(e){const i=Ee[t(this,G)],s=e/100*C,a=et(R-s);if(t(this,I)?.setAttribute("cx",String(a.x)),t(this,I)?.setAttribute("cy",String(a.y)),t(this,De)?.setAttribute("cx",String(a.x)),t(this,De)?.setAttribute("cy",String(a.y)),i==="brightness"){const o=at*(1-e/100);t(this,E)?.setAttribute("stroke-dashoffset",String(o)),t(this,ot)&&(t(this,ot).textContent=e+"%"),t(this,_)?.setAttribute("aria-valuenow",String(e))}else if(i==="temp"){const o=Math.round(t(this,ct)+e/100*(t(this,ee)-t(this,ct)));t(this,ot)&&(t(this,ot).textContent=o+"K"),t(this,_)?.setAttribute("aria-valuenow",String(o))}else t(this,ot)&&(t(this,ot).textContent=Math.round(e/100*360)+"°"),t(this,_)?.setAttribute("aria-valuenow",String(Math.round(e/100*360)))},vr=new WeakSet,As=function(e){n(this,te,!0),t(this,_)?.setPointerCapture(e.pointerId),h(this,Ii,ts).call(this,e)},fr=new WeakSet,Ss=function(e){t(this,te)&&h(this,Ii,ts).call(this,e)},Di=new WeakSet,Qr=function(e){if(t(this,te)){n(this,te,!1);try{t(this,_)?.releasePointerCapture(e.pointerId)}catch{}t(this,qi).call(this)}},Ii=new WeakSet,ts=function(e){if(!t(this,_))return;const i=t(this,_).getBoundingClientRect(),s=i.left+i.width/2,a=i.top+i.height/2,o=e.clientX-s,c=-(e.clientY-a);let d=Math.atan2(c,o)*180/Math.PI;d<0&&(d+=360);let u=R-d;u<0&&(u+=360),u>C&&(u=u>C+(360-C)/2?0:C);const f=Math.round(u/C*100),x=Ee[t(this,G)];x==="brightness"?n(this,ht,Math.round(f/100*255)):x==="temp"?n(this,Lt,Math.round(t(this,ct)+f/100*(t(this,ee)-t(this,ct)))):n(this,dt,Math.round(f/100*360)),t(this,E)&&(t(this,E).style.transition="none"),t(this,I)&&(t(this,I).style.transition="none"),h(this,ie,sr).call(this,f)},mr=new WeakSet,$s=function(){t(this,E)&&(t(this,E).style.transition=""),t(this,I)&&(t(this,I).style.transition="");const e=Ee[t(this,G)];e==="brightness"?t(this,ht)===0?this.config.card?.sendCommand("turn_off",{}):this.config.card?.sendCommand("turn_on",{brightness:t(this,ht)}):e==="temp"?this.config.card?.sendCommand("turn_on",{color_temp_kelvin:t(this,Lt)}):this.config.card?.sendCommand("turn_on",{hs_color:[t(this,dt),100]})};const en=Gr+`
    .hrv-fan-feat-btn {
      width: 40px;
      height: 40px;
      border-radius: 50%;
  ...
  `;class rn extends g{constructor(e,i,s,a){super(e,i,s,a);r(this,je);r(this,se);r(this,zi);r(this,Ve);r(this,Bi);r(this,Ri);r(this,Ot);r(this,br);r(this,yr);r(this,ji);r(this,Vi);r(this,xr);r(this,Oi);r(this,wr);r(this,it,null);r(this,j,null);r(this,gr,null);r(this,P,null);r(this,Be,null);r(this,V,null);r(this,pt,null);r(this,ut,null);r(this,vt,null);r(this,z,!1);r(this,S,0);r(this,Vt,!1);r(this,kt,"forward");r(this,B,null);r(this,$,[]);r(this,re,!1);r(this,Re,null);r(this,Pi,void 0);n(this,Pi,Rt(h(this,xr,Ms).bind(this),300)),n(this,$,e.feature_config?.preset_modes??[])}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],s=this.config.displayHints??this.def.display_hints??{},a=s.display_mode??null;let o=i.includes("set_speed");const c=s.show_oscillate!==!1&&i.includes("oscillate"),d=s.show_direction!==!1&&i.includes("direction"),u=s.show_presets!==!1&&i.includes("preset_mode");a==="on-off"&&(o=!1);let f=e&&o,x=f&&t(this,se,nr),b=x&&!t(this,$).length,M=x&&!!t(this,$).length;a==="continuous"?(x=!1,b=!1,M=!1):a==="stepped"?(M=!1,b=x&&!t(this,$).length):a==="cycle"&&(x=!0,M=!0,b=!1);const w=et(R);this.root.innerHTML=`
        <style>${this.getSharedStyles()}${en}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${l(this.def.friendly_name)}</span>
          </div>
      ...
      `,n(this,it,this.root.querySelector("[part=toggle-button]")),n(this,j,this.root.querySelector(".hrv-dial-fill")),n(this,gr,this.root.querySelector(".hrv-dial-track")),n(this,P,this.root.querySelector(".hrv-dial-thumb")),n(this,Be,this.root.querySelector(".hrv-dial-pct")),n(this,V,this.root.querySelector(".hrv-dial-wrap")),n(this,Re,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,pt,this.root.querySelector('[data-feat="oscillate"]')),n(this,ut,this.root.querySelector('[data-feat="direction"]')),n(this,vt,this.root.querySelector('[data-feat="preset"]')),t(this,it)&&!f&&(this.renderIcon(this.def.icon??"mdi:fan","fan-onoff-icon"),t(this,it).setAttribute("data-animate",String(!!this.config.animate))),this._attachGestureHandlers(t(this,it),{onTap:()=>{const m=this.config.gestureConfig?.tap;if(m){this._runAction(m);return}this.config.card?.sendCommand("toggle",{})}}),t(this,V)&&(t(this,V).addEventListener("pointerdown",h(this,br,Ls).bind(this)),t(this,V).addEventListener("pointermove",h(this,yr,ks).bind(this)),t(this,V).addEventListener("pointerup",h(this,ji,ss).bind(this)),t(this,V).addEventListener("pointercancel",h(this,ji,ss).bind(this))),this.root.querySelector(".hrv-fan-speed-circle")?.addEventListener("click",()=>{const m=t(this,Ve,Vr);if(!m.length)return;let H;if(!t(this,z)||t(this,S)===0)H=m[0],n(this,z,!0),t(this,it)?.setAttribute("aria-pressed","true");else{const nt=m.findIndex(Rn=>Rn>t(this,S));H=nt===-1?m[0]:m[nt]}n(this,S,H),h(this,Bi,is).call(this),this.config.card?.sendCommand("set_percentage",{percentage:H})}),this.root.querySelectorAll(".hrv-fan-hspeed-dot").forEach(m=>{const H=()=>{const nt=Number(m.getAttribute("data-pct"));t(this,z)||(n(this,z,!0),t(this,it)?.setAttribute("aria-pressed","true")),n(this,S,nt),h(this,Ri,rs).call(this),this.config.card?.sendCommand("set_percentage",{percentage:nt})};m.addEventListener("click",H),m.addEventListener("keydown",nt=>{(nt.key==="Enter"||nt.key===" ")&&(nt.preventDefault(),H())})}),t(this,pt)?.addEventListener("click",()=>{this.config.card?.sendCommand("oscillate",{oscillating:!t(this,Vt)})}),t(this,ut)?.addEventListener("click",()=>{const m=t(this,kt)==="forward"?"reverse":"forward";n(this,kt,m),h(this,Ot,Mi).call(this),this.config.card?.sendCommand("set_direction",{direction:m})}),t(this,vt)?.addEventListener("click",()=>{if(t(this,$).length){if(t(this,zi,es)){const m=t(this,B)??t(this,$)[0];this.config.card?.sendCommand("set_preset_mode",{preset_mode:m});return}if(t(this,B)){const m=t(this,$).indexOf(t(this,B));if(m===-1||m===t(this,$).length-1){n(this,B,null),h(this,Ot,Mi).call(this);const H=t(this,je,jr),nt=Math.floor(t(this,S)/H)*H||H;this.config.card?.sendCommand("set_percentage",{percentage:nt})}else{const H=t(this,$)[m+1];n(this,B,H),h(this,Ot,Mi).call(this),this.config.card?.sendCommand("set_preset_mode",{preset_mode:H})}}else{const m=t(this,$)[0];n(this,B,m),h(this,Ot,Mi).call(this),this.config.card?.sendCommand("set_preset_mode",{preset_mode:m})}}}),this.root.querySelector(".hrv-fan-ro-circle")&&this.renderIcon(this.def.icon??"mdi:fan","ro-state-icon"),this.renderCompanions(),this.root.querySelectorAll("[part=companion]").forEach(m=>{m.title=m.getAttribute("aria-label")??"Companion"})}applyState(e,i){n(this,z,e==="on"),n(this,S,i?.percentage??0),n(this,Vt,i?.oscillating??!1),n(this,kt,i?.direction??"forward"),n(this,B,i?.preset_mode??null),i?.preset_modes?.length&&n(this,$,i.preset_modes),t(this,it)&&t(this,it).setAttribute("aria-pressed",String(t(this,z)));const s=this.root.querySelector(".hrv-fan-ro-circle");s&&s.setAttribute("data-on",String(t(this,z))),t(this,se,nr)&&!t(this,$).length?h(this,Ri,rs).call(this):t(this,se,nr)?h(this,Bi,is).call(this):h(this,wr,Hs).call(this),h(this,Ot,Mi).call(this),this.announceState(`${this.def.friendly_name}, ${e}`+(t(this,S)>0?`, ${t(this,S)}%`:""))}predictState(e,i){return e==="toggle"?{state:t(this,z)?"off":"on",attributes:{percentage:t(this,S)}}:e==="set_percentage"?{state:"on",attributes:{percentage:i.percentage,oscillating:t(this,Vt),direction:t(this,kt),preset_mode:t(this,B),preset_modes:t(this,$)}}:null}}it=new WeakMap,j=new WeakMap,gr=new WeakMap,P=new WeakMap,Be=new WeakMap,V=new WeakMap,pt=new WeakMap,ut=new WeakMap,vt=new WeakMap,z=new WeakMap,S=new WeakMap,Vt=new WeakMap,kt=new WeakMap,B=new WeakMap,$=new WeakMap,re=new WeakMap,Re=new WeakMap,Pi=new WeakMap,je=new WeakSet,jr=function(){const e=this.def?.feature_config;return e?.percentage_step>1?e.percentage_step:e?.speed_count>1?100/e.speed_count:1},se=new WeakSet,nr=function(){return t(this,je,jr)>1},zi=new WeakSet,es=function(){return t(this,se,nr)&&t(this,$).length>0},Ve=new WeakSet,Vr=function(){const e=t(this,je,jr),i=[];for(let s=1;s*e<=100.001;s++)i.push(Math.floor(s*e*10)/10);return i},Bi=new WeakSet,is=function(){const e=this.root.querySelector(".hrv-fan-speed-circle");if(!e)return;e.setAttribute("aria-pressed",String(t(this,z)));const i=t(this,z)?"Click to increase fan speed":"Fan off - click to turn on";e.setAttribute("aria-label",i),e.title=i},Ri=new WeakSet,rs=function(){const e=this.root.querySelector(".hrv-fan-hspeed-switch");if(!e)return;const i=e.querySelector(".hrv-fan-hspeed-thumb"),s=t(this,Ve,Vr);let a=-1;if(t(this,z)&&t(this,S)>0){let o=1/0;s.forEach((c,d)=>{const u=Math.abs(c-t(this,S));u<o&&(o=u,a=d)})}e.setAttribute("data-on",String(a>=0)),i&&a>=0&&(i.style.left=`${2+a*32}px`),e.querySelectorAll(".hrv-fan-hspeed-dot").forEach((o,c)=>{o.setAttribute("data-active",String(c===a))})},Ot=new WeakSet,Mi=function(){const e=t(this,zi,es);if(t(this,pt)){const i=e||t(this,Vt),s=e?"Oscillate":`Oscillate: ${t(this,Vt)?"on":"off"}`;t(this,pt).setAttribute("data-on",String(i)),t(this,pt).setAttribute("aria-pressed",String(i)),t(this,pt).setAttribute("aria-label",s),t(this,pt).title=s}if(t(this,ut)){const i=t(this,kt)!=="reverse",s=`Direction: ${t(this,kt)}`;t(this,ut).setAttribute("data-on",String(i)),t(this,ut).setAttribute("aria-pressed",String(i)),t(this,ut).setAttribute("aria-label",s),t(this,ut).title=s}if(t(this,vt)){const i=e||!!t(this,B),s=e?t(this,B)??t(this,$)[0]??"Preset":t(this,B)?`Preset: ${t(this,B)}`:"Preset: none";t(this,vt).setAttribute("data-on",String(i)),t(this,vt).setAttribute("aria-pressed",String(i)),t(this,vt).setAttribute("aria-label",s),t(this,vt).title=s}},br=new WeakSet,Ls=function(e){n(this,re,!0),t(this,V)?.setPointerCapture(e.pointerId),h(this,Vi,ns).call(this,e)},yr=new WeakSet,ks=function(e){t(this,re)&&h(this,Vi,ns).call(this,e)},ji=new WeakSet,ss=function(e){if(t(this,re)){n(this,re,!1);try{t(this,V)?.releasePointerCapture(e.pointerId)}catch{}t(this,Pi).call(this)}},Vi=new WeakSet,ns=function(e){if(!t(this,V))return;const i=t(this,V).getBoundingClientRect(),s=i.left+i.width/2,a=i.top+i.height/2,o=e.clientX-s,c=-(e.clientY-a);let d=Math.atan2(c,o)*180/Math.PI;d<0&&(d+=360);let u=R-d;u<0&&(u+=360),u>C&&(u=u>C+(360-C)/2?0:C),n(this,S,Math.round(u/C*100)),t(this,j)&&(t(this,j).style.transition="none"),t(this,P)&&(t(this,P).style.transition="none"),h(this,Oi,as).call(this,t(this,S))},xr=new WeakSet,Ms=function(){t(this,j)&&(t(this,j).style.transition=""),t(this,P)&&(t(this,P).style.transition=""),t(this,S)===0?this.config.card?.sendCommand("turn_off",{}):this.config.card?.sendCommand("set_percentage",{percentage:t(this,S)})},Oi=new WeakSet,as=function(e){const i=at*(1-e/100),s=et(R-e/100*C);t(this,j)?.setAttribute("stroke-dashoffset",String(i)),t(this,P)?.setAttribute("cx",String(s.x)),t(this,P)?.setAttribute("cy",String(s.y)),t(this,Re)?.setAttribute("cx",String(s.x)),t(this,Re)?.setAttribute("cy",String(s.y)),t(this,Be)&&(t(this,Be).textContent=`${e}%`),t(this,V)?.setAttribute("aria-valuenow",String(e))},wr=new WeakSet,Hs=function(){t(this,P)&&(t(this,P).style.transition="none"),t(this,j)&&(t(this,j).style.transition="none"),h(this,Oi,as).call(this,t(this,z)?t(this,S):0),t(this,P)?.getBoundingClientRect(),t(this,j)?.getBoundingClientRect(),t(this,P)&&(t(this,P).style.transition=""),t(this,j)&&(t(this,j).style.transition="")};function sn(p,v,e){p/=255,v/=255,e/=255;const i=Math.max(p,v,e),s=Math.min(p,v,e),a=i-s;if(a===0)return 0;let o;return i===p?o=(v-e)/a%6:i===v?o=(e-p)/a+2:o=(p-v)/a+4,Math.round((o*60+360)%360)}const nn=Gr+`
    [part=card-body] {
      flex-direction: column;
      align-items: stretch;
      gap: 0;
  ...
  `;class an extends g{constructor(e,i,s,a){super(e,i,s,a);r(this,Ni);r(this,Cr);r(this,_r);r(this,ai);r(this,Zi);r(this,oi);r(this,Ar);r(this,Sr);r(this,Wi);r(this,Yi);r(this,$r);r(this,Lr);r(this,U,null);r(this,Mt,null);r(this,ft,null);r(this,Oe,null);r(this,Ft,!1);r(this,Fe,null);r(this,Ne,null);r(this,Ze,null);r(this,O,null);r(this,F,null);r(this,We,null);r(this,Ye,null);r(this,Ge,null);r(this,Ue,null);r(this,Ht,null);r(this,Xe,null);r(this,ne,null);r(this,N,20);r(this,mt,"off");r(this,Ke,null);r(this,Je,null);r(this,Qe,null);r(this,gt,16);r(this,Nt,32);r(this,ae,.5);r(this,ti,"°C");r(this,ei,[]);r(this,ii,[]);r(this,ri,[]);r(this,si,[]);r(this,Fi,{});r(this,ni,void 0);n(this,ni,Rt(h(this,$r,Is).bind(this),500))}render(){const e=this.def.capabilities==="read-write",i=this.config.displayHints??{},s=this.def.supported_features?.includes("target_temperature"),a=i.show_fan_mode!==!1&&(this.def.supported_features?.includes("fan_mode")||this.def.feature_config?.fan_modes?.length>0),o=i.show_presets!==!1&&(this.def.supported_features?.includes("preset_mode")||this.def.feature_config?.preset_modes?.length>0),c=i.show_swing_mode!==!1&&(this.def.supported_features?.includes("swing_mode")||this.def.feature_config?.swing_modes?.length>0);n(this,gt,this.def.feature_config?.min_temp??16),n(this,Nt,this.def.feature_config?.max_temp??32),n(this,ae,this.def.feature_config?.temp_step??.5),n(this,ti,this.def.unit_of_measurement??"°C"),n(this,ei,this.def.feature_config?.hvac_modes??["off","heat","cool","heat_cool","auto","dry","fan_only"]),n(this,ii,this.def.feature_config?.fan_modes??[]),n(this,ri,this.def.feature_config?.preset_modes??[]),n(this,si,this.def.feature_config?.swing_modes??[]);const d=h(this,Ni,os).call(this,t(this,N)),u=et(R),f=et(R-d/100*C),x=at*(1-d/100),[b,M]=t(this,N).toFixed(1).split(".");this.root.innerHTML=`
      ...
      `,n(this,U,this.root.querySelector(".hrv-dial-wrap")),n(this,Mt,this.root.querySelector(".hrv-dial-fill")),n(this,ft,this.root.querySelector(".hrv-dial-thumb")),n(this,Oe,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,Fe,this.root.querySelector(".hrv-climate-state-text")),n(this,Ne,this.root.querySelector(".hrv-climate-temp-int")),n(this,Ze,this.root.querySelector(".hrv-climate-temp-frac")),n(this,O,this.root.querySelector("[data-dir='-']")),n(this,F,this.root.querySelector("[data-dir='+']")),n(this,We,this.root.querySelector("[data-feat=mode]")),n(this,Ye,this.root.querySelector("[data-feat=fan]")),n(this,Ge,this.root.querySelector("[data-feat=preset]")),n(this,Ue,this.root.querySelector("[data-feat=swing]")),n(this,Ht,this.root.querySelector(".hrv-climate-dropdown")),t(this,U)&&(t(this,U).addEventListener("pointerdown",h(this,Ar,qs).bind(this)),t(this,U).addEventListener("pointermove",h(this,Sr,Ds).bind(this)),t(this,U).addEventListener("pointerup",h(this,Wi,ds).bind(this)),t(this,U).addEventListener("pointercancel",h(this,Wi,ds).bind(this))),t(this,O)&&(t(this,O).addEventListener("click",()=>h(this,Zi,hs).call(this,-1)),t(this,O).addEventListener("pointerdown",()=>t(this,O).setAttribute("data-pressing","true")),t(this,O).addEventListener("pointerup",()=>t(this,O).removeAttribute("data-pressing")),t(this,O).addEventListener("pointerleave",()=>t(this,O).removeAttribute("data-pressing")),t(this,O).addEventListener("pointercancel",()=>t(this,O).removeAttribute("data-pressing"))),t(this,F)&&(t(this,F).addEventListener("click",()=>h(this,Zi,hs).call(this,1)),t(this,F).addEventListener("pointerdown",()=>t(this,F).setAttribute("data-pressing","true")),t(this,F).addEventListener("pointerup",()=>t(this,F).removeAttribute("data-pressing")),t(this,F).addEventListener("pointerleave",()=>t(this,F).removeAttribute("data-pressing")),t(this,F).addEventListener("pointercancel",()=>t(this,F).removeAttribute("data-pressing"))),e&&[t(this,We),t(this,Ye),t(this,Ge),t(this,Ue)].forEach(w=>{if(!w)return;const rr=w.getAttribute("data-feat");w.addEventListener("click",()=>h(this,_r,Ts).call(this,rr)),w.addEventListener("pointerdown",()=>w.setAttribute("data-pressing","true")),w.addEventListener("pointerup",()=>w.removeAttribute("data-pressing")),w.addEventListener("pointerleave",()=>w.removeAttribute("data-pressing")),w.addEventListener("pointercancel",()=>w.removeAttribute("data-pressing"))}),this.renderCompanions(),W(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}applyState(e,i){n(this,Fi,{...i}),n(this,mt,e),n(this,Ke,i.fan_mode??null),n(this,Je,i.preset_mode??null),n(this,Qe,i.swing_mode??null),!t(this,Ft)&&i.temperature!==void 0&&(n(this,N,i.temperature),h(this,oi,Fr).call(this)),t(this,Fe)&&(t(this,Fe).textContent=Me(i.hvac_action??e));const s=this.root.querySelector(".hrv-climate-ro-temp-int"),a=this.root.querySelector(".hrv-climate-ro-temp-frac");if(s&&i.temperature!==void 0){n(this,N,i.temperature);const[d,u]=t(this,N).toFixed(1).split(".");s.textContent=d,a.textContent=`.${u}`}h(this,Lr,Ps).call(this);const o=i.hvac_action??e,c=Me(o);this.announceState(`${this.def.friendly_name}, ${c}`)}predictState(e,i){const s={...t(this,Fi)};return e==="set_hvac_mode"&&i.hvac_mode?{state:i.hvac_mode,attributes:s}:e==="set_temperature"&&i.temperature!==void 0?{state:t(this,mt),attributes:{...s,temperature:i.temperature}}:e==="set_fan_mode"&&i.fan_mode?{state:t(this,mt),attributes:{...s,fan_mode:i.fan_mode}}:e==="set_preset_mode"&&i.preset_mode?{state:t(this,mt),attributes:{...s,preset_mode:i.preset_mode}}:e==="set_swing_mode"&&i.swing_mode?{state:t(this,mt),attributes:{...s,swing_mode:i.swing_mode}}:null}}U=new WeakMap,Mt=new WeakMap,ft=new WeakMap,Oe=new WeakMap,Ft=new WeakMap,Fe=new WeakMap,Ne=new WeakMap,Ze=new WeakMap,O=new WeakMap,F=new WeakMap,We=new WeakMap,Ye=new WeakMap,Ge=new WeakMap,Ue=new WeakMap,Ht=new WeakMap,Xe=new WeakMap,ne=new WeakMap,N=new WeakMap,mt=new WeakMap,Ke=new WeakMap,Je=new WeakMap,Qe=new WeakMap,gt=new WeakMap,Nt=new WeakMap,ae=new WeakMap,ti=new WeakMap,ei=new WeakMap,ii=new WeakMap,ri=new WeakMap,si=new WeakMap,Fi=new WeakMap,ni=new WeakMap,Ni=new WeakSet,os=function(e){return Math.max(0,Math.min(100,(e-t(this,gt))/(t(this,Nt)-t(this,gt))*100))},Cr=new WeakSet,Es=function(e){const i=t(this,gt)+e/100*(t(this,Nt)-t(this,gt)),s=Math.round(i/t(this,ae))*t(this,ae);return Math.max(t(this,gt),Math.min(t(this,Nt),+s.toFixed(10)))},_r=new WeakSet,Ts=function(e){if(t(this,Xe)===e){h(this,ai,Or).call(this);return}n(this,Xe,e);let i=[],s=null,a="",o="";switch(e){case"mode":i=t(this,ei),s=t(this,mt),a="set_hvac_mode",o="hvac_mode";break;case"fan":i=t(this,ii),s=t(this,Ke),a="set_fan_mode",o="fan_mode";break;case"preset":i=t(this,ri),s=t(this,Je),a="set_preset_mode",o="preset_mode";break;case"swing":i=t(this,si),s=t(this,Qe),a="set_swing_mode",o="swing_mode";break}if(!i.length||!t(this,Ht))return;t(this,Ht).innerHTML=i.map(d=>`
        <button class="hrv-cf-option" data-active="${d===s}" type="button">
          ${l(Me(d))}
        </button>
      `).join(""),t(this,Ht).querySelectorAll(".hrv-cf-option").forEach((d,u)=>{d.addEventListener("click",()=>{this.config.card?.sendCommand(a,{[o]:i[u]}),h(this,ai,Or).call(this)})}),t(this,Ht).removeAttribute("hidden");const c=d=>{d.composedPath().some(f=>f===this.root||f===this.root.host)||h(this,ai,Or).call(this)};n(this,ne,c),document.addEventListener("pointerdown",c,!0)},ai=new WeakSet,Or=function(){n(this,Xe,null),t(this,Ht)?.setAttribute("hidden",""),t(this,ne)&&(document.removeEventListener("pointerdown",t(this,ne),!0),n(this,ne,null))},Zi=new WeakSet,hs=function(e){const i=Math.round((t(this,N)+e*t(this,ae))*100)/100;n(this,N,Math.max(t(this,gt),Math.min(t(this,Nt),i))),h(this,oi,Fr).call(this),t(this,ni).call(this)},oi=new WeakSet,Fr=function(){const e=h(this,Ni,os).call(this,t(this,N)),i=at*(1-e/100),s=et(R-e/100*C);t(this,Mt)?.setAttribute("stroke-dashoffset",String(i)),t(this,ft)?.setAttribute("cx",String(s.x)),t(this,ft)?.setAttribute("cy",String(s.y)),t(this,Oe)?.setAttribute("cx",String(s.x)),t(this,Oe)?.setAttribute("cy",String(s.y));const[a,o]=t(this,N).toFixed(1).split(".");t(this,Ne)&&(t(this,Ne).textContent=a),t(this,Ze)&&(t(this,Ze).textContent=`.${o}`)},Ar=new WeakSet,qs=function(e){n(this,Ft,!0),t(this,U)?.setPointerCapture(e.pointerId),h(this,Yi,ls).call(this,e)},Sr=new WeakSet,Ds=function(e){t(this,Ft)&&h(this,Yi,ls).call(this,e)},Wi=new WeakSet,ds=function(e){if(t(this,Ft)){n(this,Ft,!1);try{t(this,U)?.releasePointerCapture(e.pointerId)}catch{}t(this,Mt)&&(t(this,Mt).style.transition=""),t(this,ft)&&(t(this,ft).style.transition="")}},Yi=new WeakSet,ls=function(e){if(!t(this,U))return;const i=t(this,U).getBoundingClientRect(),s=i.left+i.width/2,a=i.top+i.height/2,o=e.clientX-s,c=-(e.clientY-a);let d=Math.atan2(c,o)*180/Math.PI;d<0&&(d+=360);let u=R-d;u<0&&(u+=360),u>C&&(u=u>C+(360-C)/2?0:C),n(this,N,h(this,Cr,Es).call(this,u/C*100)),t(this,Mt)&&(t(this,Mt).style.transition="none"),t(this,ft)&&(t(this,ft).style.transition="none"),h(this,oi,Fr).call(this),t(this,ni).call(this)},$r=new WeakSet,Is=function(){this.config.card?.sendCommand("set_temperature",{temperature:t(this,N)})},Lr=new WeakSet,Ps=function(){const e=(i,s)=>{if(!i)return;const a=i.querySelector(".hrv-cf-value");a&&(a.textContent=Me(s??"None"))};e(t(this,We),t(this,mt)),e(t(this,Ye),t(this,Ke)),e(t(this,Ge),t(this,Je)),e(t(this,Ue),t(this,Qe))};const on=`
    [part=card-body] {
      display: flex;
      flex-direction: column;
      align-items: center;
  ...
  `;class hn extends g{constructor(){super(...arguments);r(this,bt,null)}render(){const e=this.def.capabilities==="read-write",i=this.def.friendly_name;this.root.innerHTML=`
  ...
  `;class ln extends g{constructor(){super(...arguments);r(this,oe,null)}render(){this.root.innerHTML=`
        <style>${this.getSharedStyles()}${dn}${K}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${l(this.def.friendly_name)}</span>
          </div>
  ...
  `;class fn extends g{constructor(e,i,s,a){super(e,i,s,a);r(this,hi);r(this,kr);r(this,he,null);r(this,yt,null);r(this,L,null);r(this,de,null);r(this,le,null);r(this,ce,null);r(this,Et,!1);r(this,xt,0);r(this,Gi,"closed");r(this,Ui,{});r(this,Xi,void 0);n(this,Xi,Rt(h(this,kr,zs).bind(this),300))}render(){const e=this.def.capabilities==="read-write",s=(this.config.displayHints??{}).show_position!==!1&&this.def.supported_features?.includes("set_position"),a=!this.def.supported_features||this.def.supported_features.includes("buttons");if(this.root.innerHTML=`
            ...
            ${e&&a?`
              <div class="hrv-cover-btns">
                <button class="hrv-cover-btn" data-action="open" type="button"
                  title="Open cover" aria-label="Open cover">${cn}</button>
                ...
                <button class="hrv-cover-btn" data-action="close" type="button"
                  title="Close cover" aria-label="Close cover">${un}</button>
              </div>
            `:""}
          </div>
          ${this.renderAriaLiveHTML()}
  ...
  `;class gn extends g{constructor(e,i,s,a){super(e,i,s,a);r(this,Mr);r(this,Hr);r(this,Gt);r(this,li);r(this,Er);r(this,Ut);r(this,pe,null);r(this,Tt,null);r(this,T,null);r(this,D,null);r(this,di,null);r(this,Zt,null);r(this,Wt,null);r(this,qt,!1);r(this,q,0);r(this,X,0);r(this,rt,100);r(this,Dt,1);r(this,Yt,void 0);n(this,Yt,Rt(h(this,Er,js).bind(this),300))}render(){const e=this.def.capabilities==="read-write",s=(this.config.displayHints?.display_mode??null)!=="buttons";n(this,X,this.def.feature_config?.min??0),n(this,rt,this.def.feature_config?.max??100),n(this,Dt,this.def.feature_config?.step??1);const a=this.def.unit_of_measurement??"";if(this.root.innerHTML=`
  ...
  `;class yn extends g{constructor(){super(...arguments);r(this,Tr);r(this,Ji);r(this,ci,null);r(this,wt,null);r(this,Ki,"");r(this,It,[]);r(this,ue,!1)}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${this.getSharedStyles()}${bn}${K}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${l(this.def.friendly_name)}</span>
          </div>
  ...
  `;class wn extends g{constructor(e,i,s,a){super(e,i,s,a);r(this,vi);r(this,qr);r(this,Pt,null);r(this,pi,null);r(this,ui,null);r(this,ve,null);r(this,fe,null);r(this,Ct,null);r(this,k,null);r(this,me,null);r(this,ge,null);r(this,be,!1);r(this,_t,0);r(this,zt,!1);r(this,ye,"idle");r(this,xe,{});r(this,Qi,void 0);n(this,Qi,this.debounce(h(this,qr,Os).bind(this),200))}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],s=this.config.displayHints??{},a=s.show_transport!==!1,o=s.show_volume!==!1&&i.includes("volume_set"),c=i.includes("previous_track");if(this.root.innerHTML=`
        <style>${this.getSharedStyles()}${xn}${K}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${l(this.def.friendly_name)}</span>
          </div>
  ...
  `;class _n extends g{constructor(){super(...arguments);r(this,fi,null)}render(){const e=this.def.capabilities==="read-write",i=this.config.tapAction?.data?.command??"power";this.root.innerHTML=`
  ...
  `;class Sn extends g{constructor(){super(...arguments);r(this,mi,null);r(this,gi,null)}render(){const e=this.def.unit_of_measurement??"";this.root.innerHTML=`
  ...
  `;class ms extends g{constructor(){super(...arguments);r(this,At,null);r(this,bi,null);r(this,we,!1)}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
  ...
  `;function hr(p){p<0&&(p=0);const v=Math.floor(p/3600),e=Math.floor(p%3600/60),i=Math.floor(p%60),s=a=>String(a).padStart(2,"0");return v>0?`${v}:${s(e)}:${s(i)}`:`${s(e)}:${s(i)}`}function gs(p){if(typeof p=="number")return p;if(typeof p!="string")return 0;const v=p.split(":").map(Number);return v.length===3?v[0]*3600+v[1]*60+v[2]:v.length===2?v[0]*60+v[1]:v[0]||0}class kn extends g{constructor(){super(...arguments);r(this,Dr);r(this,Ir);r(this,Pr);r(this,_e);r(this,J,null);r(this,Bt,null);r(this,Xt,null);r(this,Kt,null);r(this,Ce,null);r(this,yi,"idle");r(this,xi,{});r(this,st,null);r(this,wi,null)}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
      ...
      `,n(this,J,this.root.querySelector(".hrv-timer-display")),n(this,Bt,this.root.querySelector("[data-action=playpause]")),n(this,Xt,this.root.querySelector("[data-action=cancel]")),n(this,Kt,this.root.querySelector("[data-action=finish]")),this.renderIcon("mdi:play","playpause-icon"),this.renderIcon("mdi:stop","cancel-icon"),this.renderIcon("mdi:check-circle","finish-icon"),e&&(t(this,Bt)?.addEventListener("click",()=>{const i=t(this,yi)==="active"?"pause":"start";this.config.card?.sendCommand(i,{})}),t(this,Xt)?.addEventListener("click",()=>{this.config.card?.sendCommand("cancel",{})}),t(this,Kt)?.addEventListener("click",()=>{this.config.card?.sendCommand("finish",{})}),[t(this,Bt),t(this,Xt),t(this,Kt)].forEach(i=>{i&&(i.addEventListener("pointerdown",()=>i.setAttribute("data-pressing","true")),i.addEventListener("pointerup",()=>i.removeAttribute("data-pressing")),i.addEventListener("pointerleave",()=>i.removeAttribute("data-pressing")),i.addEventListener("pointercancel",()=>i.removeAttribute("data-pressing")))})),this.renderCompanions(),W(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}applyState(e,i){n(this,yi,e),n(this,xi,{...i}),n(this,st,i.finishes_at??null),n(this,wi,i.remaining!=null?gs(i.remaining):null),h(this,Dr,Fs).call(this,e),h(this,Ir,Ns).call(this,e),e==="active"&&t(this,st)?h(this,Pr,Zs).call(this):h(this,_e,ar).call(this),t(this,J)&&t(this,J).setAttribute("data-paused",String(e==="paused"))}predictState(e,i){const s={...t(this,xi)};return e==="start"?{state:"active",attributes:s}:e==="pause"?(t(this,st)&&(s.remaining=Math.max(0,(new Date(t(this,st)).getTime()-Date.now())/1e3)),{state:"paused",attributes:s}):e==="cancel"||e==="finish"?{state:"idle",attributes:s}:null}}J=new WeakMap,Bt=new WeakMap,Xt=new WeakMap,Kt=new WeakMap,Ce=new WeakMap,yi=new WeakMap,xi=new WeakMap,st=new WeakMap,wi=new WeakMap,Dr=new WeakSet,Fs=function(e){const i=e==="idle",s=e==="active";if(t(this,Bt)){const a=s?"mdi:pause":"mdi:play",o=s?"Pause":e==="paused"?"Resume":"Start";this.renderIcon(a,"playpause-icon"),t(this,Bt).title=o,t(this,Bt).setAttribute("aria-label",`${this.def.friendly_name} - ${o}`)}t(this,Xt)&&(t(this,Xt).disabled=i),t(this,Kt)&&(t(this,Kt).disabled=i),this.announceState(`${this.def.friendly_name}, ${e}`)},Ir=new WeakSet,Ns=function(e){if(t(this,J)){if(e==="idle"){const i=t(this,xi).duration;t(this,J).textContent=i?hr(gs(i)):"00:00";return}if(e==="paused"&&t(this,wi)!=null){t(this,J).textContent=hr(t(this,wi));return}if(e==="active"&&t(this,st)){const i=Math.max(0,(new Date(t(this,st)).getTime()-Date.now())/1e3);t(this,J).textContent=hr(i)}}},Pr=new WeakSet,Zs=function(){h(this,_e,ar).call(this),n(this,Ce,setInterval(()=>{if(!t(this,st)||t(this,yi)!=="active"){h(this,_e,ar).call(this);return}const e=Math.max(0,(new Date(t(this,st)).getTime()-Date.now())/1e3);t(this,J)&&(t(this,J).textContent=hr(e)),e<=0&&h(this,_e,ar).call(this)},1e3))},_e=new WeakSet,ar=function(){t(this,Ce)&&(clearInterval(t(this,Ce)),n(this,Ce,null))};const Mn=`
    [part=card-body] {
      display: flex;
      flex-direction: column;
      align-items: center;
  ...
  `;class Hn extends g{constructor(){super(...arguments);r(this,Ci,null);r(this,St,null);r(this,Ae,!1);r(this,Se,!1)}render(){const e=this.def.capabilities==="read-write";n(this,Se,!1),this.root.innerHTML=`
        <style>${this.getSharedStyles()}${Mn}${K}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${l(this.def.friendly_name)}</span>
  ...
  `;class zn extends g{constructor(){super(...arguments);r(this,Z);r(this,tr);r(this,er);r(this,ir);r(this,zr);r(this,_i,null);r(this,$e,null);r(this,Ai,null);r(this,Si,null);r(this,$i,null);r(this,Li,null);r(this,Q,null);r(this,$t,null);r(this,tt,null);r(this,ki,null);r(this,Le,null);r(this,ke,null)}render(){this.root.innerHTML=`
        ...
        <div part="card">
          ...
          <div part="card-body">
            <div class="hrv-weather-main">
              <span class="hrv-weather-icon">${Ur("cloudy",44)}</span>
      ...
      `,n(this,_i,this.root.querySelector(".hrv-weather-icon")),n(this,$e,this.root.querySelector(".hrv-weather-temp")),n(this,Ai,this.root.querySelector(".hrv-weather-cond")),n(this,Si,this.root.querySelector("[data-stat=humidity] [data-value]")),n(this,$i,this.root.querySelector("[data-stat=wind] [data-value]")),n(this,Li,this.root.querySelector("[data-stat=pressure] [data-value]")),n(this,Q,this.root.querySelector(".hrv-forecast-strip")),n(this,$t,this.root.querySelector(".hrv-forecast-toggle")),n(this,tt,this.root.querySelector(".hrv-forecast-scroll-track")),n(this,ki,this.root.querySelector(".hrv-forecast-scroll-thumb")),t(this,Q)&&t(this,Q).addEventListener("scroll",()=>h(this,ir,vs).call(this),{passive:!0}),t(this,tt)&&t(this,tt).addEventListener("pointerdown",e=>h(this,zr,Ws).call(this,e)),this.renderCompanions(),W(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}applyState(e,i){const s=e||"cloudy";t(this,_i)&&(t(this,_i).innerHTML=Ur(s,44));const a=this.i18n.t(`weather.${s}`)!==`weather.${s}`?this.i18n.t(`weather.${s}`):s.replace(/-/g," ");t(this,Ai)&&(t(this,Ai).textContent=a);const o=i.temperature??i.native_temperature,c=i.temperature_unit??"";if(t(this,$e)){const u=t(this,$e).querySelector(".hrv-weather-unit");t(this,$e).firstChild.textContent=o!=null?Math.round(Number(o)):"--",u&&(u.textContent=c?` ${c}`:"")}if(t(this,Si)){const u=i.humidity;t(this,Si).textContent=u!=null?`${u}%`:"--"}if(t(this,$i)){const u=i.wind_speed,f=i.wind_speed_unit??"";t(this,$i).textContent=u!=null?`${u} ${f}`.trim():"--"}if(t(this,Li)){const u=i.pressure,f=i.pressure_unit??"";t(this,Li).textContent=u!=null?`${u} ${f}`.trim():"--"}const d=(this.config.displayHints??this.def.display_hints??{}).show_forecast===!0;n(this,Le,d?i.forecast_daily??i.forecast??null:null),n(this,ke,d?i.forecast_hourly??null:null),h(this,tr,ps).call(this),h(this,er,us).call(this),this.announceState(`${this.def.friendly_name}, ${a}, ${o??"--"} ${c}`)}}_i=new WeakMap,$e=new WeakMap,Ai=new WeakMap,Si=new WeakMap,$i=new WeakMap,Li=new WeakMap,Q=new WeakMap,$t=new WeakMap,tt=new WeakMap,ki=new WeakMap,Z=new WeakSet,Jt=function(){return this.config._forecastMode??"daily"},Yr=function(e){this.config._forecastMode=e},Le=new WeakMap,ke=new WeakMap,tr=new WeakSet,ps=function(){if(!t(this,$t))return;const e=Array.isArray(t(this,Le))&&t(this,Le).length>0,i=Array.isArray(t(this,ke))&&t(this,ke).length>0;if(!e&&!i){t(this,$t).textContent="";return}e&&!i&&n(this,Z,"daily",Yr),!e&&i&&n(this,Z,"hourly",Yr),e&&i?(t(this,$t).textContent=t(this,Z,Jt)==="daily"?"Hourly":"5-Day",t(this,$t).onclick=()=>{n(this,Z,t(this,Z,Jt)==="daily"?"hourly":"daily",Yr),h(this,tr,ps).call(this),h(this,er,us).call(this)}):(t(this,$t).textContent="",t(this,$t).onclick=null)},er=new WeakSet,us=function(){if(!t(this,Q))return;const e=t(this,Z,Jt)==="hourly"?t(this,ke):t(this,Le);if(t(this,Q).setAttribute("data-mode",t(this,Z,Jt)),!Array.isArray(e)||e.length===0){t(this,Q).innerHTML="",t(this,tt)&&(t(this,tt).hidden=!0);return}const i=t(this,Z,Jt)==="daily"?e.slice(0,5):e;t(this,Q).innerHTML=i.map(s=>{const a=new Date(s.datetime);let o;t(this,Z,Jt)==="hourly"?o=a.toLocaleTimeString([],{hour:"numeric"}):o=In[a.getDay()]??"";const c=(s.temperature??s.native_temperature)!=null?Math.round(s.temperature??s.native_temperature):"--",d=(s.templow??s.native_templow)!=null?Math.round(s.templow??s.native_templow):null;return`
          <div class="hrv-forecast-day" role="listitem">
            <span class="hrv-forecast-day-name">${l(String(o))}</span>
            ${Ur(s.condition||"cloudy",18)}
            <span class="hrv-forecast-temps">
              ${l(String(c))}${d!=null?`/<span class="hrv-forecast-lo">${l(String(d))}</span>`:""}
            </span>
          </div>`}).join(""),t(this,Z,Jt)==="hourly"?requestAnimationFrame(()=>h(this,ir,vs).call(this)):t(this,tt)&&(t(this,tt).hidden=!0)},ir=new WeakSet,vs=function(){const e=t(this,Q),i=t(this,tt),s=t(this,ki);if(!e||!i||!s)return;const a=e.scrollWidth>e.clientWidth?e.clientWidth/e.scrollWidth:1;if(a>=1){i.hidden=!0;return}i.hidden=!1;const o=i.clientWidth,c=Math.max(20,a*o),d=o-c,u=e.scrollLeft/(e.scrollWidth-e.clientWidth);s.style.width=`${c}px`,s.style.left=`${u*d}px`},zr=new WeakSet,Ws=function(e){const i=t(this,Q),s=t(this,tt),a=t(this,ki);if(!i||!s||!a)return;e.preventDefault();const o=s.getBoundingClientRect(),c=parseFloat(a.style.width)||20,d=x=>{const b=x-o.left-c/2,M=o.width-c,w=Math.max(0,Math.min(1,b/M));i.scrollLeft=w*(i.scrollWidth-i.clientWidth)};d(e.clientX);const u=x=>d(x.clientX),f=()=>{window.removeEventListener("pointermove",u),window.removeEventListener("pointerup",f)};window.addEventListener("pointermove",u),window.addEventListener("pointerup",f)},y._packs=y._packs||{};const Bn=window.__HARVEST_PACK_ID__||document.currentScript&&document.currentScript.dataset.packId||"minimus";y._packs[Bn]={light:tn,fan:rn,climate:an,harvest_action:hn,binary_sensor:ln,cover:fn,input_boolean:ms,input_number:gn,input_select:yn,media_player:wn,remote:_n,sensor:Sn,switch:ms,timer:kn,weather:zn,generic:Hn,_capabilities:{fan:{display_modes:["on-off","continuous","stepped","cycle"]},input_number:{display_modes:["slider","buttons"]},light:{features:["brightness","color_temp","rgb"]},climate:{features:["hvac_modes","presets","fan_mode","swing_mode"]},cover:{features:["position","tilt"]},media_player:{features:["transport","volume","source"]}}}})();})();
