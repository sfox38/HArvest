(()=>{var ur=Object.defineProperty;var oi=y=>{throw TypeError(y)};var fr=(y,f,p)=>f in y?ur(y,f,{enumerable:!0,configurable:!0,writable:!0,value:p}):y[f]=p;var uo=(y,f,p)=>fr(y,typeof f!="symbol"?f+"":f,p),ko=(y,f,p)=>f.has(y)||oi("Cannot "+p);var t=(y,f,p)=>(ko(y,f,"read from private field"),p?p.call(y):f.get(y)),r=(y,f,p)=>f.has(y)?oi("Cannot add the same private member more than once"):f instanceof WeakSet?f.add(y):f.set(y,p),i=(y,f,p,rt)=>(ko(y,f,"write to private field"),rt?rt.call(y,p):f.set(y,p),p),l=(y,f,p)=>(ko(y,f,"access private method"),p);(function(){"use strict";var zs,Se,Ht,kt,Yt,B,Zs,Et,Gt,Ut,nt,Kt,Xt,F,Z,Tt,$e,Jt,Le,at,Eo,To,ii,ht,Qt,Ae,ut,te,W,Me,It,qt,Bt,R,L,ee,Ot,Vt,X,He,Rs,se,$,_o,ri,Io,qo,Bo,wo,ni,js,ke,Fs,Ee,Y,lt,oe,Ws,Te,G,Ie,dt,ft,qe,Ys,Be,vt,ai,Oo,hi,Gs,Oe,V,T,ie,re,gt,yo,Dt,Ve,bt,ne,Pt,P,q,li,di,Vo,Do,Ds,Us,De,J,Pe,Ne,Q,ze,yt,Ze,ae,he,le,xt,ct,Re,Ks,je,Fe,N,ci,Po,pi,No,mi,We,Ye,Xs,Ge,Nt,zt,de,ce,pe,Ue,Ke,tt,Xe,j,ui,fi,vi,fo,Js,Je,Qe,ts,es,ss,os,is,rs,ns,as,O,hs,ls,_t,me,pt,z,wt,Ct,ds,et,cs,ps,ms,Qs,to,eo,us,Zt,ue,fe,ve,so,oo,C,gi,zo,Zo,bi,yi,Ro,vo,xi,io,fs,ge,vs,gs,bs,Rt,ro,no,ao,ys,st,jt,ho,be,ot,St,$t,xs,ye,jo,_i,lo,_s,ws,xe,Cs,Ss,$s,Lt,mt,Ls,I,Ce,Co,_e,we,Fo,Wo,co,As,Ft,xo,Ms,Hs,ks,Es,it,Ts,Is,Wt,qs,Bs,Os,Vs;const y=window.HArvest;if(!y||!y.renderers||!y.renderers.BaseCard){console.warn("[HArvest Shrooms] HArvest not found - pack not loaded.");return}const f=y.renderers.BaseCard,p=window.HArvest.esc;function rt(a,d){let e=null,s=null,o=null;function n(...h){s=this,o=h,e&&clearTimeout(e),e=setTimeout(()=>{e=null,a.apply(s,o),o=null},d)}return n.flush=function(){e!==null&&(clearTimeout(e),e=null,o&&(a.apply(s,o),o=null))},n}function S(a){return a?a.charAt(0).toUpperCase()+a.slice(1).replace(/_/g," "):""}function vr(a,d,e){return Math.min(e,Math.max(d,a))}function Yo(a,d){const e=a.querySelector(".shroom-controls-shell");e&&e.setAttribute("data-collapsed",String(d))}function At(a,d){a&&(a.setAttribute("role","button"),a.setAttribute("tabindex","0"),a.setAttribute("aria-label",d),a.addEventListener("keydown",e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),a.click())}))}function A(a){a.querySelectorAll("[part=companion]").forEach(d=>{d.title=d.getAttribute("aria-label")??"Companion"})}const wi={light:"var(--hrv-ex-shroom-light, #ff9800)",switch:"var(--hrv-ex-shroom-switch, #2196f3)",input_boolean:"var(--hrv-ex-shroom-switch, #2196f3)",lock:"var(--hrv-ex-shroom-lock, #2196f3)",fan:"var(--hrv-ex-shroom-fan, #4caf50)",climate:"var(--hrv-ex-shroom-climate, #ff5722)",cover:"var(--hrv-ex-shroom-cover, #9c27b0)",media_player:"var(--hrv-ex-shroom-media, #e91e63)",sensor:"var(--hrv-ex-shroom-sensor, #03a9f4)",binary_sensor:"var(--hrv-ex-shroom-binary, #8bc34a)",input_number:"var(--hrv-ex-shroom-input, #00bcd4)",input_select:"var(--hrv-ex-shroom-input, #00bcd4)",timer:"var(--hrv-ex-shroom-timer, #673ab7)",remote:"var(--hrv-ex-shroom-remote, #607d8b)",weather:"var(--hrv-ex-shroom-weather, #ff9800)"};function Go(a){return wi[a]??"var(--hrv-color-primary, #ff9800)"}function w(a,d,e){if(!a)return;const s=Go(d);e?(a.style.background=`color-mix(in srgb, ${s} 20%, transparent)`,a.style.color=s):(a.style.background="var(--hrv-ex-shroom-btn-bg, rgba(0,0,0,0.05))",a.style.color="var(--hrv-color-icon, #757575)")}function M(a){const d=(a.config.displayHints??a.def.display_hints??{}).layout??null,e=a.root.host;e&&(d==="vertical"?e.setAttribute("data-layout","vertical"):e.removeAttribute("data-layout"))}function Ci(a){if(!a)return()=>{};const d=80,e=1.6,s=.96,o=.04;let n=null,h=0,c=0,m=0,u=!1,x=0;const b=[],v=()=>{x&&(cancelAnimationFrame(x),x=0)},D=g=>{for(;b.length&&b[0].t<g-d;)b.shift();if(b.length<2)return 0;const E=b[0],K=b[b.length-1],mo=K.t-E.t;return mo<=0?0:(K.x-E.x)/mo},U=()=>{if(Math.abs(m)<o)return;let g=performance.now();const E=K=>{const mo=K-g;if(g=K,a.scrollLeft-=m*mo,m*=Math.pow(s,mo/16),Math.abs(m)<o){x=0,m=0;return}const mr=a.scrollWidth-a.clientWidth;if(a.scrollLeft<=0||a.scrollLeft>=mr){x=0,m=0;return}x=requestAnimationFrame(E)};x=requestAnimationFrame(E)},po=g=>{if(a.scrollWidth<=a.clientWidth||g.pointerType==="touch")return;const E=g.target;if(!(E&&E!==a&&E.closest?.("button, a"))){v(),n=g.pointerId,h=g.clientX,c=a.scrollLeft,m=0,u=!1,b.length=0,b.push({x:g.clientX,t:g.timeStamp});try{a.setPointerCapture(n)}catch{}}},Ho=g=>{if(g.pointerId!==n)return;const E=g.clientX-h;Math.abs(E)>4&&(u=!0,a.dataset.dragging="true"),a.scrollLeft=c-E,b.push({x:g.clientX,t:g.timeStamp});const K=g.timeStamp-d;for(;b.length>2&&b[0].t<K;)b.shift()},_=g=>{if(g.pointerId===n){try{a.releasePointerCapture(n)}catch{}if(n=null,u){const E=K=>{K.stopPropagation(),K.preventDefault()};window.addEventListener("click",E,{capture:!0,once:!0}),requestAnimationFrame(()=>a.removeAttribute("data-dragging")),m=D(g.timeStamp)*e,U()}b.length=0}};return a.addEventListener("pointerdown",po),a.addEventListener("pointermove",Ho),a.addEventListener("pointerup",_),a.addEventListener("pointercancel",_),a.addEventListener("wheel",v,{passive:!0}),a.addEventListener("touchstart",v,{passive:!0}),()=>{v(),a.removeEventListener("pointerdown",po),a.removeEventListener("pointermove",Ho),a.removeEventListener("pointerup",_),a.removeEventListener("pointercancel",_),a.removeEventListener("wheel",v),a.removeEventListener("touchstart",v)}}function Uo(a,d){if(a!=="on")return null;if(d.rgb_color){const[s,o,n]=d.rgb_color;return(.299*s+.587*o+.114*n)/255>.85?`rgb(${Math.round(s*.8)}, ${Math.round(o*.8)}, ${Math.round(n*.75)})`:`rgb(${s}, ${o}, ${n})`}if(d.hs_color)return`hsl(${d.hs_color[0]}, ${Math.max(d.hs_color[1],50)}%, 55%)`;const e=d.color_temp_kelvin??(d.color_temp?Math.round(1e6/d.color_temp):null);return e?e>=5200?"#4ba3e0":e>=4500?"#e0c85a":e<=3e3?"#e6a040":"#ddb840":null}const H=`
  ...
  `,Si=`
    ${H}
    ${k}
  `;class Ko extends f{constructor(){super(...arguments);r(this,zs,null);r(this,Se,null);r(this,Ht,!1)}render(){M(this);const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${Si}</style>
        <div part="card">
  ...
  `;class Ai extends f{constructor(e,s,o,n){super(e,s,o,n);r(this,at);r(this,kt,null);r(this,Yt,null);r(this,B,null);r(this,Zs,null);r(this,Et,null);r(this,Gt,null);r(this,Ut,[]);r(this,nt,0);r(this,Kt,4e3);r(this,Xt,0);r(this,F,!1);r(this,Z,0);r(this,Tt,2e3);r(this,$e,6500);r(this,Jt,{});r(this,Le);i(this,Le,rt(l(this,at,ii).bind(this),300))}render(){M(this);const e=this.def.capabilities==="read-write",s=this.def.supported_features??[],o=this.config.displayHints??{},n=o.show_brightness!==!1&&s.includes("brightness"),h=o.show_color_temp!==!1&&s.includes("color_temp"),c=o.show_rgb!==!1&&s.includes("rgb_color"),m=e&&(n||h||c),u=[n,h,c].filter(Boolean).length;i(this,Tt,this.def.feature_config?.min_color_temp_kelvin??2e3),i(this,$e,this.def.feature_config?.max_color_temp_kelvin??6500);const x=[n,h,c];x[t(this,Z)]||(i(this,Z,x.findIndex(Boolean)),t(this,Z)===-1&&i(this,Z,0)),this.root.innerHTML=`
        <style>${Li}</style>
        <div part="card">
          <div class="shroom-state-item" data-tappable="${e}">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
  ...
  `;class qi extends f{constructor(e,s,o,n){super(e,s,o,n);r(this,$);r(this,ut,null);r(this,te,null);r(this,W,null);r(this,Me,null);r(this,It,null);r(this,qt,null);r(this,Bt,null);r(this,R,!1);r(this,L,0);r(this,ee,!1);r(this,Ot,"forward");r(this,Vt,null);r(this,X,[]);r(this,He);r(this,Rs,!1);r(this,se,!1);i(this,He,rt(l(this,$,ni).bind(this),300)),i(this,X,e.feature_config?.preset_modes??[])}render(){M(this);const e=this.def.capabilities==="read-write",s=this.def.supported_features??[],o=this.config.displayHints??this.def.display_hints??{},n=o.display_mode??null;let h=s.includes("set_speed");const c=o.show_oscillate!==!1&&s.includes("oscillate"),m=o.show_direction!==!1&&s.includes("direction"),u=o.show_presets!==!1&&s.includes("preset_mode");n==="on-off"&&(h=!1);let x=e&&h,b=x&&t(this,$,ri),v=!1,D=!1;n==="continuous"?b=!1:n==="stepped"?D=b:n==="cycle"?(b=!0,v=!0):b&&t(this,X).length?v=!0:b&&(D=!0),i(this,Rs,v);const U=e&&(c||m||u);this.root.innerHTML=`
        <style>${Ii}</style>
        <div part="card">
          <div class="shroom-state-item" data-tappable="${e}">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
      ...
      `,i(this,ut,this.root.querySelector(".shroom-icon-shape")),i(this,te,this.root.querySelector(".shroom-secondary")),i(this,W,this.root.querySelector(".shroom-slider-input")),i(this,Me,this.root.querySelector(".shroom-slider-cover")),i(this,It,this.root.querySelector('[data-feat="oscillate"]')),i(this,qt,this.root.querySelector('[data-feat="direction"]')),i(this,Bt,this.root.querySelector('[data-feat="preset"]')),this.renderIcon(this.resolveIcon(this.def.icon,"mdi:fan"),"card-icon");const po=this.root.querySelector(".shroom-state-item");e&&(At(po,`${this.def.friendly_name} - Toggle`),this._attachGestureHandlers(po,{onTap:()=>{const _=this.config.gestureConfig?.tap;if(_){this._runAction(_);return}this.config.card?.sendCommand("toggle",{})}})),t(this,W)&&(t(this,W).addEventListener("input",()=>{const _=Number(t(this,W).value);i(this,L,_),t(this,W).setAttribute("aria-valuetext",`${Math.round(_)}%`),l(this,$,qo).call(this),t(this,He).call(this)}),this.guardSlider(t(this,W),t(this,He))),this.root.querySelectorAll(".shroom-fan-step-dot").forEach(_=>{_.addEventListener("click",()=>{const g=Number(_.getAttribute("data-pct"));i(this,L,g),i(this,R,!0),l(this,$,Bo).call(this),this.config.card?.sendCommand("set_percentage",{percentage:g})})}),this.root.querySelector(".shroom-fan-cycle-btn")?.addEventListener("click",()=>{const _=t(this,$,Io);if(!_.length)return;let g;if(!t(this,R)||t(this,L)===0)g=_[0];else{const E=_.findIndex(K=>K>t(this,L));g=E===-1?_[0]:_[E]}i(this,L,g),i(this,R,!0),this.config.card?.sendCommand("set_percentage",{percentage:g})}),t(this,It)?.addEventListener("click",()=>{this.config.card?.sendCommand("oscillate",{oscillating:!t(this,ee)})}),t(this,qt)?.addEventListener("click",()=>{const _=t(this,Ot)==="forward"?"reverse":"forward";i(this,Ot,_),l(this,$,wo).call(this),this.config.card?.sendCommand("set_direction",{direction:_})}),t(this,Bt)?.addEventListener("click",()=>{if(!t(this,X).length)return;const g=((t(this,Vt)?t(this,X).indexOf(t(this,Vt)):-1)+1)%t(this,X).length,E=t(this,X)[g];i(this,Vt,E),l(this,$,wo).call(this),this.config.card?.sendCommand("set_preset_mode",{preset_mode:E})}),this.renderCompanions(),A(this.root)}applyState(e,s){i(this,R,e==="on"),i(this,L,s?.percentage??0),i(this,ee,s?.oscillating??!1),i(this,Ot,s?.direction??"forward"),i(this,Vt,s?.preset_mode??null),s?.preset_modes?.length&&i(this,X,s.preset_modes),i(this,se,t(this,Rs)||s?.assumed_state===!0),Yo(this.root,!t(this,R)),w(t(this,ut),"fan",t(this,R));const o=this.def.icon_state_map?.[e]??this.def.icon_state_map?.["*"]??this.def.icon??"mdi:fan";if(this.renderIcon(this.resolveIcon(o,"mdi:fan"),"card-icon"),t(this,ut))if(t(this,R)&&t(this,L)>0&&!t(this,se)&&this.config.animate!==!1){const h=1/(1.5*Math.pow(t(this,L)/100,.5));t(this,ut).setAttribute("data-spinning","true"),t(this,ut).style.setProperty("--shroom-fan-duration",`${h.toFixed(2)}s`)}else t(this,ut).setAttribute("data-spinning","false");t(this,te)&&(t(this,R)&&t(this,L)>0&&!t(this,se)?t(this,te).textContent=`${Math.round(t(this,L))}%`:t(this,te).textContent=S(e)),l(this,$,qo).call(this),l(this,$,Bo).call(this),l(this,$,wo).call(this),this.announceState(`${this.def.friendly_name}, ${e}`+(t(this,L)>0&&!t(this,se)?`, ${Math.round(t(this,L))}%`:""))}predictState(e,s){return e==="toggle"?{state:t(this,R)?"off":"on",attributes:{percentage:t(this,L)}}:e==="set_percentage"?{state:"on",attributes:{percentage:s.percentage,oscillating:t(this,ee),direction:t(this,Ot),preset_mode:t(this,Vt),preset_modes:t(this,X)}}:e==="oscillate"?{state:"on",attributes:{percentage:t(this,L),oscillating:s.oscillating,direction:t(this,Ot)}}:e==="set_direction"?{state:"on",attributes:{percentage:t(this,L),oscillating:t(this,ee),direction:s.direction}}:null}}ut=new WeakMap,te=new WeakMap,W=new WeakMap,Me=new WeakMap,It=new WeakMap,qt=new WeakMap,Bt=new WeakMap,R=new WeakMap,L=new WeakMap,ee=new WeakMap,Ot=new WeakMap,Vt=new WeakMap,X=new WeakMap,He=new WeakMap,Rs=new WeakMap,se=new WeakMap,$=new WeakSet,_o=function(){const e=this.def?.feature_config;return e?.percentage_step>1?e.percentage_step:e?.speed_count>1?100/e.speed_count:1},ri=function(){return t(this,$,_o)>1},Io=function(){const e=t(this,$,_o),s=[];for(let o=1;o*e<=100.001;o++)s.push(o*e);return s},qo=function(){if(!t(this,W))return;const e=t(this,L);this.isSliderActive(t(this,W))||(t(this,W).value=String(e)),t(this,Me)&&(t(this,Me).style.left=`${e}%`)},Bo=function(){const e=t(this,$,_o)/2;this.root.querySelectorAll(".shroom-fan-step-dot").forEach(s=>{const o=Number(s.getAttribute("data-pct"));s.setAttribute("data-active",String(t(this,R)&&t(this,L)>=o-e))})},wo=function(){t(this,It)&&(t(this,It).setAttribute("aria-pressed","false"),t(this,It).textContent="Oscillate"),t(this,qt)&&(t(this,qt).textContent="Direction",t(this,qt).setAttribute("aria-label","Direction")),t(this,Bt)&&(t(this,Bt).textContent="Preset",t(this,Bt).setAttribute("data-active","false"))},ni=function(){t(this,L)<=0?this.config.card?.sendCommand("turn_off",{}):this.config.card?.sendCommand("set_percentage",{percentage:t(this,L)})};const Bi=`
    ${H}
    ${k}
  `;class Oi extends f{constructor(){super(...arguments);r(this,js,null);r(this,ke,null)}render(){M(this),this.root.innerHTML=`
        <style>${Bi}</style>
        <div part="card">
          <div class="shroom-state-item">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
  ...
  `;class Di extends f{constructor(){super(...arguments);r(this,Fs,null);r(this,Ee,null);r(this,Y,null);r(this,lt,!1);r(this,oe,!1)}render(){M(this);const e=this.def.capabilities==="read-write";i(this,oe,!1),this.root.innerHTML=`
        <style>${Vi}</style>
        <div part="card">
          <div class="shroom-state-item">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
  ...
  `;class Xo extends f{constructor(e,s,o,n){super(e,s,o,n);r(this,vt);r(this,Ws,null);r(this,Te,null);r(this,G,null);r(this,Ie,null);r(this,dt,0);r(this,ft,0);r(this,qe,100);r(this,Ys,1);r(this,Be);i(this,Be,rt(l(this,vt,hi).bind(this),300))}render(){M(this);const e=this.def.capabilities==="read-write";if(i(this,ft,this.def.feature_config?.min??0),i(this,qe,this.def.feature_config?.max??100),i(this,Ys,this.def.feature_config?.step??1),this.root.innerHTML=`
        <style>${Pi}</style>
        <div part="card">
          <div class="shroom-state-item">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
  ...
  `;class Zi extends f{constructor(e,s,o,n){super(e,s,o,n);r(this,N);r(this,Us,null);r(this,De,null);r(this,J,null);r(this,Pe,null);r(this,Ne,null);r(this,Q,null);r(this,ze,null);r(this,yt,0);r(this,Ze,null);r(this,ae,null);r(this,he,null);r(this,le,null);r(this,xt,0);r(this,ct,!1);r(this,Re,"closed");r(this,Ks,{});r(this,je);r(this,Fe);i(this,je,rt(l(this,N,pi).bind(this),300)),i(this,Fe,rt(l(this,N,mi).bind(this),300))}render(){M(this);const e=this.def.capabilities==="read-write",s=this.config.displayHints??{},o=s.show_position!==!1&&this.def.supported_features?.includes("set_position"),n=s.show_tilt!==!1&&this.def.supported_features?.includes("set_tilt_position"),h=!this.def.supported_features||this.def.supported_features.includes("buttons"),c=e&&(o||n||h);this.root.innerHTML=`
        <style>${zi}</style>
        <div part="card">
          <div class="shroom-state-item">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
  ...
  `;class Ki extends f{constructor(e,s,o,n){super(e,s,o,n);r(this,ye);r(this,io,null);r(this,fs,null);r(this,ge,null);r(this,vs,null);r(this,gs,null);r(this,bs,null);r(this,Rt,null);r(this,ro,null);r(this,no,null);r(this,ao,null);r(this,ys,null);r(this,st,null);r(this,jt,null);r(this,ho,!1);r(this,be,!1);r(this,ot,0);r(this,St,"idle");r(this,$t,{});r(this,xs);i(this,xs,rt(l(this,ye,_i).bind(this),200))}render(){M(this);const e=this.def.capabilities==="read-write",s=this.def.supported_features??[],o=this.config.displayHints??{},n=s.includes("previous_track");this.root.innerHTML=`
        <style>${Ui}</style>
        <div part="card">
          <div class="shroom-state-item">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
  ...
  `;class rr extends f{constructor(){super(...arguments);r(this,co,null);r(this,As,null);r(this,Ft,!1);r(this,xo,"unknown")}render(){M(this);const e=this.def.capabilities==="read-write";this.root.innerHTML=`
    ...
    ${H}
    ${k}
  `;class ei extends f{constructor(){super(...arguments);r(this,Ms,null);r(this,Hs,null)}render(){M(this);const e=this.def.capabilities==="read-write",s=this.i18n.t("action.run")!=="action.run"?this.i18n.t("action.run"):"Run";this.root.innerHTML=`
        <style>${nr}</style>
        <div part="card">
          <div class="shroom-state-item" data-tappable="${e}">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
  ...
  `;class si extends f{constructor(){super(...arguments);r(this,ks,null);r(this,Es,null);r(this,it,null)}render(){M(this);const e=this.def.capabilities==="read-write",s=this.i18n.t("action.trigger")!=="action.trigger"?this.i18n.t("action.trigger"):"Trigger";this.root.innerHTML=`
        <style>${ar}</style>
        <div part="card">
          <div class="shroom-state-item" data-tappable="${e}">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
  ...
  `;class Ao extends f{constructor(){super(...arguments);r(this,Ts,null);r(this,Is,null);r(this,Wt,null)}render(){M(this);const e=this.def.capabilities==="read-write",s=this.i18n.t("action.press")!=="action.press"?this.i18n.t("action.press"):"Press";this.root.innerHTML=`
    ...
    ${H}
    ${k}
  `;class Mo extends f{constructor(){super(...arguments);r(this,qs,null);r(this,Bs,null)}render(){M(this),this.root.innerHTML=`
        <style>${lr}</style>
        <div part="card">
          <div class="shroom-state-item">
            <span class="shroom-icon-shape" part="card-icon" aria-hidden="true"></span>
