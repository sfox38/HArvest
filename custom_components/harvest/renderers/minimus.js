(()=>{var Es=Object.defineProperty;var ln=$=>{throw TypeError($)};var Hs=($,y,p)=>y in $?Es($,y,{enumerable:!0,configurable:!0,writable:!0,value:p}):$[y]=p;var sr=($,y,p)=>Hs($,typeof y!="symbol"?y+"":y,p),qr=($,y,p)=>y.has($)||ln("Cannot "+p);var t=($,y,p)=>(qr($,y,"read from private field"),p?p.call($):y.get($)),s=($,y,p)=>y.has($)?ln("Cannot add the same private member more than once"):y instanceof WeakSet?y.add($):y.set($,p),n=($,y,p,Nt)=>(qr($,y,"write to private field"),Nt?Nt.call($,p):y.set($,p),p),h=($,y,p)=>(qr($,y,"access private method"),p);(function(){"use strict";var se,R,Ji,X,Lt,S,j,Qe,ti,ut,yt,vt,xt,$e,ei,N,K,kt,ii,ri,x,Ts,I,cn,pn,un,vn,gr,br,fn,Yi,mn,gn,Dr,bn,Pr,yn,wt,rt,pr,J,ni,Z,Mt,Et,Ht,Q,T,oe,Zt,tt,q,Se,si,oi,m,yr,or,zr,xr,Br,Rr,Gi,xn,wn,jr,_n,Or,Cn,wr,An,dt,Yt,Tt,ai,ae,hi,di,li,nt,st,ci,pi,ui,vi,Y,Le,It,ot,at,qt,fi,mi,gi,Dt,he,ke,bi,yi,xi,wi,_i,Qi,Ci,w,Vr,$n,Sn,Fr,ar,Wr,_r,Ln,kn,Nr,Zr,Mn,En,Me,Ee,Pt,D,He,Te,Ie,ft,de,Gt,zt,Ai,tr,er,$i,Bt,Cr,Hn,Tn,qe,Ut,O,G,Si,le,ce,Xt,V,lt,_t,Kt,pe,k,In,qn,Ui,Ar,Dn,Xi,et,F,De,ur,ue,Li,Jt,Pe,Qt,ve,fe,ht,P,Pn,zn,Yr,Gr,Ki,te,ki,Mi,ze,Be,Rt,z,Re,je,Oe,jt,ee,Ve,Fe,ir,me,$r,Bn,Ei,rr,Hi,Ti,Ot,Ii,We,mt,ie,ge,be,Ne,qi,Di,Ct,Pi,ct,Rn,jn,On,hr,zi,Vt,Ze,Ye,Bi,Ge,Ri,ji,Oi,Vi,pt,Ft,gt,Fi,Wi,L,Ce,Sr,Ue,Xe,Ur,Xr,Kr,Vn,re,Ni,ye,vr,ne,fr,xe,At,mr,we,Zi;const $=window.HArvest;if(!$||!$.renderers||!$.renderers.BaseCard){console.warn("[HArvest minimus] HArvest not found - pack not loaded.");return}const y=$.renderers.BaseCard,p=window.HArvest.esc;function Nt(c,v){let e=null;return function(...i){e&&clearTimeout(e),e=setTimeout(()=>{e=null,c.apply(this,i)},v)}}function Ke(c){return c?c.charAt(0).toUpperCase()+c.slice(1).replace(/_/g," "):""}const W=`
    [part=companion-zone] {
      display: flex;
      flex-wrap: wrap;
  ...
  `;function Fn(c){if(!c)return()=>{};const v=80,e=1.6,i=.96,r=.04;let o=null,a=0,d=0,l=0,u=!1,f=0;const b=[],g=()=>{f&&(cancelAnimationFrame(f),f=0)},M=A=>{for(;b.length&&b[0].t<A-v;)b.shift();if(b.length<2)return 0;const U=b[0],Wt=b[b.length-1],nr=Wt.t-U.t;return nr<=0?0:(Wt.x-U.x)/nr},_=()=>{if(Math.abs(l)<r)return;let A=performance.now();const U=Wt=>{const nr=Wt-A;if(A=Wt,c.scrollLeft-=l*nr,l*=Math.pow(i,nr/16),Math.abs(l)<r){f=0,l=0;return}const Ms=c.scrollWidth-c.clientWidth;if(c.scrollLeft<=0||c.scrollLeft>=Ms){f=0,l=0;return}f=requestAnimationFrame(U)};f=requestAnimationFrame(U)},_e=A=>{if(c.scrollWidth<=c.clientWidth||A.pointerType==="touch")return;const U=A.target;if(!(U&&U!==c&&U.closest?.("button, a"))){g(),o=A.pointerId,a=A.clientX,d=c.scrollLeft,l=0,u=!1,b.length=0,b.push({x:A.clientX,t:A.timeStamp});try{c.setPointerCapture(o)}catch{}}},C=A=>{if(A.pointerId!==o)return;const U=A.clientX-a;Math.abs(U)>4&&(u=!0,c.dataset.dragging="true"),c.scrollLeft=d-U,b.push({x:A.clientX,t:A.timeStamp});const Wt=A.timeStamp-v;for(;b.length>2&&b[0].t<Wt;)b.shift()},E=A=>{if(A.pointerId===o){try{c.releasePointerCapture(o)}catch{}if(o=null,u){const U=Wt=>{Wt.stopPropagation(),Wt.preventDefault()};window.addEventListener("click",U,{capture:!0,once:!0}),requestAnimationFrame(()=>c.removeAttribute("data-dragging")),l=M(A.timeStamp)*e,_()}b.length=0}};return c.addEventListener("pointerdown",_e),c.addEventListener("pointermove",C),c.addEventListener("pointerup",E),c.addEventListener("pointercancel",E),c.addEventListener("wheel",g,{passive:!0}),c.addEventListener("touchstart",g,{passive:!0}),()=>{g(),c.removeEventListener("pointerdown",_e),c.removeEventListener("pointermove",C),c.removeEventListener("pointerup",E),c.removeEventListener("pointercancel",E),c.removeEventListener("wheel",g),c.removeEventListener("touchstart",g)}}function B(c){c.querySelectorAll("[part=companion]").forEach(v=>{v.title=v.getAttribute("aria-label")??""})}const Wn=60,Nn=60,Ae=48,it=225,H=270,$t=2*Math.PI*Ae*(H/360);function Zn(c){return c*Math.PI/180}function bt(c){const v=Zn(c);return{x:Wn+Ae*Math.cos(v),y:Nn-Ae*Math.sin(v)}}function Yn(){const c=bt(it),v=bt(it-H);return`M ${c.x} ${c.y} A ${Ae} ${Ae} 0 1 1 ${v.x} ${v.y}`}const Je=Yn(),St=["brightness","temp","color"],dr=120;function Jr(c){const v=H/dr;let e="";for(let i=0;i<dr;i++){const r=it-i*v,o=it-(i+1)*v,a=bt(r),d=bt(o),l=`M ${a.x} ${a.y} A ${Ae} ${Ae} 0 0 1 ${d.x} ${d.y}`,u=i===0||i===dr-1?"round":"butt";e+=`<path d="${l}" stroke="${c(i/dr)}" fill="none" stroke-width="8" stroke-linecap="${u}" />`}return e}const Gn=Jr(c=>`hsl(${Math.round(c*360)},100%,50%)`),Un=Jr(c=>{const e=Math.round(143+112*c),i=Math.round(255*c);return`rgb(255,${e},${i})`}),Lr=`
    [part=card] {
  ...
  `;class Kn extends y{constructor(e,i,r,o){super(e,i,r,o);s(this,x);s(this,se,null);s(this,R,null);s(this,Ji,null);s(this,X,null);s(this,Lt,null);s(this,S,null);s(this,j,null);s(this,Qe,null);s(this,ti,null);s(this,ut,0);s(this,yt,4e3);s(this,vt,0);s(this,xt,!1);s(this,$e,!1);s(this,ei,null);s(this,N,0);s(this,K,2e3);s(this,kt,6500);s(this,ii);s(this,ri,new Map);s(this,I,[]);n(this,ii,Nt(h(this,x,yn).bind(this),300))}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],r=this.config.displayHints??{},o=r.show_brightness!==!1&&i.includes("brightness"),a=r.show_color_temp!==!1&&i.includes("color_temp"),d=r.show_rgb!==!1&&i.includes("rgb_color"),l=e&&(o||a||d),u=[o,a,d].filter(Boolean).length,f=e&&u>1;n(this,K,this.def.feature_config?.min_color_temp_kelvin??2e3),n(this,kt,this.def.feature_config?.max_color_temp_kelvin??6500);const b=bt(it);this.root.innerHTML=`
        <style>${Lr}${Xn}</style>
        <div part="card">
      ...
      `,n(this,se,this.root.querySelector("[part=toggle-button]")),n(this,R,this.root.querySelector(".hrv-dial-fill")),n(this,Ji,this.root.querySelector(".hrv-dial-track")),n(this,X,this.root.querySelector(".hrv-dial-thumb")),n(this,Lt,this.root.querySelector(".hrv-dial-pct")),n(this,S,this.root.querySelector(".hrv-dial-wrap")),n(this,ei,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,Qe,this.root.querySelector(".hrv-dial-segs-color")),n(this,ti,this.root.querySelector(".hrv-dial-segs-temp")),n(this,j,this.root.querySelector(".hrv-mode-switch")),t(this,se)&&(l||this.renderIcon(this.resolveIcon(this.def.icon,"mdi:lightbulb"),"card-icon"),this._attachGestureHandlers(t(this,se),{onTap:()=>{const g=this.config.gestureConfig?.tap;if(g){this._runAction(g);return}this.config.card?.sendCommand("toggle",{})}})),t(this,S)&&(t(this,S).addEventListener("pointerdown",h(this,x,mn).bind(this)),t(this,S).addEventListener("pointermove",h(this,x,gn).bind(this)),t(this,S).addEventListener("pointerup",h(this,x,Dr).bind(this)),t(this,S).addEventListener("pointercancel",h(this,x,Dr).bind(this)),t(this,S).addEventListener("keydown",h(this,x,bn).bind(this))),l&&h(this,x,cn).call(this),t(this,j)&&(t(this,j).addEventListener("click",h(this,x,pn).bind(this)),t(this,j).addEventListener("keydown",h(this,x,vn).bind(this)),t(this,j).addEventListener("mousemove",h(this,x,un).bind(this))),h(this,x,br).call(this),this.root.querySelector("[part=ro-state-icon]")&&this.renderIcon(this.resolveIcon(this.def.icon,"mdi:lightbulb"),"ro-state-icon"),this.renderCompanions(),this.root.querySelectorAll("[part=companion]").forEach(g=>{g.title=g.getAttribute("aria-label")??"Companion";const M=g.getAttribute("data-entity");if(M&&t(this,ri).has(M)){const _=t(this,ri).get(M);g.setAttribute("data-on",String(_==="on"))}})}applyState(e,i){if(n(this,xt,e==="on"),n(this,ut,i?.brightness??0),i?.color_temp_kelvin!==void 0?n(this,yt,i.color_temp_kelvin):i?.color_temp!==void 0&&i.color_temp>0&&n(this,yt,Math.round(1e6/i.color_temp)),i?.hs_color)n(this,vt,Math.round(i.hs_color[0]));else if(i?.rgb_color){const[o,a,d]=i.rgb_color;n(this,vt,ts(o,a,d))}if(t(this,se)&&(t(this,se).setAttribute("aria-pressed",String(t(this,xt))),this.root.querySelector("[part=card-icon]"))){const a=t(this,xt)?"mdi:lightbulb":"mdi:lightbulb-outline",d=this.def.icon_state_map?.[e]??this.def.icon??a;this.renderIcon(this.resolveIcon(d,a),"card-icon")}const r=this.root.querySelector(".hrv-light-ro-circle");if(r){r.setAttribute("data-on",String(t(this,xt)));const o=t(this,xt)?"mdi:lightbulb":"mdi:lightbulb-outline",a=this.def.icon_state_map?.[e]??this.def.icon_state_map?.["*"]??this.def.icon??o;this.renderIcon(this.resolveIcon(a,o),"ro-state-icon");const d=i?.color_mode,l=d==="color_temp",u=d&&d!=="color_temp",f=this.root.querySelector('[data-attr="brightness"]');if(f){const M=Math.round(t(this,ut)/255*100);f.title=t(this,xt)?`Brightness: ${M}%`:"Brightness: off"}const b=this.root.querySelector('[data-attr="temp"]');b&&(b.title=`Color temperature: ${t(this,yt)}K`,b.style.display=u?"none":"");const g=this.root.querySelector('[data-attr="color"]');if(g)if(g.style.display=l?"none":"",i?.rgb_color){const[M,_,_e]=i.rgb_color;g.style.background=`rgb(${M},${_},${_e})`,g.title=`Color: rgb(${M}, ${_}, ${_e})`}else g.style.background=`hsl(${t(this,vt)}, 100%, 50%)`,g.title=`Color: hue ${t(this,vt)}°`}h(this,x,gr).call(this)}predictState(e,i){return e==="toggle"?{state:t(this,xt)?"off":"on",attributes:{brightness:t(this,ut)}}:e==="turn_on"&&i.brightness!==void 0?{state:"on",attributes:{brightness:i.brightness}}:null}updateCompanionState(e,i,r){t(this,ri).set(e,i),super.updateCompanionState(e,i,r)}}se=new WeakMap,R=new WeakMap,Ji=new WeakMap,X=new WeakMap,Lt=new WeakMap,S=new WeakMap,j=new WeakMap,Qe=new WeakMap,ti=new WeakMap,ut=new WeakMap,yt=new WeakMap,vt=new WeakMap,xt=new WeakMap,$e=new WeakMap,ei=new WeakMap,N=new WeakMap,K=new WeakMap,kt=new WeakMap,ii=new WeakMap,ri=new WeakMap,x=new WeakSet,Ts=function(){const e=this.def.supported_features??[],i=[];return e.includes("brightness")&&i.push("brightness"),e.includes("color_temp")&&i.push("temp"),e.includes("rgb_color")&&i.push("color"),i.length>0?i:["brightness"]},I=new WeakMap,cn=function(){const e=this.def.supported_features??[],i=[e.includes("brightness"),e.includes("color_temp"),e.includes("rgb_color")];n(this,I,[]),i[0]&&t(this,I).push(0),i[1]&&t(this,I).push(1),i[2]&&t(this,I).push(2),t(this,I).length===0&&t(this,I).push(0),t(this,I).includes(t(this,N))||n(this,N,t(this,I)[0])},pn=function(e){const i=t(this,j).getBoundingClientRect(),r=e.clientY-i.top,o=i.height/3;let a;r<o?a=0:r<o*2?a=1:a=2,a=Math.min(a,t(this,I).length-1),n(this,N,t(this,I)[a]),t(this,j).setAttribute("data-pos",String(a)),t(this,j).setAttribute("aria-valuenow",String(a+1)),t(this,j).setAttribute("aria-valuetext",St[t(this,N)]),h(this,x,br).call(this),h(this,x,gr).call(this)},un=function(e){const i={brightness:"Brightness",temp:"Color Temperature",color:"Color"},r=t(this,j).getBoundingClientRect(),o=Math.min(Math.floor((e.clientY-r.top)/(r.height/t(this,I).length)),t(this,I).length-1),a=St[t(this,I)[Math.max(0,o)]];t(this,j).title=`Dial mode: ${i[a]??a}`},vn=function(e){const i=t(this,I).indexOf(t(this,N));let r=i;if(e.key==="ArrowUp"||e.key==="ArrowLeft")r=Math.max(0,i-1);else if(e.key==="ArrowDown"||e.key==="ArrowRight")r=Math.min(t(this,I).length-1,i+1);else return;e.preventDefault(),n(this,N,t(this,I)[r]),t(this,j).setAttribute("data-pos",String(r)),t(this,j).setAttribute("aria-valuenow",String(r+1)),t(this,j).setAttribute("aria-valuetext",St[t(this,N)]),h(this,x,br).call(this),h(this,x,gr).call(this)},gr=function(){t(this,X)&&(t(this,X).style.transition="none"),t(this,R)&&(t(this,R).style.transition="none"),h(this,x,fn).call(this),t(this,X)?.getBoundingClientRect(),t(this,R)?.getBoundingClientRect(),t(this,X)&&(t(this,X).style.transition=""),t(this,R)&&(t(this,R).style.transition="")},br=function(){if(!t(this,R))return;const e=St[t(this,N)],i=e==="color"||e==="temp";t(this,Ji).style.display=i?"none":"",t(this,R).style.display=i?"none":"",t(this,Qe)&&t(this,Qe).classList.toggle("hrv-dial-segs-visible",e==="color"),t(this,ti)&&t(this,ti).classList.toggle("hrv-dial-segs-visible",e==="temp"),e==="brightness"&&t(this,R).setAttribute("stroke-dasharray",String($t));const r={brightness:"brightness",temp:"color temperature",color:"color"},o={brightness:"Drag to adjust brightness",temp:"Drag to adjust color temperature",color:"Drag to adjust color"};t(this,S)?.setAttribute("aria-label",`${p(this.def.friendly_name)} ${r[e]}`),t(this,S)&&(t(this,S).title=o[e]),t(this,S)&&(t(this,S).setAttribute("aria-valuemin",e==="temp"?String(t(this,K)):"0"),t(this,S).setAttribute("aria-valuemax",e==="temp"?String(t(this,kt)):e==="color"?"360":"100"))},fn=function(){const e=St[t(this,N)];if(e==="brightness"){const i=t(this,xt)?t(this,ut):0;h(this,x,Yi).call(this,Math.round(i/255*100))}else if(e==="temp"){const i=Math.round((t(this,yt)-t(this,K))/(t(this,kt)-t(this,K))*100);h(this,x,Yi).call(this,Math.max(0,Math.min(100,i)))}else{const i=Math.round(t(this,vt)/360*100);h(this,x,Yi).call(this,i)}},Yi=function(e){const i=St[t(this,N)],r=e/100*H,o=bt(it-r);if(t(this,X)?.setAttribute("cx",String(o.x)),t(this,X)?.setAttribute("cy",String(o.y)),t(this,ei)?.setAttribute("cx",String(o.x)),t(this,ei)?.setAttribute("cy",String(o.y)),i==="brightness"){const a=$t*(1-e/100);t(this,R)?.setAttribute("stroke-dashoffset",String(a)),t(this,Lt)&&(t(this,Lt).textContent=e+"%"),t(this,S)?.setAttribute("aria-valuenow",String(e)),t(this,S)?.setAttribute("aria-valuetext",`${e}%`)}else if(i==="temp"){const a=Math.round(t(this,K)+e/100*(t(this,kt)-t(this,K)));t(this,Lt)&&(t(this,Lt).textContent=a+"K"),t(this,S)?.setAttribute("aria-valuenow",String(a)),t(this,S)?.setAttribute("aria-valuetext",`${a} kelvin`)}else{const a=Math.round(e/100*360);t(this,Lt)&&(t(this,Lt).textContent=a+"°"),t(this,S)?.setAttribute("aria-valuenow",String(a)),t(this,S)?.setAttribute("aria-valuetext",`${a} degrees`)}},mn=function(e){n(this,$e,!0),t(this,S)?.setPointerCapture(e.pointerId),h(this,x,Pr).call(this,e)},gn=function(e){t(this,$e)&&h(this,x,Pr).call(this,e)},Dr=function(e){if(t(this,$e)){n(this,$e,!1);try{t(this,S)?.releasePointerCapture(e.pointerId)}catch{}t(this,ii).call(this)}},bn=function(e){const i=St[t(this,N)];let r=Math.round(i==="brightness"?t(this,ut)/255*100:i==="temp"?(t(this,yt)-t(this,K))/(t(this,kt)-t(this,K))*100:t(this,vt)/360*100);if(e.key==="ArrowDown"||e.key==="ArrowLeft")r-=1;else if(e.key==="ArrowUp"||e.key==="ArrowRight")r+=1;else if(e.key==="PageDown")r-=10;else if(e.key==="PageUp")r+=10;else if(e.key==="Home")r=0;else if(e.key==="End")r=100;else return;e.preventDefault(),r=Math.max(0,Math.min(100,r)),i==="brightness"?n(this,ut,Math.round(r/100*255)):i==="temp"?n(this,yt,Math.round(t(this,K)+r/100*(t(this,kt)-t(this,K)))):n(this,vt,Math.round(r/100*360)),h(this,x,Yi).call(this,r),t(this,ii).call(this)},Pr=function(e){if(!t(this,S))return;const i=t(this,S).getBoundingClientRect(),r=i.left+i.width/2,o=i.top+i.height/2,a=e.clientX-r,d=-(e.clientY-o);let l=Math.atan2(d,a)*180/Math.PI;l<0&&(l+=360);let u=it-l;u<0&&(u+=360),u>H&&(u=u>H+(360-H)/2?0:H);const f=Math.round(u/H*100),b=St[t(this,N)];b==="brightness"?n(this,ut,Math.round(f/100*255)):b==="temp"?n(this,yt,Math.round(t(this,K)+f/100*(t(this,kt)-t(this,K)))):n(this,vt,Math.round(f/100*360)),t(this,R)&&(t(this,R).style.transition="none"),t(this,X)&&(t(this,X).style.transition="none"),h(this,x,Yi).call(this,f)},yn=function(){t(this,R)&&(t(this,R).style.transition=""),t(this,X)&&(t(this,X).style.transition="");const e=St[t(this,N)];e==="brightness"?t(this,ut)===0?this.config.card?.sendCommand("turn_off",{}):this.config.card?.sendCommand("turn_on",{brightness:t(this,ut)}):e==="temp"?this.config.card?.sendCommand("turn_on",{color_temp_kelvin:t(this,yt)}):this.config.card?.sendCommand("turn_on",{hs_color:[t(this,vt),100]})};const Jn=Lr+`
    .hrv-fan-feat-btn {
      width: 40px;
      height: 40px;
      border-radius: 50%;
  ...
  `;class Qn extends y{constructor(e,i,r,o){super(e,i,r,o);s(this,m);s(this,wt,null);s(this,rt,null);s(this,pr,null);s(this,J,null);s(this,ni,null);s(this,Z,null);s(this,Mt,null);s(this,Et,null);s(this,Ht,null);s(this,Q,!1);s(this,T,0);s(this,oe,!1);s(this,Zt,"forward");s(this,tt,null);s(this,q,[]);s(this,Se,!1);s(this,si,null);s(this,oi);n(this,oi,Nt(h(this,m,Cn).bind(this),300)),n(this,q,e.feature_config?.preset_modes??[])}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],r=this.config.displayHints??this.def.display_hints??{},o=r.display_mode??null;let a=i.includes("set_speed");const d=r.show_oscillate!==!1&&i.includes("oscillate"),l=r.show_direction!==!1&&i.includes("direction"),u=r.show_presets!==!1&&i.includes("preset_mode");o==="on-off"&&(a=!1);let f=e&&a,b=f&&t(this,m,or),g=b&&!t(this,q).length,M=b&&!!t(this,q).length;o==="continuous"?(b=!1,g=!1,M=!1):o==="stepped"?(M=!1,g=b&&!t(this,q).length):o==="cycle"&&(b=!0,M=!0,g=!1);const _=bt(it);this.root.innerHTML=`
        <style>${Jn}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
                ...
                ${g?`
                  <div class="hrv-fan-hspeed-wrap">
                    <div class="hrv-fan-hspeed-switch" role="group"
                      ...
                      ${t(this,m,xr).map((C,E)=>`
                        <div class="hrv-fan-hspeed-dot" data-pct="${C}" data-idx="${E}"
                          data-active="false"
                          role="button" tabindex="0"
                          aria-label="Speed ${E+1} (${C}%)"
                          title="Speed ${E+1} (${C}%)"></div>
                      `).join("")}
                    </div>
                  </div>
                `:M?`
      ...
      `,n(this,wt,this.root.querySelector("[part=toggle-button]")),n(this,rt,this.root.querySelector(".hrv-dial-fill")),n(this,pr,this.root.querySelector(".hrv-dial-track")),n(this,J,this.root.querySelector(".hrv-dial-thumb")),n(this,ni,this.root.querySelector(".hrv-dial-pct")),n(this,Z,this.root.querySelector(".hrv-dial-wrap")),n(this,si,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,Mt,this.root.querySelector('[data-feat="oscillate"]')),n(this,Et,this.root.querySelector('[data-feat="direction"]')),n(this,Ht,this.root.querySelector('[data-feat="preset"]')),t(this,wt)&&!f&&(this.renderIcon(this.resolveIcon(this.def.icon,"mdi:fan"),"fan-onoff-icon"),t(this,wt).setAttribute("data-animate",String(!!this.config.animate))),this._attachGestureHandlers(t(this,wt),{onTap:()=>{const C=this.config.gestureConfig?.tap;if(C){this._runAction(C);return}this.config.card?.sendCommand("toggle",{})}}),t(this,Z)&&(t(this,Z).addEventListener("pointerdown",h(this,m,xn).bind(this)),t(this,Z).addEventListener("pointermove",h(this,m,wn).bind(this)),t(this,Z).addEventListener("pointerup",h(this,m,jr).bind(this)),t(this,Z).addEventListener("pointercancel",h(this,m,jr).bind(this)),t(this,Z).addEventListener("keydown",h(this,m,_n).bind(this))),this.root.querySelector(".hrv-fan-speed-circle")?.addEventListener("click",()=>{const C=t(this,m,xr);if(!C.length)return;let E;if(!t(this,Q)||t(this,T)===0)E=C[0],n(this,Q,!0),t(this,wt)?.setAttribute("aria-pressed","true");else{const A=C.findIndex(U=>U>t(this,T));E=A===-1?C[0]:C[A]}n(this,T,E),h(this,m,Br).call(this),this.config.card?.sendCommand("set_percentage",{percentage:E})}),this.root.querySelectorAll(".hrv-fan-hspeed-dot").forEach(C=>{const E=()=>{const A=Number(C.getAttribute("data-pct"));t(this,Q)||(n(this,Q,!0),t(this,wt)?.setAttribute("aria-pressed","true")),n(this,T,A),h(this,m,Rr).call(this),this.config.card?.sendCommand("set_percentage",{percentage:A})};C.addEventListener("click",E),C.addEventListener("keydown",A=>{(A.key==="Enter"||A.key===" ")&&(A.preventDefault(),E())})}),t(this,Mt)?.addEventListener("click",()=>{this.config.card?.sendCommand("oscillate",{oscillating:!t(this,oe)})}),t(this,Et)?.addEventListener("click",()=>{const C=t(this,Zt)==="forward"?"reverse":"forward";n(this,Zt,C),h(this,m,Gi).call(this),this.config.card?.sendCommand("set_direction",{direction:C})}),t(this,Ht)?.addEventListener("click",()=>{if(t(this,q).length){if(t(this,m,zr)){const C=t(this,tt)??t(this,q)[0];this.config.card?.sendCommand("set_preset_mode",{preset_mode:C});return}if(t(this,tt)){const C=t(this,q).indexOf(t(this,tt));if(C===-1||C===t(this,q).length-1){n(this,tt,null),h(this,m,Gi).call(this);const E=t(this,m,yr),A=Math.floor(t(this,T)/E)*E||E;this.config.card?.sendCommand("set_percentage",{percentage:A})}else{const E=t(this,q)[C+1];n(this,tt,E),h(this,m,Gi).call(this),this.config.card?.sendCommand("set_preset_mode",{preset_mode:E})}}else{const C=t(this,q)[0];n(this,tt,C),h(this,m,Gi).call(this),this.config.card?.sendCommand("set_preset_mode",{preset_mode:C})}}}),this.root.querySelector(".hrv-fan-ro-circle")&&this.renderIcon(this.resolveIcon(this.def.icon,"mdi:fan"),"ro-state-icon"),this.renderCompanions(),this.root.querySelectorAll("[part=companion]").forEach(C=>{C.title=C.getAttribute("aria-label")??"Companion"})}applyState(e,i){n(this,Q,e==="on"),n(this,T,i?.percentage??0),n(this,oe,i?.oscillating??!1),n(this,Zt,i?.direction??"forward"),n(this,tt,i?.preset_mode??null),i?.preset_modes?.length&&n(this,q,i.preset_modes),t(this,wt)&&t(this,wt).setAttribute("aria-pressed",String(t(this,Q)));const r=this.root.querySelector(".hrv-fan-ro-circle");r&&r.setAttribute("data-on",String(t(this,Q))),t(this,m,or)&&!t(this,q).length?h(this,m,Rr).call(this):t(this,m,or)?h(this,m,Br).call(this):h(this,m,An).call(this),h(this,m,Gi).call(this),this.announceState(`${this.def.friendly_name}, ${e}`+(t(this,T)>0?`, ${Math.round(t(this,T))}%`:""))}predictState(e,i){return e==="toggle"?{state:t(this,Q)?"off":"on",attributes:{percentage:t(this,T)}}:e==="set_percentage"?{state:"on",attributes:{percentage:i.percentage,oscillating:t(this,oe),direction:t(this,Zt),preset_mode:t(this,tt),preset_modes:t(this,q)}}:null}}wt=new WeakMap,rt=new WeakMap,pr=new WeakMap,J=new WeakMap,ni=new WeakMap,Z=new WeakMap,Mt=new WeakMap,Et=new WeakMap,Ht=new WeakMap,Q=new WeakMap,T=new WeakMap,oe=new WeakMap,Zt=new WeakMap,tt=new WeakMap,q=new WeakMap,Se=new WeakMap,si=new WeakMap,oi=new WeakMap,m=new WeakSet,yr=function(){const e=this.def?.feature_config;return e?.percentage_step>1?e.percentage_step:e?.speed_count>1?100/e.speed_count:1},or=function(){return t(this,m,yr)>1},zr=function(){return t(this,m,or)&&t(this,q).length>0},xr=function(){const e=t(this,m,yr),i=[];for(let r=1;r*e<=100.001;r++)i.push(r*e);return i},Br=function(){const e=this.root.querySelector(".hrv-fan-speed-circle");if(!e)return;e.setAttribute("aria-pressed",String(t(this,Q)));const i=t(this,Q)?"Click to increase fan speed":"Fan off - click to turn on";e.setAttribute("aria-label",i),e.title=i},Rr=function(){const e=this.root.querySelector(".hrv-fan-hspeed-switch");if(!e)return;const i=e.querySelector(".hrv-fan-hspeed-thumb"),r=t(this,m,xr);let o=-1;if(t(this,Q)&&t(this,T)>0){let a=1/0;r.forEach((d,l)=>{const u=Math.abs(d-t(this,T));u<a&&(a=u,o=l)})}e.setAttribute("data-on",String(o>=0)),i&&o>=0&&(i.style.left=`${2+o*32}px`),e.querySelectorAll(".hrv-fan-hspeed-dot").forEach((a,d)=>{a.setAttribute("data-active",String(d===o))})},Gi=function(){const e=t(this,m,zr);if(t(this,Mt)){const i=e||t(this,oe),r=e?"Oscillate":`Oscillate: ${t(this,oe)?"on":"off"}`;t(this,Mt).setAttribute("data-on",String(i)),t(this,Mt).setAttribute("aria-pressed",String(i)),t(this,Mt).setAttribute("aria-label",r),t(this,Mt).title=r}if(t(this,Et)){const i=t(this,Zt)!=="reverse",r=`Direction: ${t(this,Zt)}`;t(this,Et).setAttribute("data-on",String(i)),t(this,Et).setAttribute("aria-pressed",String(i)),t(this,Et).setAttribute("aria-label",r),t(this,Et).title=r}if(t(this,Ht)){const i=e||!!t(this,tt),r=e?t(this,tt)??t(this,q)[0]??"Preset":t(this,tt)?`Preset: ${t(this,tt)}`:"Preset: none";t(this,Ht).setAttribute("data-on",String(i)),t(this,Ht).setAttribute("aria-pressed",String(i)),t(this,Ht).setAttribute("aria-label",r),t(this,Ht).title=r}},xn=function(e){n(this,Se,!0),t(this,Z)?.setPointerCapture(e.pointerId),h(this,m,Or).call(this,e)},wn=function(e){t(this,Se)&&h(this,m,Or).call(this,e)},jr=function(e){if(t(this,Se)){n(this,Se,!1);try{t(this,Z)?.releasePointerCapture(e.pointerId)}catch{}t(this,oi).call(this)}},_n=function(e){let i=t(this,T);if(e.key==="ArrowDown"||e.key==="ArrowLeft")i-=1;else if(e.key==="ArrowUp"||e.key==="ArrowRight")i+=1;else if(e.key==="PageDown")i-=10;else if(e.key==="PageUp")i+=10;else if(e.key==="Home")i=0;else if(e.key==="End")i=100;else return;e.preventDefault(),n(this,T,Math.max(0,Math.min(100,i))),h(this,m,wr).call(this,t(this,T)),t(this,oi).call(this)},Or=function(e){if(!t(this,Z))return;const i=t(this,Z).getBoundingClientRect(),r=i.left+i.width/2,o=i.top+i.height/2,a=e.clientX-r,d=-(e.clientY-o);let l=Math.atan2(d,a)*180/Math.PI;l<0&&(l+=360);let u=it-l;u<0&&(u+=360),u>H&&(u=u>H+(360-H)/2?0:H),n(this,T,Math.round(u/H*100)),t(this,rt)&&(t(this,rt).style.transition="none"),t(this,J)&&(t(this,J).style.transition="none"),h(this,m,wr).call(this,t(this,T))},Cn=function(){t(this,rt)&&(t(this,rt).style.transition=""),t(this,J)&&(t(this,J).style.transition=""),t(this,T)===0?this.config.card?.sendCommand("turn_off",{}):this.config.card?.sendCommand("set_percentage",{percentage:t(this,T)})},wr=function(e){const i=$t*(1-e/100),r=bt(it-e/100*H);t(this,rt)?.setAttribute("stroke-dashoffset",String(i)),t(this,J)?.setAttribute("cx",String(r.x)),t(this,J)?.setAttribute("cy",String(r.y)),t(this,si)?.setAttribute("cx",String(r.x)),t(this,si)?.setAttribute("cy",String(r.y)),t(this,ni)&&(t(this,ni).textContent=`${e}%`),t(this,Z)?.setAttribute("aria-valuenow",String(e)),t(this,Z)?.setAttribute("aria-valuetext",`${e}%`)},An=function(){t(this,J)&&(t(this,J).style.transition="none"),t(this,rt)&&(t(this,rt).style.transition="none"),h(this,m,wr).call(this,t(this,Q)?t(this,T):0),t(this,J)?.getBoundingClientRect(),t(this,rt)?.getBoundingClientRect(),t(this,J)&&(t(this,J).style.transition=""),t(this,rt)&&(t(this,rt).style.transition="")};function ts(c,v,e){c/=255,v/=255,e/=255;const i=Math.max(c,v,e),r=Math.min(c,v,e),o=i-r;if(o===0)return 0;let a;return i===c?a=(v-e)/o%6:i===v?a=(e-c)/o+2:a=(c-v)/o+4,Math.round((a*60+360)%360)}const es=Lr+`
    [part=card-body] {
      flex-direction: column;
      align-items: stretch;
      gap: 0;
  ...
  `;class is extends y{constructor(e,i,r,o){super(e,i,r,o);s(this,w);s(this,dt,null);s(this,Yt,null);s(this,Tt,null);s(this,ai,null);s(this,ae,!1);s(this,hi,null);s(this,di,null);s(this,li,null);s(this,nt,null);s(this,st,null);s(this,ci,null);s(this,pi,null);s(this,ui,null);s(this,vi,null);s(this,Y,null);s(this,Le,null);s(this,It,null);s(this,ot,null);s(this,at,20);s(this,qt,"off");s(this,fi,null);s(this,mi,null);s(this,gi,null);s(this,Dt,16);s(this,he,32);s(this,ke,.5);s(this,bi,"°C");s(this,yi,[]);s(this,xi,[]);s(this,wi,[]);s(this,_i,[]);s(this,Qi,{});s(this,Ci);n(this,Ci,Nt(h(this,w,Mn).bind(this),500))}render(){const e=this.def.capabilities==="read-write",i=this.config.displayHints??{},r=this.def.supported_features?.includes("target_temperature"),o=i.show_fan_mode!==!1&&(this.def.supported_features?.includes("fan_mode")||this.def.feature_config?.fan_modes?.length>0),a=i.show_presets!==!1&&(this.def.supported_features?.includes("preset_mode")||this.def.feature_config?.preset_modes?.length>0),d=i.show_swing_mode!==!1&&(this.def.supported_features?.includes("swing_mode")||this.def.feature_config?.swing_modes?.length>0);n(this,Dt,this.def.feature_config?.min_temp??16),n(this,he,this.def.feature_config?.max_temp??32),n(this,ke,this.def.feature_config?.temp_step??.5),n(this,bi,this.def.unit_of_measurement??"°C"),n(this,yi,this.def.feature_config?.hvac_modes??["off","heat","cool","heat_cool","auto","dry","fan_only"]),n(this,xi,this.def.feature_config?.fan_modes??[]),n(this,wi,this.def.feature_config?.preset_modes??[]),n(this,_i,this.def.feature_config?.swing_modes??[]);const l=h(this,w,Vr).call(this,t(this,at)),u=bt(it),f=bt(it-l/100*H),b=$t*(1-l/100),[g,M]=t(this,at).toFixed(1).split(".");this.root.innerHTML=`
        <style>${es}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
            ...
            ${e&&r?`
              <div class="hrv-dial-wrap">
                <svg viewBox="0 0 120 120" aria-hidden="true">
                  <path class="hrv-dial-track" d="${Je}"/>
                  <path class="hrv-dial-fill" d="${Je}"
                    stroke-dasharray="${$t}" stroke-dashoffset="${b}"/>
                ...
                <div class="hrv-climate-center">
                  ...
                  <div class="hrv-climate-temp-row">
                    <span class="hrv-climate-temp-int">${p(g)}</span><span class="hrv-climate-temp-frac">.${p(M)}</span><span class="hrv-climate-temp-unit">${p(t(this,bi))}</span>
                  </div>
                </div>
              </div>
            ...
            `:!e&&r?`
              <div class="hrv-climate-ro-temp">
                <div class="hrv-climate-ro-temp-row">
                  <span class="hrv-climate-ro-temp-int">${p(g)}</span><span class="hrv-climate-ro-temp-frac">.${p(M)}</span><span class="hrv-climate-ro-temp-unit">${p(t(this,bi))}</span>
                </div>
              </div>
            `:""}
      ...
      `,n(this,dt,this.root.querySelector(".hrv-dial-wrap")),n(this,Yt,this.root.querySelector(".hrv-dial-fill")),n(this,Tt,this.root.querySelector(".hrv-dial-thumb")),n(this,ai,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,hi,this.root.querySelector(".hrv-climate-state-text")),n(this,di,this.root.querySelector(".hrv-climate-temp-int")),n(this,li,this.root.querySelector(".hrv-climate-temp-frac")),n(this,nt,this.root.querySelector("[data-dir='-']")),n(this,st,this.root.querySelector("[data-dir='+']")),n(this,ci,this.root.querySelector("[data-feat=mode]")),n(this,pi,this.root.querySelector("[data-feat=fan]")),n(this,ui,this.root.querySelector("[data-feat=preset]")),n(this,vi,this.root.querySelector("[data-feat=swing]")),n(this,Y,this.root.querySelector(".hrv-climate-dropdown")),t(this,dt)&&(t(this,dt).addEventListener("pointerdown",h(this,w,Ln).bind(this)),t(this,dt).addEventListener("pointermove",h(this,w,kn).bind(this)),t(this,dt).addEventListener("pointerup",h(this,w,Nr).bind(this)),t(this,dt).addEventListener("pointercancel",h(this,w,Nr).bind(this))),t(this,nt)&&(t(this,nt).addEventListener("click",()=>h(this,w,Wr).call(this,-1)),t(this,nt).addEventListener("pointerdown",()=>t(this,nt).setAttribute("data-pressing","true")),t(this,nt).addEventListener("pointerup",()=>t(this,nt).removeAttribute("data-pressing")),t(this,nt).addEventListener("pointerleave",()=>t(this,nt).removeAttribute("data-pressing")),t(this,nt).addEventListener("pointercancel",()=>t(this,nt).removeAttribute("data-pressing"))),t(this,st)&&(t(this,st).addEventListener("click",()=>h(this,w,Wr).call(this,1)),t(this,st).addEventListener("pointerdown",()=>t(this,st).setAttribute("data-pressing","true")),t(this,st).addEventListener("pointerup",()=>t(this,st).removeAttribute("data-pressing")),t(this,st).addEventListener("pointerleave",()=>t(this,st).removeAttribute("data-pressing")),t(this,st).addEventListener("pointercancel",()=>t(this,st).removeAttribute("data-pressing"))),e&&[t(this,ci),t(this,pi),t(this,ui),t(this,vi)].forEach(_=>{if(!_)return;const _e=_.getAttribute("data-feat");_.addEventListener("click",()=>h(this,w,Sn).call(this,_e)),_.addEventListener("pointerdown",()=>_.setAttribute("data-pressing","true")),_.addEventListener("pointerup",()=>_.removeAttribute("data-pressing")),_.addEventListener("pointerleave",()=>_.removeAttribute("data-pressing")),_.addEventListener("pointercancel",()=>_.removeAttribute("data-pressing"))}),this.renderCompanions(),B(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}applyState(e,i){n(this,Qi,{...i}),n(this,qt,e),n(this,fi,i.fan_mode??null),n(this,mi,i.preset_mode??null),n(this,gi,i.swing_mode??null),!t(this,ae)&&i.temperature!==void 0&&(n(this,at,i.temperature),h(this,w,_r).call(this)),t(this,hi)&&(t(this,hi).textContent=Ke(i.hvac_action??e));const r=this.root.querySelector(".hrv-climate-ro-temp-int"),o=this.root.querySelector(".hrv-climate-ro-temp-frac");if(r&&i.temperature!==void 0){n(this,at,i.temperature);const[l,u]=t(this,at).toFixed(1).split(".");r.textContent=l,o.textContent=`.${u}`}h(this,w,En).call(this);const a=i.hvac_action??e,d=Ke(a);this.announceState(`${this.def.friendly_name}, ${d}`)}predictState(e,i){const r={...t(this,Qi)};return e==="set_hvac_mode"&&i.hvac_mode?{state:i.hvac_mode,attributes:r}:e==="set_temperature"&&i.temperature!==void 0?{state:t(this,qt),attributes:{...r,temperature:i.temperature}}:e==="set_fan_mode"&&i.fan_mode?{state:t(this,qt),attributes:{...r,fan_mode:i.fan_mode}}:e==="set_preset_mode"&&i.preset_mode?{state:t(this,qt),attributes:{...r,preset_mode:i.preset_mode}}:e==="set_swing_mode"&&i.swing_mode?{state:t(this,qt),attributes:{...r,swing_mode:i.swing_mode}}:null}destroy(){t(this,It)&&(document.removeEventListener("pointerdown",t(this,It),!0),n(this,It,null)),t(this,ot)&&(window.removeEventListener("scroll",t(this,ot),!0),window.removeEventListener("resize",t(this,ot)),n(this,ot,null));try{t(this,Y)?.hidePopover?.()}catch{}}}dt=new WeakMap,Yt=new WeakMap,Tt=new WeakMap,ai=new WeakMap,ae=new WeakMap,hi=new WeakMap,di=new WeakMap,li=new WeakMap,nt=new WeakMap,st=new WeakMap,ci=new WeakMap,pi=new WeakMap,ui=new WeakMap,vi=new WeakMap,Y=new WeakMap,Le=new WeakMap,It=new WeakMap,ot=new WeakMap,at=new WeakMap,qt=new WeakMap,fi=new WeakMap,mi=new WeakMap,gi=new WeakMap,Dt=new WeakMap,he=new WeakMap,ke=new WeakMap,bi=new WeakMap,yi=new WeakMap,xi=new WeakMap,wi=new WeakMap,_i=new WeakMap,Qi=new WeakMap,Ci=new WeakMap,w=new WeakSet,Vr=function(e){return Math.max(0,Math.min(100,(e-t(this,Dt))/(t(this,he)-t(this,Dt))*100))},$n=function(e){const i=t(this,Dt)+e/100*(t(this,he)-t(this,Dt)),r=Math.round(i/t(this,ke))*t(this,ke);return Math.max(t(this,Dt),Math.min(t(this,he),+r.toFixed(10)))},Sn=function(e){if(t(this,Le)===e){h(this,w,ar).call(this);return}t(this,Le)&&h(this,w,ar).call(this),n(this,Le,e);let i=[],r=null,o="",a="";switch(e){case"mode":i=t(this,yi),r=t(this,qt),o="set_hvac_mode",a="hvac_mode";break;case"fan":i=t(this,xi),r=t(this,fi),o="set_fan_mode",a="fan_mode";break;case"preset":i=t(this,wi),r=t(this,mi),o="set_preset_mode",a="preset_mode";break;case"swing":i=t(this,_i),r=t(this,gi),o="set_swing_mode",a="swing_mode";break}if(!i.length||!t(this,Y))return;t(this,Y).innerHTML=i.map(u=>`
        <button class="hrv-cf-option" data-active="${u===r}" role="option"
          aria-selected="${u===r}" type="button">
          ${p(Ke(u))}
        </button>
      `).join(""),t(this,Y).querySelectorAll(".hrv-cf-option").forEach((u,f)=>{u.addEventListener("click",()=>{this.config.card?.sendCommand(o,{[a]:i[f]}),h(this,w,ar).call(this)})});const d=this.root.querySelector(`[data-feat="${e}"]`);try{t(this,Y).showPopover?.()}catch{}h(this,w,Fr).call(this,d),n(this,ot,()=>h(this,w,Fr).call(this,d)),window.addEventListener("scroll",t(this,ot),!0),window.addEventListener("resize",t(this,ot));const l=u=>{u.composedPath().some(b=>b===this.root||b===this.root.host)||h(this,w,ar).call(this)};n(this,It,l),document.addEventListener("pointerdown",l,!0)},Fr=function(e){if(!t(this,Y)||!e)return;const i=e.getBoundingClientRect(),r=window.innerHeight-i.bottom,o=i.top,a=Math.min(t(this,Y).scrollHeight||280,280),d=Math.max(140,Math.round(i.width));t(this,Y).style.left=`${Math.round(i.left)}px`,t(this,Y).style.minWidth=`${d}px`,o>=a+8||o>r?t(this,Y).style.top=`${Math.max(8,Math.round(i.top-a-6))}px`:t(this,Y).style.top=`${Math.round(i.bottom+6)}px`},ar=function(){n(this,Le,null);try{t(this,Y)?.hidePopover?.()}catch{}t(this,It)&&(document.removeEventListener("pointerdown",t(this,It),!0),n(this,It,null)),t(this,ot)&&(window.removeEventListener("scroll",t(this,ot),!0),window.removeEventListener("resize",t(this,ot)),n(this,ot,null))},Wr=function(e){const i=Math.round((t(this,at)+e*t(this,ke))*100)/100;n(this,at,Math.max(t(this,Dt),Math.min(t(this,he),i))),h(this,w,_r).call(this),t(this,Ci).call(this)},_r=function(){const e=h(this,w,Vr).call(this,t(this,at)),i=$t*(1-e/100),r=bt(it-e/100*H);t(this,Yt)?.setAttribute("stroke-dashoffset",String(i)),t(this,Tt)?.setAttribute("cx",String(r.x)),t(this,Tt)?.setAttribute("cy",String(r.y)),t(this,ai)?.setAttribute("cx",String(r.x)),t(this,ai)?.setAttribute("cy",String(r.y));const[o,a]=t(this,at).toFixed(1).split(".");t(this,di)&&(t(this,di).textContent=o),t(this,li)&&(t(this,li).textContent=`.${a}`)},Ln=function(e){n(this,ae,!0),t(this,dt)?.setPointerCapture(e.pointerId),h(this,w,Zr).call(this,e)},kn=function(e){t(this,ae)&&h(this,w,Zr).call(this,e)},Nr=function(e){if(t(this,ae)){n(this,ae,!1);try{t(this,dt)?.releasePointerCapture(e.pointerId)}catch{}t(this,Yt)&&(t(this,Yt).style.transition=""),t(this,Tt)&&(t(this,Tt).style.transition="")}},Zr=function(e){if(!t(this,dt))return;const i=t(this,dt).getBoundingClientRect(),r=i.left+i.width/2,o=i.top+i.height/2,a=e.clientX-r,d=-(e.clientY-o);let l=Math.atan2(d,a)*180/Math.PI;l<0&&(l+=360);let u=it-l;u<0&&(u+=360),u>H&&(u=u>H+(360-H)/2?0:H),n(this,at,h(this,w,$n).call(this,u/H*100)),t(this,Yt)&&(t(this,Yt).style.transition="none"),t(this,Tt)&&(t(this,Tt).style.transition="none"),h(this,w,_r).call(this),t(this,Ci).call(this)},Mn=function(){this.config.card?.sendCommand("set_temperature",{temperature:t(this,at)})},En=function(){const e=(i,r)=>{if(!i)return;const o=i.querySelector(".hrv-cf-value");o&&(o.textContent=Ke(r??"None"))};e(t(this,ci),t(this,qt)),e(t(this,pi),t(this,fi)),e(t(this,ui),t(this,mi)),e(t(this,vi),t(this,gi))};const rs=`
    [part=card-body] {
      display: flex;
      flex-direction: column;
      align-items: center;
  ...
  `;class ns extends y{constructor(){super(...arguments);s(this,Me,null)}render(){this.root.innerHTML=`
        <style>${rs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
      ...
      `,n(this,Me,this.root.querySelector(".hrv-bs-circle")),this.renderIcon(this.resolveIcon(this.def.icon_state_map?.off??this.def.icon,"mdi:radiobox-blank"),"state-icon"),this.renderCompanions(),B(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}applyState(e,i){const r=e==="on",o=this.formatStateLabel(e);t(this,Me)&&(t(this,Me).setAttribute("data-on",String(r)),t(this,Me).setAttribute("aria-label",`${this.def.friendly_name}: ${o}`));const a=r?"mdi:radiobox-marked":"mdi:radiobox-blank",d=this.def.icon_state_map?.[e]??this.def.icon??a;this.renderIcon(this.resolveIcon(d,a),"state-icon"),this.announceState(`${this.def.friendly_name}, ${o}`)}}Me=new WeakMap;const Qr='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 4h18v2H3V4zm0 14h18v2H3v-2zm0-4h18v2H3v-2zm0-4h18v2H3V10z" opacity="0.3"/><path d="M3 4h18v2H3V4zm0 16h18v2H3v-2z"/></svg>',tn='<svg viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg>',kr='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 4h18v2H3V4zm0 4h18v2H3V8zm0 4h18v2H3v-2zm0 4h18v2H3v-2zm0 4h18v2H3v-2z"/></svg>',ss=`
    [part=card] {
      padding-bottom: 0 !important;
    }
  ...
  `;class ls extends y{constructor(e,i,r,o){super(e,i,r,o);s(this,me);s(this,te,null);s(this,ki,null);s(this,Mi,null);s(this,ze,null);s(this,Be,null);s(this,Rt,null);s(this,z,null);s(this,Re,null);s(this,je,null);s(this,Oe,!1);s(this,jt,0);s(this,ee,!1);s(this,Ve,"idle");s(this,Fe,{});s(this,ir);n(this,ir,this.debounce(h(this,me,Bn).bind(this),200))}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],r=this.config.displayHints??{},o=r.show_transport!==!1,a=i.includes("play_pause"),d=i.includes("previous_track"),l=i.includes("next_track"),u=r.show_volume!==!1&&i.includes("volume_set"),f=r.show_volume!==!1&&i.includes("volume_mute"),b=u||f;if(this.root.innerHTML=`
        <style>${ds}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class ps extends y{constructor(){super(...arguments);s(this,Ei,null);s(this,rr,!1)}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${cs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class lr extends y{constructor(){super(...arguments);s(this,Hi,null);s(this,Ti,null)}render(){const e=this.def.unit_of_measurement??"";this.root.innerHTML=`
        <style>${us}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class nn extends y{constructor(){super(...arguments);s(this,Ot,null);s(this,Ii,null);s(this,We,!1)}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${vs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class on extends y{constructor(){super(...arguments);s(this,zi,null);s(this,Vt,null);s(this,Ze,!1);s(this,Ye,!1)}render(){const e=this.def.capabilities==="read-write";n(this,Ye,!1),this.root.innerHTML=`
        <style>${gs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class As extends y{constructor(){super(...arguments);s(this,L);s(this,Bi,null);s(this,Ge,null);s(this,Ri,null);s(this,ji,null);s(this,Oi,null);s(this,Vi,null);s(this,pt,null);s(this,Ft,null);s(this,gt,null);s(this,Fi,null);s(this,Wi,null);s(this,Ue,null);s(this,Xe,null)}render(){this.root.innerHTML=`
        <style>${Cs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
      ...
      `,n(this,Bi,this.root.querySelector(".hrv-weather-icon")),n(this,Ge,this.root.querySelector(".hrv-weather-temp")),n(this,Ri,this.root.querySelector(".hrv-weather-cond")),n(this,ji,this.root.querySelector("[data-stat=humidity] [data-value]")),n(this,Oi,this.root.querySelector("[data-stat=wind] [data-value]")),n(this,Vi,this.root.querySelector("[data-stat=pressure] [data-value]")),n(this,pt,this.root.querySelector(".hrv-forecast-strip")),n(this,Ft,this.root.querySelector(".hrv-forecast-toggle")),n(this,gt,this.root.querySelector(".hrv-forecast-scroll-track")),n(this,Fi,this.root.querySelector(".hrv-forecast-scroll-thumb")),t(this,pt)&&(t(this,pt).addEventListener("scroll",()=>h(this,L,Kr).call(this),{passive:!0}),n(this,Wi,Fn(t(this,pt)))),t(this,gt)&&t(this,gt).addEventListener("pointerdown",e=>h(this,L,Vn).call(this,e)),this.renderCompanions(),B(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}destroy(){var e;(e=t(this,Wi))==null||e.call(this),n(this,Wi,null)}applyState(e,i){const r=e||"cloudy";t(this,Bi)&&(t(this,Bi).innerHTML=Mr(r,44));const o=this.i18n.t(`weather.${r}`)!==`weather.${r}`?this.i18n.t(`weather.${r}`):r.replace(/-/g," ");t(this,Ri)&&(t(this,Ri).textContent=o);const a=i.temperature??i.native_temperature;let d=String(i.temperature_unit||i.native_temperature_unit||this.def.unit_of_measurement||"°C").trim();if(d&&!/^°/.test(d)&&d.length<=2&&(d=`°${d}`),t(this,Ge)){const u=t(this,Ge).querySelector(".hrv-weather-unit");t(this,Ge).firstChild.textContent=a!=null?Math.round(Number(a)):"--",u&&(u.textContent=d)}if(t(this,ji)){const u=i.humidity;t(this,ji).textContent=u!=null?`${u}%`:"--"}if(t(this,Oi)){const u=i.wind_speed,f=i.wind_speed_unit??"";t(this,Oi).textContent=u!=null?`${u} ${f}`.trim():"--"}if(t(this,Vi)){const u=i.pressure,f=i.pressure_unit??"";t(this,Vi).textContent=u!=null?`${u} ${f}`.trim():"--"}const l=(this.config.displayHints??this.def.display_hints??{}).show_forecast===!0;n(this,Ue,l?i.forecast_daily??i.forecast??null:null),n(this,Xe,l?i.forecast_hourly??null:null),h(this,L,Ur).call(this),h(this,L,Xr).call(this),this.announceState(`${this.def.friendly_name}, ${o}, ${a??"--"} ${d}`)}}Bi=new WeakMap,Ge=new WeakMap,Ri=new WeakMap,ji=new WeakMap,Oi=new WeakMap,Vi=new WeakMap,pt=new WeakMap,Ft=new WeakMap,gt=new WeakMap,Fi=new WeakMap,Wi=new WeakMap,L=new WeakSet,Ce=function(){return this.config._forecastMode??"daily"},Sr=function(e){this.config._forecastMode=e},Ue=new WeakMap,Xe=new WeakMap,Ur=function(){if(!t(this,Ft))return;const e=Array.isArray(t(this,Ue))&&t(this,Ue).length>0,i=Array.isArray(t(this,Xe))&&t(this,Xe).length>0;if(!e&&!i){t(this,Ft).textContent="";return}e&&!i&&n(this,L,"daily",Sr),!e&&i&&n(this,L,"hourly",Sr),e&&i?(t(this,Ft).textContent=t(this,L,Ce)==="daily"?"Hourly":"5-Day",t(this,Ft).onclick=()=>{n(this,L,t(this,L,Ce)==="daily"?"hourly":"daily",Sr),h(this,L,Ur).call(this),h(this,L,Xr).call(this)}):(t(this,Ft).textContent="",t(this,Ft).onclick=null)},Xr=function(){if(!t(this,pt))return;const e=t(this,L,Ce)==="hourly"?t(this,Xe):t(this,Ue);if(t(this,pt).setAttribute("data-mode",t(this,L,Ce)),!Array.isArray(e)||e.length===0){t(this,pt).innerHTML="",t(this,gt)&&(t(this,gt).hidden=!0);return}const i=t(this,L,Ce)==="daily"?e.slice(0,5):e;t(this,pt).innerHTML=i.map(r=>{const o=new Date(r.datetime);let a;t(this,L,Ce)==="hourly"?a=o.toLocaleTimeString([],{hour:"numeric"}):a=_s[o.getDay()]??"";const d=(r.temperature??r.native_temperature)!=null?Math.round(r.temperature??r.native_temperature):"--",l=(r.templow??r.native_templow)!=null?Math.round(r.templow??r.native_templow):null;return`
          ...
          </div>`}).join(""),t(this,L,Ce)==="hourly"?requestAnimationFrame(()=>h(this,L,Kr).call(this)):t(this,gt)&&(t(this,gt).hidden=!0)},Kr=function(){const e=t(this,pt),i=t(this,gt),r=t(this,Fi);if(!e||!i||!r)return;const o=e.scrollWidth>e.clientWidth?e.clientWidth/e.scrollWidth:1;if(o>=1){i.hidden=!0;return}i.hidden=!1;const a=i.clientWidth,d=Math.max(20,o*a),l=a-d,u=e.scrollLeft/(e.scrollWidth-e.clientWidth);r.style.width=`${d}px`,r.style.left=`${u*l}px`},Vn=function(e){const i=t(this,pt),r=t(this,gt),o=t(this,Fi);if(!i||!r||!o)return;e.preventDefault();const a=r.getBoundingClientRect(),d=parseFloat(o.style.width)||20,l=b=>{const g=b-a.left-d/2,M=a.width-d,_=Math.max(0,Math.min(1,g/M));i.scrollLeft=_*(i.scrollWidth-i.clientWidth)};l(e.clientX);const u=b=>l(b.clientX),f=()=>{window.removeEventListener("pointermove",u),window.removeEventListener("pointerup",f)};window.addEventListener("pointermove",u),window.addEventListener("pointerup",f)};const $s=`
    [part=card-body] {
      display: flex;
      flex-direction: column;
      align-items: center;
  ...
  `;class Ss extends y{constructor(){super(...arguments);s(this,re,null);s(this,Ni,null);s(this,ye,!1);s(this,vr,"unknown")}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${$s}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class hn extends y{constructor(){super(...arguments);s(this,ne,null);s(this,fr,"unknown")}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${Hr}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
      ...
      `,n(this,ne,this.root.querySelector(".hrv-action-icon-btn")),this.renderIcon(this.resolveIcon(this.def.icon,"mdi:script-text-play"),"card-icon"),e&&t(this,ne)&&this._attachGestureHandlers(t(this,ne),{onTap:()=>{const i=this.config.gestureConfig?.tap;if(i){this._runAction(i);return}this.config.card?.sendCommand("turn_on",this.def.service_data??{})}}),this.renderCompanions(),B(this.root)}applyState(e,i){n(this,fr,e);const r=this.def.capabilities==="read-write",o=e==="on",a=!r||o||e==="unavailable"||e==="unknown";t(this,ne)&&(t(this,ne).disabled=a,t(this,ne).dataset.running=String(o));const d=o?"mdi:script-text":"mdi:script-text-play",l=this.def.icon_state_map?.[e]??this.def.icon??d;this.renderIcon(this.resolveIcon(l,d),"card-icon"),this.announceState(`${this.def.friendly_name}, ${e}`)}predictState(e,i){return e==="turn_on"?{state:"on",attributes:{}}:null}}ne=new WeakMap,fr=new WeakMap,sr(hn,"staleOnMount",!1);class dn extends y{constructor(){super(...arguments);s(this,xe,null);s(this,At,null);s(this,mr,"unknown")}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${Hr}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class Ir extends y{constructor(){super(...arguments);s(this,Zi,null)}render(){this.root.innerHTML=`
        <style>${Ls}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
