(()=>{var Hs=Object.defineProperty;var dn=S=>{throw TypeError(S)};var Es=(S,x,p)=>x in S?Hs(S,x,{enumerable:!0,configurable:!0,writable:!0,value:p}):S[x]=p;var sr=(S,x,p)=>Es(S,typeof x!="symbol"?x+"":x,p),Ir=(S,x,p)=>x.has(S)||dn("Cannot "+p);var t=(S,x,p)=>(Ir(S,x,"read from private field"),p?p.call(S):x.get(S)),o=(S,x,p)=>x.has(S)?dn("Cannot add the same private member more than once"):x instanceof WeakSet?x.add(S):x.set(S,p),n=(S,x,p,Zt)=>(Ir(S,x,"write to private field"),Zt?Zt.call(S,p):x.set(S,p),p),h=(S,x,p)=>(Ir(S,x,"access private method"),p);(function(){"use strict";var ae,R,Qi,K,Lt,$,j,ti,ei,ut,wt,vt,ft,ke,ii,N,J,Mt,ri,ni,w,Ts,T,cn,pn,un,vn,gr,br,fn,Yi,mn,gn,Dr,bn,Pr,yn,_t,nt,pr,Q,si,Z,Ht,Et,Tt,G,H,he,Gt,tt,I,Le,oi,ai,g,yr,or,Br,xr,zr,Rr,Ui,xn,wn,jr,_n,Or,Cn,wr,An,lt,Yt,qt,hi,le,li,di,ci,st,ot,pi,ui,vi,fi,Y,Me,It,at,mt,Dt,mi,gi,bi,Pt,de,He,yi,xi,wi,_i,Ci,tr,Ai,_,Vr,Sn,$n,Fr,ar,Wr,_r,kn,Ln,Nr,Zr,Mn,Hn,Ee,Te,Bt,D,qe,Ie,De,gt,ce,Ut,zt,Si,er,ir,$i,Rt,Cr,En,Tn,Pe,Xt,O,U,ki,pe,ue,Kt,V,dt,Ct,Jt,ve,L,qn,In,Xi,Ar,Dn,Ki,et,F,Be,ur,fe,Li,Qt,ze,te,me,ge,ht,P,Pn,Bn,Gr,Yr,Ji,ee,Mi,Hi,Re,je,jt,B,Oe,Ve,Fe,Ot,ie,We,Ne,rr,be,Sr,zn,Ei,nr,Ti,qi,Vt,Ii,ye,bt,re,xe,we,Ze,Di,Pi,At,Bi,ct,Rn,jn,On,hr,zi,Ft,Ge,Ye,Ri,Ue,ji,Oi,Vi,Fi,pt,Wt,yt,Wi,Ni,k,Se,$r,Xe,Ke,Ur,Xr,Kr,Vn,ne,Zi,se,vr,oe,fr,_e,St,mr,Ce,Gi;const S=window.HArvest;if(!S||!S.renderers||!S.renderers.BaseCard){console.warn("[HArvest minimus] HArvest not found - pack not loaded.");return}const x=S.renderers.BaseCard,p=window.HArvest.esc;function Zt(c,v){let e=null;return function(...i){e&&clearTimeout(e),e=setTimeout(()=>{e=null,c.apply(this,i)},v)}}function it(c){return c?c.charAt(0).toUpperCase()+c.slice(1).replace(/_/g," "):""}const W=`
    [part=companion-zone] {
      display: flex;
      flex-wrap: wrap;
  ...
  `;function Fn(c){if(!c)return()=>{};const v=80,e=1.6,i=.96,r=.04;let s=null,a=0,d=0,l=0,u=!1,f=0;const y=[],C=()=>{f&&(cancelAnimationFrame(f),f=0)},q=m=>{for(;y.length&&y[0].t<m-v;)y.shift();if(y.length<2)return 0;const A=y[0],E=y[y.length-1],Je=E.t-A.t;return Je<=0?0:(E.x-A.x)/Je},b=()=>{if(Math.abs(l)<r)return;let m=performance.now();const A=E=>{const Je=E-m;if(m=E,c.scrollLeft-=l*Je,l*=Math.pow(i,Je/16),Math.abs(l)<r){f=0,l=0;return}const Ms=c.scrollWidth-c.clientWidth;if(c.scrollLeft<=0||c.scrollLeft>=Ms){f=0,l=0;return}f=requestAnimationFrame(A)};f=requestAnimationFrame(A)},X=m=>{if(c.scrollWidth<=c.clientWidth||m.pointerType==="touch")return;const A=m.target;if(!(A&&A!==c&&A.closest?.("button, a"))){C(),s=m.pointerId,a=m.clientX,d=c.scrollLeft,l=0,u=!1,y.length=0,y.push({x:m.clientX,t:m.timeStamp});try{c.setPointerCapture(s)}catch{}}},Nt=m=>{if(m.pointerId!==s)return;const A=m.clientX-a;Math.abs(A)>4&&(u=!0,c.dataset.dragging="true"),c.scrollLeft=d-A,y.push({x:m.clientX,t:m.timeStamp});const E=m.timeStamp-v;for(;y.length>2&&y[0].t<E;)y.shift()},Ae=m=>{if(m.pointerId===s){try{c.releasePointerCapture(s)}catch{}if(s=null,u){const A=E=>{E.stopPropagation(),E.preventDefault()};window.addEventListener("click",A,{capture:!0,once:!0}),requestAnimationFrame(()=>c.removeAttribute("data-dragging")),l=q(m.timeStamp)*e,b()}y.length=0}};return c.addEventListener("pointerdown",X),c.addEventListener("pointermove",Nt),c.addEventListener("pointerup",Ae),c.addEventListener("pointercancel",Ae),c.addEventListener("wheel",C,{passive:!0}),c.addEventListener("touchstart",C,{passive:!0}),()=>{C(),c.removeEventListener("pointerdown",X),c.removeEventListener("pointermove",Nt),c.removeEventListener("pointerup",Ae),c.removeEventListener("pointercancel",Ae),c.removeEventListener("wheel",C),c.removeEventListener("touchstart",C)}}function z(c){c.querySelectorAll("[part=companion]").forEach(v=>{v.title=v.getAttribute("aria-label")??""})}const Wn=60,Nn=60,$e=48,rt=225,M=270,$t=2*Math.PI*$e*(M/360);function Zn(c){return c*Math.PI/180}function xt(c){const v=Zn(c);return{x:Wn+$e*Math.cos(v),y:Nn-$e*Math.sin(v)}}function Gn(){const c=xt(rt),v=xt(rt-M);return`M ${c.x} ${c.y} A ${$e} ${$e} 0 1 1 ${v.x} ${v.y}`}const Qe=Gn(),kt=["brightness","temp","color"],lr=120;function Jr(c){const v=M/lr;let e="";for(let i=0;i<lr;i++){const r=rt-i*v,s=rt-(i+1)*v,a=xt(r),d=xt(s),l=`M ${a.x} ${a.y} A ${$e} ${$e} 0 0 1 ${d.x} ${d.y}`,u=i===0||i===lr-1?"round":"butt";e+=`<path d="${l}" stroke="${c(i/lr)}" fill="none" stroke-width="8" stroke-linecap="${u}" />`}return e}const Yn=Jr(c=>`hsl(${Math.round(c*360)},100%,50%)`),Un=Jr(c=>{const e=Math.round(143+112*c),i=Math.round(255*c);return`rgb(255,${e},${i})`}),kr=`
    [part=card] {
  ...
  `;class Kn extends x{constructor(e,i,r,s){super(e,i,r,s);o(this,w);o(this,ae,null);o(this,R,null);o(this,Qi,null);o(this,K,null);o(this,Lt,null);o(this,$,null);o(this,j,null);o(this,ti,null);o(this,ei,null);o(this,ut,0);o(this,wt,4e3);o(this,vt,0);o(this,ft,!1);o(this,ke,!1);o(this,ii,null);o(this,N,0);o(this,J,2e3);o(this,Mt,6500);o(this,ri);o(this,ni,new Map);o(this,T,[]);n(this,ri,Zt(h(this,w,yn).bind(this),300))}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],r=this.config.displayHints??{},s=r.show_brightness!==!1&&i.includes("brightness"),a=r.show_color_temp!==!1&&i.includes("color_temp"),d=r.show_rgb!==!1&&i.includes("rgb_color"),l=e&&(s||a||d),u=[s,a,d].filter(Boolean).length,f=e&&u>1;n(this,J,this.def.feature_config?.min_color_temp_kelvin??2e3),n(this,Mt,this.def.feature_config?.max_color_temp_kelvin??6500);const y=xt(rt);this.root.innerHTML=`
        <style>${kr}${Xn}</style>
        <div part="card">
      ...
      `,n(this,ae,this.root.querySelector("[part=toggle-button]")),n(this,R,this.root.querySelector(".hrv-dial-fill")),n(this,Qi,this.root.querySelector(".hrv-dial-track")),n(this,K,this.root.querySelector(".hrv-dial-thumb")),n(this,Lt,this.root.querySelector(".hrv-dial-pct")),n(this,$,this.root.querySelector(".hrv-dial-wrap")),n(this,ii,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,ti,this.root.querySelector(".hrv-dial-segs-color")),n(this,ei,this.root.querySelector(".hrv-dial-segs-temp")),n(this,j,this.root.querySelector(".hrv-mode-switch"));const C=()=>{const b=this.config.gestureConfig?.tap;if(b){this._runAction(b);return}this.config.card?.sendCommand("toggle",{})};t(this,ae)&&(l||this.renderIcon(this.resolveIcon(this.def.icon,"mdi:lightbulb"),"card-icon"),this._attachGestureHandlers(t(this,ae),{onTap:C}));const q=this.root.querySelector("[part=row-toggle]");q&&this._attachGestureHandlers(q,{onTap:C}),t(this,$)&&(t(this,$).addEventListener("pointerdown",h(this,w,mn).bind(this)),t(this,$).addEventListener("pointermove",h(this,w,gn).bind(this)),t(this,$).addEventListener("pointerup",h(this,w,Dr).bind(this)),t(this,$).addEventListener("pointercancel",h(this,w,Dr).bind(this)),t(this,$).addEventListener("keydown",h(this,w,bn).bind(this))),l&&h(this,w,cn).call(this),t(this,j)&&(t(this,j).addEventListener("click",h(this,w,pn).bind(this)),t(this,j).addEventListener("keydown",h(this,w,vn).bind(this)),t(this,j).addEventListener("mousemove",h(this,w,un).bind(this))),h(this,w,br).call(this),this.root.querySelector("[part=ro-state-icon]")&&this.renderIcon(this.resolveIcon(this.def.icon,"mdi:lightbulb"),"ro-state-icon"),this.renderCompanions(),this.root.querySelectorAll("[part=companion]").forEach(b=>{b.title=b.getAttribute("aria-label")??"Companion";const X=b.getAttribute("data-entity");if(X&&t(this,ni).has(X)){const Nt=t(this,ni).get(X);b.setAttribute("data-on",String(Nt==="on"))}})}applyState(e,i){if(n(this,ft,e==="on"),n(this,ut,i?.brightness??0),i?.color_temp_kelvin!==void 0?n(this,wt,i.color_temp_kelvin):i?.color_temp!==void 0&&i.color_temp>0&&n(this,wt,Math.round(1e6/i.color_temp)),i?.hs_color)n(this,vt,Math.round(i.hs_color[0]));else if(i?.rgb_color){const[d,l,u]=i.rgb_color;n(this,vt,ts(d,l,u))}if(t(this,ae)&&(t(this,ae).setAttribute("aria-pressed",String(t(this,ft))),this.root.querySelector("[part=card-icon]"))){const l=t(this,ft)?"mdi:lightbulb":"mdi:lightbulb-outline",u=this.def.icon_state_map?.[e]??this.def.icon??l;this.renderIcon(this.resolveIcon(u,l),"card-icon")}const r=this.root.querySelector(".hrv-light-ro-circle");if(r){r.setAttribute("data-on",String(t(this,ft)));const d=t(this,ft)?"mdi:lightbulb":"mdi:lightbulb-outline",l=this.def.icon_state_map?.[e]??this.def.icon_state_map?.["*"]??this.def.icon??d;this.renderIcon(this.resolveIcon(l,d),"ro-state-icon");const u=i?.color_mode,f=u==="color_temp",y=u&&u!=="color_temp",C=this.root.querySelector('[data-attr="brightness"]');if(C){const X=Math.round(t(this,ut)/255*100);C.title=t(this,ft)?`Brightness: ${X}%`:"Brightness: off"}const q=this.root.querySelector('[data-attr="temp"]');q&&(q.title=`Color temperature: ${t(this,wt)}K`,q.style.display=y?"none":"");const b=this.root.querySelector('[data-attr="color"]');if(b)if(b.style.display=f?"none":"",i?.rgb_color){const[X,Nt,Ae]=i.rgb_color;b.style.background=`rgb(${X},${Nt},${Ae})`,b.title=`Color: rgb(${X}, ${Nt}, ${Ae})`}else b.style.background=`hsl(${t(this,vt)}, 100%, 50%)`,b.title=`Color: hue ${t(this,vt)}°`}const s=this.root.querySelector("[part=row-toggle]");s&&(s.setAttribute("aria-pressed",String(t(this,ft))),s.disabled=e==="unavailable"||e==="unknown");const a=this.root.querySelector("[part=row-state]");a&&(a.textContent=it(e)),h(this,w,gr).call(this)}predictState(e,i){return e==="toggle"?{state:t(this,ft)?"off":"on",attributes:{brightness:t(this,ut)}}:e==="turn_on"&&i.brightness!==void 0?{state:"on",attributes:{brightness:i.brightness}}:null}updateCompanionState(e,i,r){t(this,ni).set(e,i),super.updateCompanionState(e,i,r)}}ae=new WeakMap,R=new WeakMap,Qi=new WeakMap,K=new WeakMap,Lt=new WeakMap,$=new WeakMap,j=new WeakMap,ti=new WeakMap,ei=new WeakMap,ut=new WeakMap,wt=new WeakMap,vt=new WeakMap,ft=new WeakMap,ke=new WeakMap,ii=new WeakMap,N=new WeakMap,J=new WeakMap,Mt=new WeakMap,ri=new WeakMap,ni=new WeakMap,w=new WeakSet,Ts=function(){const e=this.def.supported_features??[],i=[];return e.includes("brightness")&&i.push("brightness"),e.includes("color_temp")&&i.push("temp"),e.includes("rgb_color")&&i.push("color"),i.length>0?i:["brightness"]},T=new WeakMap,cn=function(){const e=this.def.supported_features??[],i=[e.includes("brightness"),e.includes("color_temp"),e.includes("rgb_color")];n(this,T,[]),i[0]&&t(this,T).push(0),i[1]&&t(this,T).push(1),i[2]&&t(this,T).push(2),t(this,T).length===0&&t(this,T).push(0),t(this,T).includes(t(this,N))||n(this,N,t(this,T)[0])},pn=function(e){const i=t(this,j).getBoundingClientRect(),r=e.clientY-i.top,s=i.height/3;let a;r<s?a=0:r<s*2?a=1:a=2,a=Math.min(a,t(this,T).length-1),n(this,N,t(this,T)[a]),t(this,j).setAttribute("data-pos",String(a)),t(this,j).setAttribute("aria-valuenow",String(a+1)),t(this,j).setAttribute("aria-valuetext",kt[t(this,N)]),h(this,w,br).call(this),h(this,w,gr).call(this)},un=function(e){const i={brightness:"Brightness",temp:"Color Temperature",color:"Color"},r=t(this,j).getBoundingClientRect(),s=Math.min(Math.floor((e.clientY-r.top)/(r.height/t(this,T).length)),t(this,T).length-1),a=kt[t(this,T)[Math.max(0,s)]];t(this,j).title=`Dial mode: ${i[a]??a}`},vn=function(e){const i=t(this,T).indexOf(t(this,N));let r=i;if(e.key==="ArrowUp"||e.key==="ArrowLeft")r=Math.max(0,i-1);else if(e.key==="ArrowDown"||e.key==="ArrowRight")r=Math.min(t(this,T).length-1,i+1);else return;e.preventDefault(),n(this,N,t(this,T)[r]),t(this,j).setAttribute("data-pos",String(r)),t(this,j).setAttribute("aria-valuenow",String(r+1)),t(this,j).setAttribute("aria-valuetext",kt[t(this,N)]),h(this,w,br).call(this),h(this,w,gr).call(this)},gr=function(){t(this,K)&&(t(this,K).style.transition="none"),t(this,R)&&(t(this,R).style.transition="none"),h(this,w,fn).call(this),t(this,K)?.getBoundingClientRect(),t(this,R)?.getBoundingClientRect(),t(this,K)&&(t(this,K).style.transition=""),t(this,R)&&(t(this,R).style.transition="")},br=function(){if(!t(this,R))return;const e=kt[t(this,N)],i=e==="color"||e==="temp";t(this,Qi).style.display=i?"none":"",t(this,R).style.display=i?"none":"",t(this,ti)&&t(this,ti).classList.toggle("hrv-dial-segs-visible",e==="color"),t(this,ei)&&t(this,ei).classList.toggle("hrv-dial-segs-visible",e==="temp"),e==="brightness"&&t(this,R).setAttribute("stroke-dasharray",String($t));const r={brightness:"brightness",temp:"color temperature",color:"color"},s={brightness:"Drag to adjust brightness",temp:"Drag to adjust color temperature",color:"Drag to adjust color"};t(this,$)?.setAttribute("aria-label",`${p(this.def.friendly_name)} ${r[e]}`),t(this,$)&&(t(this,$).title=s[e]),t(this,$)&&(t(this,$).setAttribute("aria-valuemin",e==="temp"?String(t(this,J)):"0"),t(this,$).setAttribute("aria-valuemax",e==="temp"?String(t(this,Mt)):e==="color"?"360":"100"))},fn=function(){const e=kt[t(this,N)];if(e==="brightness"){const i=t(this,ft)?t(this,ut):0;h(this,w,Yi).call(this,Math.round(i/255*100))}else if(e==="temp"){const i=Math.round((t(this,wt)-t(this,J))/(t(this,Mt)-t(this,J))*100);h(this,w,Yi).call(this,Math.max(0,Math.min(100,i)))}else{const i=Math.round(t(this,vt)/360*100);h(this,w,Yi).call(this,i)}},Yi=function(e){const i=kt[t(this,N)],r=e/100*M,s=xt(rt-r);if(t(this,K)?.setAttribute("cx",String(s.x)),t(this,K)?.setAttribute("cy",String(s.y)),t(this,ii)?.setAttribute("cx",String(s.x)),t(this,ii)?.setAttribute("cy",String(s.y)),i==="brightness"){const a=$t*(1-e/100);t(this,R)?.setAttribute("stroke-dashoffset",String(a)),t(this,Lt)&&(t(this,Lt).textContent=e+"%"),t(this,$)?.setAttribute("aria-valuenow",String(e)),t(this,$)?.setAttribute("aria-valuetext",`${e}%`)}else if(i==="temp"){const a=Math.round(t(this,J)+e/100*(t(this,Mt)-t(this,J)));t(this,Lt)&&(t(this,Lt).textContent=a+"K"),t(this,$)?.setAttribute("aria-valuenow",String(a)),t(this,$)?.setAttribute("aria-valuetext",`${a} kelvin`)}else{const a=Math.round(e/100*360);t(this,Lt)&&(t(this,Lt).textContent=a+"°"),t(this,$)?.setAttribute("aria-valuenow",String(a)),t(this,$)?.setAttribute("aria-valuetext",`${a} degrees`)}},mn=function(e){n(this,ke,!0),t(this,$)?.setPointerCapture(e.pointerId),h(this,w,Pr).call(this,e)},gn=function(e){t(this,ke)&&h(this,w,Pr).call(this,e)},Dr=function(e){if(t(this,ke)){n(this,ke,!1);try{t(this,$)?.releasePointerCapture(e.pointerId)}catch{}t(this,ri).call(this)}},bn=function(e){const i=kt[t(this,N)];let r=Math.round(i==="brightness"?t(this,ut)/255*100:i==="temp"?(t(this,wt)-t(this,J))/(t(this,Mt)-t(this,J))*100:t(this,vt)/360*100);if(e.key==="ArrowDown"||e.key==="ArrowLeft")r-=1;else if(e.key==="ArrowUp"||e.key==="ArrowRight")r+=1;else if(e.key==="PageDown")r-=10;else if(e.key==="PageUp")r+=10;else if(e.key==="Home")r=0;else if(e.key==="End")r=100;else return;e.preventDefault(),r=Math.max(0,Math.min(100,r)),i==="brightness"?n(this,ut,Math.round(r/100*255)):i==="temp"?n(this,wt,Math.round(t(this,J)+r/100*(t(this,Mt)-t(this,J)))):n(this,vt,Math.round(r/100*360)),h(this,w,Yi).call(this,r),t(this,ri).call(this)},Pr=function(e){if(!t(this,$))return;const i=t(this,$).getBoundingClientRect(),r=i.left+i.width/2,s=i.top+i.height/2,a=e.clientX-r,d=-(e.clientY-s);let l=Math.atan2(d,a)*180/Math.PI;l<0&&(l+=360);let u=rt-l;u<0&&(u+=360),u>M&&(u=u>M+(360-M)/2?0:M);const f=Math.round(u/M*100),y=kt[t(this,N)];y==="brightness"?n(this,ut,Math.round(f/100*255)):y==="temp"?n(this,wt,Math.round(t(this,J)+f/100*(t(this,Mt)-t(this,J)))):n(this,vt,Math.round(f/100*360)),t(this,R)&&(t(this,R).style.transition="none"),t(this,K)&&(t(this,K).style.transition="none"),h(this,w,Yi).call(this,f)},yn=function(){t(this,R)&&(t(this,R).style.transition=""),t(this,K)&&(t(this,K).style.transition="");const e=kt[t(this,N)];e==="brightness"?t(this,ut)===0?this.config.card?.sendCommand("turn_off",{}):this.config.card?.sendCommand("turn_on",{brightness:t(this,ut)}):e==="temp"?this.config.card?.sendCommand("turn_on",{color_temp_kelvin:t(this,wt)}):this.config.card?.sendCommand("turn_on",{hs_color:[t(this,vt),100]})};const Jn=kr+`
    .hrv-fan-feat-btn {
      width: 40px;
      height: 40px;
      border-radius: 50%;
  ...
  `;class Qn extends x{constructor(e,i,r,s){super(e,i,r,s);o(this,g);o(this,_t,null);o(this,nt,null);o(this,pr,null);o(this,Q,null);o(this,si,null);o(this,Z,null);o(this,Ht,null);o(this,Et,null);o(this,Tt,null);o(this,G,!1);o(this,H,0);o(this,he,!1);o(this,Gt,"forward");o(this,tt,null);o(this,I,[]);o(this,Le,!1);o(this,oi,null);o(this,ai);n(this,ai,Zt(h(this,g,Cn).bind(this),300)),n(this,I,e.feature_config?.preset_modes??[])}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],r=this.config.displayHints??this.def.display_hints??{},s=r.display_mode??null;let a=i.includes("set_speed");const d=r.show_oscillate!==!1&&i.includes("oscillate"),l=r.show_direction!==!1&&i.includes("direction"),u=r.show_presets!==!1&&i.includes("preset_mode");s==="on-off"&&(a=!1);let f=e&&a,y=f&&t(this,g,or),C=y&&!t(this,I).length,q=y&&!!t(this,I).length;s==="continuous"?(y=!1,C=!1,q=!1):s==="stepped"?(q=!1,C=y&&!t(this,I).length):s==="cycle"&&(y=!0,q=!0,C=!1);const b=xt(rt);this.root.innerHTML=`
        <style>${Jn}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
      ...
      `,n(this,_t,this.root.querySelector("[part=toggle-button]")),n(this,nt,this.root.querySelector(".hrv-dial-fill")),n(this,pr,this.root.querySelector(".hrv-dial-track")),n(this,Q,this.root.querySelector(".hrv-dial-thumb")),n(this,si,this.root.querySelector(".hrv-dial-pct")),n(this,Z,this.root.querySelector(".hrv-dial-wrap")),n(this,oi,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,Ht,this.root.querySelector('[data-feat="oscillate"]')),n(this,Et,this.root.querySelector('[data-feat="direction"]')),n(this,Tt,this.root.querySelector('[data-feat="preset"]')),t(this,_t)&&!f&&(this.renderIcon(this.resolveIcon(this.def.icon,"mdi:fan"),"fan-onoff-icon"),t(this,_t).setAttribute("data-animate",String(!!this.config.animate)));const X=()=>{const m=this.config.gestureConfig?.tap;if(m){this._runAction(m);return}this.config.card?.sendCommand("toggle",{})};this._attachGestureHandlers(t(this,_t),{onTap:X});const Nt=this.root.querySelector("[part=row-toggle]");Nt&&this._attachGestureHandlers(Nt,{onTap:X}),t(this,Z)&&(t(this,Z).addEventListener("pointerdown",h(this,g,xn).bind(this)),t(this,Z).addEventListener("pointermove",h(this,g,wn).bind(this)),t(this,Z).addEventListener("pointerup",h(this,g,jr).bind(this)),t(this,Z).addEventListener("pointercancel",h(this,g,jr).bind(this)),t(this,Z).addEventListener("keydown",h(this,g,_n).bind(this))),this.root.querySelector(".hrv-fan-speed-circle")?.addEventListener("click",()=>{const m=t(this,g,xr);if(!m.length)return;let A;if(!t(this,G)||t(this,H)===0)A=m[0],n(this,G,!0),t(this,_t)?.setAttribute("aria-pressed","true");else{const E=m.findIndex(Je=>Je>t(this,H));A=E===-1?m[0]:m[E]}n(this,H,A),h(this,g,zr).call(this),this.config.card?.sendCommand("set_percentage",{percentage:A})}),this.root.querySelectorAll(".hrv-fan-hspeed-dot").forEach(m=>{const A=()=>{const E=Number(m.getAttribute("data-pct"));t(this,G)||(n(this,G,!0),t(this,_t)?.setAttribute("aria-pressed","true")),n(this,H,E),h(this,g,Rr).call(this),this.config.card?.sendCommand("set_percentage",{percentage:E})};m.addEventListener("click",A),m.addEventListener("keydown",E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),A())})}),t(this,Ht)?.addEventListener("click",()=>{this.config.card?.sendCommand("oscillate",{oscillating:!t(this,he)})}),t(this,Et)?.addEventListener("click",()=>{const m=t(this,Gt)==="forward"?"reverse":"forward";n(this,Gt,m),h(this,g,Ui).call(this),this.config.card?.sendCommand("set_direction",{direction:m})}),t(this,Tt)?.addEventListener("click",()=>{if(t(this,I).length){if(t(this,g,Br)){const m=t(this,tt)??t(this,I)[0];this.config.card?.sendCommand("set_preset_mode",{preset_mode:m});return}if(t(this,tt)){const m=t(this,I).indexOf(t(this,tt));if(m===-1||m===t(this,I).length-1){n(this,tt,null),h(this,g,Ui).call(this);const A=t(this,g,yr),E=Math.floor(t(this,H)/A)*A||A;this.config.card?.sendCommand("set_percentage",{percentage:E})}else{const A=t(this,I)[m+1];n(this,tt,A),h(this,g,Ui).call(this),this.config.card?.sendCommand("set_preset_mode",{preset_mode:A})}}else{const m=t(this,I)[0];n(this,tt,m),h(this,g,Ui).call(this),this.config.card?.sendCommand("set_preset_mode",{preset_mode:m})}}}),this.root.querySelector(".hrv-fan-ro-circle")&&this.renderIcon(this.resolveIcon(this.def.icon,"mdi:fan"),"ro-state-icon"),this.renderCompanions(),this.root.querySelectorAll("[part=companion]").forEach(m=>{m.title=m.getAttribute("aria-label")??"Companion"})}applyState(e,i){n(this,G,e==="on"),n(this,H,i?.percentage??0),n(this,he,i?.oscillating??!1),n(this,Gt,i?.direction??"forward"),n(this,tt,i?.preset_mode??null),i?.preset_modes?.length&&n(this,I,i.preset_modes),t(this,_t)&&t(this,_t).setAttribute("aria-pressed",String(t(this,G)));const r=this.root.querySelector(".hrv-fan-ro-circle");r&&r.setAttribute("data-on",String(t(this,G)));const s=this.root.querySelector("[part=row-toggle]");s&&(s.setAttribute("aria-pressed",String(t(this,G))),s.disabled=e==="unavailable"||e==="unknown");const a=this.root.querySelector("[part=row-state]");a&&(a.textContent=it(e)),t(this,g,or)&&!t(this,I).length?h(this,g,Rr).call(this):t(this,g,or)?h(this,g,zr).call(this):h(this,g,An).call(this),h(this,g,Ui).call(this),this.announceState(`${this.def.friendly_name}, ${e}`+(t(this,H)>0?`, ${Math.round(t(this,H))}%`:""))}predictState(e,i){return e==="toggle"?{state:t(this,G)?"off":"on",attributes:{percentage:t(this,H)}}:e==="set_percentage"?{state:"on",attributes:{percentage:i.percentage,oscillating:t(this,he),direction:t(this,Gt),preset_mode:t(this,tt),preset_modes:t(this,I)}}:null}}_t=new WeakMap,nt=new WeakMap,pr=new WeakMap,Q=new WeakMap,si=new WeakMap,Z=new WeakMap,Ht=new WeakMap,Et=new WeakMap,Tt=new WeakMap,G=new WeakMap,H=new WeakMap,he=new WeakMap,Gt=new WeakMap,tt=new WeakMap,I=new WeakMap,Le=new WeakMap,oi=new WeakMap,ai=new WeakMap,g=new WeakSet,yr=function(){const e=this.def?.feature_config;return e?.percentage_step>1?e.percentage_step:e?.speed_count>1?100/e.speed_count:1},or=function(){return t(this,g,yr)>1},Br=function(){return t(this,g,or)&&t(this,I).length>0},xr=function(){const e=t(this,g,yr),i=[];for(let r=1;r*e<=100.001;r++)i.push(r*e);return i},zr=function(){const e=this.root.querySelector(".hrv-fan-speed-circle");if(!e)return;e.setAttribute("aria-pressed",String(t(this,G)));const i=t(this,G)?"Click to increase fan speed":"Fan off - click to turn on";e.setAttribute("aria-label",i),e.title=i},Rr=function(){const e=this.root.querySelector(".hrv-fan-hspeed-switch");if(!e)return;const i=e.querySelector(".hrv-fan-hspeed-thumb"),r=t(this,g,xr);let s=-1;if(t(this,G)&&t(this,H)>0){let a=1/0;r.forEach((d,l)=>{const u=Math.abs(d-t(this,H));u<a&&(a=u,s=l)})}e.setAttribute("data-on",String(s>=0)),i&&s>=0&&(i.style.left=`${2+s*32}px`),e.querySelectorAll(".hrv-fan-hspeed-dot").forEach((a,d)=>{a.setAttribute("data-active",String(d===s))})},Ui=function(){const e=t(this,g,Br);if(t(this,Ht)){const i=e||t(this,he),r=e?"Oscillate":`Oscillate: ${t(this,he)?"on":"off"}`;t(this,Ht).setAttribute("data-on",String(i)),t(this,Ht).setAttribute("aria-pressed",String(i)),t(this,Ht).setAttribute("aria-label",r),t(this,Ht).title=r}if(t(this,Et)){const i=t(this,Gt)!=="reverse",r=`Direction: ${t(this,Gt)}`;t(this,Et).setAttribute("data-on",String(i)),t(this,Et).setAttribute("aria-pressed",String(i)),t(this,Et).setAttribute("aria-label",r),t(this,Et).title=r}if(t(this,Tt)){const i=e||!!t(this,tt),r=e?t(this,tt)??t(this,I)[0]??"Preset":t(this,tt)?`Preset: ${t(this,tt)}`:"Preset: none";t(this,Tt).setAttribute("data-on",String(i)),t(this,Tt).setAttribute("aria-pressed",String(i)),t(this,Tt).setAttribute("aria-label",r),t(this,Tt).title=r}},xn=function(e){n(this,Le,!0),t(this,Z)?.setPointerCapture(e.pointerId),h(this,g,Or).call(this,e)},wn=function(e){t(this,Le)&&h(this,g,Or).call(this,e)},jr=function(e){if(t(this,Le)){n(this,Le,!1);try{t(this,Z)?.releasePointerCapture(e.pointerId)}catch{}t(this,ai).call(this)}},_n=function(e){let i=t(this,H);if(e.key==="ArrowDown"||e.key==="ArrowLeft")i-=1;else if(e.key==="ArrowUp"||e.key==="ArrowRight")i+=1;else if(e.key==="PageDown")i-=10;else if(e.key==="PageUp")i+=10;else if(e.key==="Home")i=0;else if(e.key==="End")i=100;else return;e.preventDefault(),n(this,H,Math.max(0,Math.min(100,i))),h(this,g,wr).call(this,t(this,H)),t(this,ai).call(this)},Or=function(e){if(!t(this,Z))return;const i=t(this,Z).getBoundingClientRect(),r=i.left+i.width/2,s=i.top+i.height/2,a=e.clientX-r,d=-(e.clientY-s);let l=Math.atan2(d,a)*180/Math.PI;l<0&&(l+=360);let u=rt-l;u<0&&(u+=360),u>M&&(u=u>M+(360-M)/2?0:M),n(this,H,Math.round(u/M*100)),t(this,nt)&&(t(this,nt).style.transition="none"),t(this,Q)&&(t(this,Q).style.transition="none"),h(this,g,wr).call(this,t(this,H))},Cn=function(){t(this,nt)&&(t(this,nt).style.transition=""),t(this,Q)&&(t(this,Q).style.transition=""),t(this,H)===0?this.config.card?.sendCommand("turn_off",{}):this.config.card?.sendCommand("set_percentage",{percentage:t(this,H)})},wr=function(e){const i=$t*(1-e/100),r=xt(rt-e/100*M);t(this,nt)?.setAttribute("stroke-dashoffset",String(i)),t(this,Q)?.setAttribute("cx",String(r.x)),t(this,Q)?.setAttribute("cy",String(r.y)),t(this,oi)?.setAttribute("cx",String(r.x)),t(this,oi)?.setAttribute("cy",String(r.y)),t(this,si)&&(t(this,si).textContent=`${e}%`),t(this,Z)?.setAttribute("aria-valuenow",String(e)),t(this,Z)?.setAttribute("aria-valuetext",`${e}%`)},An=function(){t(this,Q)&&(t(this,Q).style.transition="none"),t(this,nt)&&(t(this,nt).style.transition="none"),h(this,g,wr).call(this,t(this,G)?t(this,H):0),t(this,Q)?.getBoundingClientRect(),t(this,nt)?.getBoundingClientRect(),t(this,Q)&&(t(this,Q).style.transition=""),t(this,nt)&&(t(this,nt).style.transition="")};function ts(c,v,e){c/=255,v/=255,e/=255;const i=Math.max(c,v,e),r=Math.min(c,v,e),s=i-r;if(s===0)return 0;let a;return i===c?a=(v-e)/s%6:i===v?a=(e-c)/s+2:a=(c-v)/s+4,Math.round((a*60+360)%360)}const es=kr+`
    [part=card-body] {
      flex-direction: column;
      align-items: stretch;
      gap: 0;
  ...
  `;class is extends x{constructor(e,i,r,s){super(e,i,r,s);o(this,_);o(this,lt,null);o(this,Yt,null);o(this,qt,null);o(this,hi,null);o(this,le,!1);o(this,li,null);o(this,di,null);o(this,ci,null);o(this,st,null);o(this,ot,null);o(this,pi,null);o(this,ui,null);o(this,vi,null);o(this,fi,null);o(this,Y,null);o(this,Me,null);o(this,It,null);o(this,at,null);o(this,mt,20);o(this,Dt,"off");o(this,mi,null);o(this,gi,null);o(this,bi,null);o(this,Pt,16);o(this,de,32);o(this,He,.5);o(this,yi,"°C");o(this,xi,[]);o(this,wi,[]);o(this,_i,[]);o(this,Ci,[]);o(this,tr,{});o(this,Ai);n(this,Ai,Zt(h(this,_,Mn).bind(this),500))}render(){const e=this.def.capabilities==="read-write",i=this.config.displayHints??{},r=this.def.supported_features?.includes("target_temperature"),s=i.show_fan_mode!==!1&&(this.def.supported_features?.includes("fan_mode")||this.def.feature_config?.fan_modes?.length>0),a=i.show_presets!==!1&&(this.def.supported_features?.includes("preset_mode")||this.def.feature_config?.preset_modes?.length>0),d=i.show_swing_mode!==!1&&(this.def.supported_features?.includes("swing_mode")||this.def.feature_config?.swing_modes?.length>0);n(this,Pt,this.def.feature_config?.min_temp??16),n(this,de,this.def.feature_config?.max_temp??32),n(this,He,this.def.feature_config?.temp_step??.5),n(this,yi,this.def.unit_of_measurement??"°C"),n(this,xi,this.def.feature_config?.hvac_modes??["off","heat","cool","heat_cool","auto","dry","fan_only"]),n(this,wi,this.def.feature_config?.fan_modes??[]),n(this,_i,this.def.feature_config?.preset_modes??[]),n(this,Ci,this.def.feature_config?.swing_modes??[]);const l=h(this,_,Vr).call(this,t(this,mt)),u=xt(rt),f=xt(rt-l/100*M),y=$t*(1-l/100),[C,q]=t(this,mt).toFixed(1).split(".");this.root.innerHTML=`
        <style>${es}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
              ...
              <div class="hrv-dial-wrap">
                ...
                <div class="hrv-climate-center">
                  ...
                  <div class="hrv-climate-temp-row">
                    <span class="hrv-climate-temp-int">${p(C)}</span><span class="hrv-climate-temp-frac">.${p(q)}</span><span class="hrv-climate-temp-unit">${p(t(this,yi))}</span>
                  </div>
                </div>
              </div>
            ...
            `:e?"":`
              <div class="hrv-climate-ro-temp">
                <div class="hrv-climate-ro-temp-row">
                  <span class="hrv-climate-ro-temp-int">-</span><span class="hrv-climate-ro-temp-frac"></span><span class="hrv-climate-ro-temp-unit">${p(t(this,yi))}</span>
                </div>
      ...
      `,n(this,lt,this.root.querySelector(".hrv-dial-wrap")),n(this,Yt,this.root.querySelector(".hrv-dial-fill")),n(this,qt,this.root.querySelector(".hrv-dial-thumb")),n(this,hi,this.root.querySelector(".hrv-dial-thumb-hit")),n(this,li,this.root.querySelector(".hrv-climate-state-text")),n(this,di,this.root.querySelector(".hrv-climate-temp-int")),n(this,ci,this.root.querySelector(".hrv-climate-temp-frac")),n(this,st,this.root.querySelector("[data-dir='-']")),n(this,ot,this.root.querySelector("[data-dir='+']")),n(this,pi,this.root.querySelector("[data-feat=mode]")),n(this,ui,this.root.querySelector("[data-feat=fan]")),n(this,vi,this.root.querySelector("[data-feat=preset]")),n(this,fi,this.root.querySelector("[data-feat=swing]")),n(this,Y,this.root.querySelector(".hrv-climate-dropdown")),t(this,lt)&&(t(this,lt).addEventListener("pointerdown",h(this,_,kn).bind(this)),t(this,lt).addEventListener("pointermove",h(this,_,Ln).bind(this)),t(this,lt).addEventListener("pointerup",h(this,_,Nr).bind(this)),t(this,lt).addEventListener("pointercancel",h(this,_,Nr).bind(this))),t(this,st)&&(t(this,st).addEventListener("click",()=>h(this,_,Wr).call(this,-1)),t(this,st).addEventListener("pointerdown",()=>t(this,st).setAttribute("data-pressing","true")),t(this,st).addEventListener("pointerup",()=>t(this,st).removeAttribute("data-pressing")),t(this,st).addEventListener("pointerleave",()=>t(this,st).removeAttribute("data-pressing")),t(this,st).addEventListener("pointercancel",()=>t(this,st).removeAttribute("data-pressing"))),t(this,ot)&&(t(this,ot).addEventListener("click",()=>h(this,_,Wr).call(this,1)),t(this,ot).addEventListener("pointerdown",()=>t(this,ot).setAttribute("data-pressing","true")),t(this,ot).addEventListener("pointerup",()=>t(this,ot).removeAttribute("data-pressing")),t(this,ot).addEventListener("pointerleave",()=>t(this,ot).removeAttribute("data-pressing")),t(this,ot).addEventListener("pointercancel",()=>t(this,ot).removeAttribute("data-pressing"))),e&&[t(this,pi),t(this,ui),t(this,vi),t(this,fi)].forEach(b=>{if(!b)return;const X=b.getAttribute("data-feat");b.addEventListener("click",()=>h(this,_,$n).call(this,X)),b.addEventListener("pointerdown",()=>b.setAttribute("data-pressing","true")),b.addEventListener("pointerup",()=>b.removeAttribute("data-pressing")),b.addEventListener("pointerleave",()=>b.removeAttribute("data-pressing")),b.addEventListener("pointercancel",()=>b.removeAttribute("data-pressing"))}),this.renderCompanions(),z(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}applyState(e,i){n(this,tr,{...i}),n(this,Dt,e),n(this,mi,i.fan_mode??null),n(this,gi,i.preset_mode??null),n(this,bi,i.swing_mode??null),!t(this,le)&&i.temperature!==void 0&&(n(this,mt,i.temperature),h(this,_,_r).call(this)),t(this,li)&&(t(this,li).textContent=it(i.hvac_action??e));const r=this.root.querySelector(".hrv-climate-ro-temp-int"),s=this.root.querySelector(".hrv-climate-ro-temp-frac");if(r){const u=i.current_temperature??i.temperature;if(u!=null){const[f,y]=Number(u).toFixed(1).split(".");r.textContent=f,s&&(s.textContent=`.${y}`)}}const a=this.root.querySelector(".hrv-climate-ro-mode");a&&(a.textContent=it(i.hvac_action??e)),h(this,_,Hn).call(this);const d=i.hvac_action??e,l=it(d);this.announceState(`${this.def.friendly_name}, ${l}`)}predictState(e,i){const r={...t(this,tr)};return e==="set_hvac_mode"&&i.hvac_mode?{state:i.hvac_mode,attributes:r}:e==="set_temperature"&&i.temperature!==void 0?{state:t(this,Dt),attributes:{...r,temperature:i.temperature}}:e==="set_fan_mode"&&i.fan_mode?{state:t(this,Dt),attributes:{...r,fan_mode:i.fan_mode}}:e==="set_preset_mode"&&i.preset_mode?{state:t(this,Dt),attributes:{...r,preset_mode:i.preset_mode}}:e==="set_swing_mode"&&i.swing_mode?{state:t(this,Dt),attributes:{...r,swing_mode:i.swing_mode}}:null}destroy(){t(this,It)&&(document.removeEventListener("pointerdown",t(this,It),!0),n(this,It,null)),t(this,at)&&(window.removeEventListener("scroll",t(this,at),!0),window.removeEventListener("resize",t(this,at)),n(this,at,null));try{t(this,Y)?.hidePopover?.()}catch{}}}lt=new WeakMap,Yt=new WeakMap,qt=new WeakMap,hi=new WeakMap,le=new WeakMap,li=new WeakMap,di=new WeakMap,ci=new WeakMap,st=new WeakMap,ot=new WeakMap,pi=new WeakMap,ui=new WeakMap,vi=new WeakMap,fi=new WeakMap,Y=new WeakMap,Me=new WeakMap,It=new WeakMap,at=new WeakMap,mt=new WeakMap,Dt=new WeakMap,mi=new WeakMap,gi=new WeakMap,bi=new WeakMap,Pt=new WeakMap,de=new WeakMap,He=new WeakMap,yi=new WeakMap,xi=new WeakMap,wi=new WeakMap,_i=new WeakMap,Ci=new WeakMap,tr=new WeakMap,Ai=new WeakMap,_=new WeakSet,Vr=function(e){return Math.max(0,Math.min(100,(e-t(this,Pt))/(t(this,de)-t(this,Pt))*100))},Sn=function(e){const i=t(this,Pt)+e/100*(t(this,de)-t(this,Pt)),r=Math.round(i/t(this,He))*t(this,He);return Math.max(t(this,Pt),Math.min(t(this,de),+r.toFixed(10)))},$n=function(e){if(t(this,Me)===e){h(this,_,ar).call(this);return}t(this,Me)&&h(this,_,ar).call(this),n(this,Me,e);let i=[],r=null,s="",a="";switch(e){case"mode":i=t(this,xi),r=t(this,Dt),s="set_hvac_mode",a="hvac_mode";break;case"fan":i=t(this,wi),r=t(this,mi),s="set_fan_mode",a="fan_mode";break;case"preset":i=t(this,_i),r=t(this,gi),s="set_preset_mode",a="preset_mode";break;case"swing":i=t(this,Ci),r=t(this,bi),s="set_swing_mode",a="swing_mode";break}if(!i.length||!t(this,Y))return;t(this,Y).innerHTML=i.map(u=>`
        <button class="hrv-cf-option" data-active="${u===r}" role="option"
          aria-selected="${u===r}" type="button">
          ${p(it(u))}
        </button>
      `).join(""),t(this,Y).querySelectorAll(".hrv-cf-option").forEach((u,f)=>{u.addEventListener("click",()=>{this.config.card?.sendCommand(s,{[a]:i[f]}),h(this,_,ar).call(this)})});const d=this.root.querySelector(`[data-feat="${e}"]`);try{t(this,Y).showPopover?.()}catch{}h(this,_,Fr).call(this,d),n(this,at,()=>h(this,_,Fr).call(this,d)),window.addEventListener("scroll",t(this,at),!0),window.addEventListener("resize",t(this,at));const l=u=>{u.composedPath().some(y=>y===this.root||y===this.root.host)||h(this,_,ar).call(this)};n(this,It,l),document.addEventListener("pointerdown",l,!0)},Fr=function(e){if(!t(this,Y)||!e)return;const i=e.getBoundingClientRect(),r=window.innerHeight-i.bottom,s=i.top,a=Math.min(t(this,Y).scrollHeight||280,280),d=Math.max(140,Math.round(i.width));t(this,Y).style.left=`${Math.round(i.left)}px`,t(this,Y).style.minWidth=`${d}px`,s>=a+8||s>r?t(this,Y).style.top=`${Math.max(8,Math.round(i.top-a-6))}px`:t(this,Y).style.top=`${Math.round(i.bottom+6)}px`},ar=function(){n(this,Me,null);try{t(this,Y)?.hidePopover?.()}catch{}t(this,It)&&(document.removeEventListener("pointerdown",t(this,It),!0),n(this,It,null)),t(this,at)&&(window.removeEventListener("scroll",t(this,at),!0),window.removeEventListener("resize",t(this,at)),n(this,at,null))},Wr=function(e){const i=Math.round((t(this,mt)+e*t(this,He))*100)/100;n(this,mt,Math.max(t(this,Pt),Math.min(t(this,de),i))),h(this,_,_r).call(this),t(this,Ai).call(this)},_r=function(){const e=h(this,_,Vr).call(this,t(this,mt)),i=$t*(1-e/100),r=xt(rt-e/100*M);t(this,Yt)?.setAttribute("stroke-dashoffset",String(i)),t(this,qt)?.setAttribute("cx",String(r.x)),t(this,qt)?.setAttribute("cy",String(r.y)),t(this,hi)?.setAttribute("cx",String(r.x)),t(this,hi)?.setAttribute("cy",String(r.y));const[s,a]=t(this,mt).toFixed(1).split(".");t(this,di)&&(t(this,di).textContent=s),t(this,ci)&&(t(this,ci).textContent=`.${a}`)},kn=function(e){n(this,le,!0),t(this,lt)?.setPointerCapture(e.pointerId),h(this,_,Zr).call(this,e)},Ln=function(e){t(this,le)&&h(this,_,Zr).call(this,e)},Nr=function(e){if(t(this,le)){n(this,le,!1);try{t(this,lt)?.releasePointerCapture(e.pointerId)}catch{}t(this,Yt)&&(t(this,Yt).style.transition=""),t(this,qt)&&(t(this,qt).style.transition="")}},Zr=function(e){if(!t(this,lt))return;const i=t(this,lt).getBoundingClientRect(),r=i.left+i.width/2,s=i.top+i.height/2,a=e.clientX-r,d=-(e.clientY-s);let l=Math.atan2(d,a)*180/Math.PI;l<0&&(l+=360);let u=rt-l;u<0&&(u+=360),u>M&&(u=u>M+(360-M)/2?0:M),n(this,mt,h(this,_,Sn).call(this,u/M*100)),t(this,Yt)&&(t(this,Yt).style.transition="none"),t(this,qt)&&(t(this,qt).style.transition="none"),h(this,_,_r).call(this),t(this,Ai).call(this)},Mn=function(){this.config.card?.sendCommand("set_temperature",{temperature:t(this,mt)})},Hn=function(){const e=(i,r)=>{if(!i)return;const s=i.querySelector(".hrv-cf-value");s&&(s.textContent=it(r??"None"))};e(t(this,pi),t(this,Dt)),e(t(this,ui),t(this,mi)),e(t(this,vi),t(this,gi)),e(t(this,fi),t(this,bi))};const rs=`
    [part=card-body] {
      display: flex;
      flex-direction: column;
      align-items: center;
  ...
  `;class ns extends x{constructor(){super(...arguments);o(this,Ee,null)}render(){this.root.innerHTML=`
        <style>${rs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class os extends x{constructor(e,i,r,s){super(e,i,r,s);o(this,Rt);o(this,Te,null);o(this,Bt,null);o(this,D,null);o(this,qe,null);o(this,Ie,null);o(this,De,null);o(this,gt,null);o(this,ce,null);o(this,Ut,!1);o(this,zt,0);o(this,Si,"closed");o(this,er,{});o(this,ir);o(this,$i);n(this,ir,Zt(h(this,Rt,En).bind(this),300)),n(this,$i,Zt(h(this,Rt,Tn).bind(this),300))}render(){const e=this.def.capabilities==="read-write",i=this.config.displayHints??{},r=i.show_position!==!1&&this.def.supported_features?.includes("set_position"),s=i.show_tilt!==!1&&this.def.supported_features?.includes("set_tilt_position"),a=!this.def.supported_features||this.def.supported_features.includes("buttons");this.root.innerHTML=`
        <style>${ss}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class en extends x{constructor(e,i,r,s){super(e,i,r,s);o(this,L);o(this,Pe,null);o(this,Xt,null);o(this,O,null);o(this,U,null);o(this,ki,null);o(this,pe,null);o(this,ue,null);o(this,Kt,!1);o(this,V,0);o(this,dt,0);o(this,Ct,100);o(this,Jt,1);o(this,ve);n(this,ve,Zt(h(this,L,Dn).bind(this),300))}render(){const e=this.def.capabilities==="read-write",r=(this.config.displayHints?.display_mode??null)!=="buttons";n(this,dt,this.def.feature_config?.min??0),n(this,Ct,this.def.feature_config?.max??100),n(this,Jt,this.def.feature_config?.step??1);const s=this.def.unit_of_measurement??"";if(this.root.innerHTML=`
        <style>${as}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
            ...
            ${e?`
              ...
              <div class="hrv-num-input-row">
                ...
                <input class="hrv-num-input" type="number"
                  min="${t(this,dt)}" max="${t(this,Ct)}" step="${t(this,Jt)}"
                ...
                ${s?`<span class="hrv-num-unit">${p(s)}</span>`:""}
              </div>
            `:`
              <div class="hrv-num-readonly">
                <span class="hrv-num-readonly-val">-</span>
                ${s?`<span class="hrv-num-readonly-unit">${p(s)}</span>`:""}
              </div>
            `}
          </div>
          ${this.renderHistoryZoneHTML()}
      ...
      `,n(this,Pe,this.root.querySelector(".hrv-num-slider-track")),n(this,Xt,this.root.querySelector(".hrv-num-slider-fill")),n(this,O,this.root.querySelector(".hrv-num-slider-thumb")),n(this,U,this.root.querySelector(".hrv-num-input")),n(this,ki,this.root.querySelector(".hrv-num-readonly-val")),n(this,pe,this.root.querySelector("[part=dec-btn]")),n(this,ue,this.root.querySelector("[part=inc-btn]")),t(this,Pe)&&t(this,O)){const a=l=>{n(this,Kt,!0),t(this,O).style.transition="none",t(this,Xt).style.transition="none",h(this,L,Ar).call(this,l),t(this,O).setPointerCapture(l.pointerId)};t(this,O).addEventListener("pointerdown",a),t(this,Pe).addEventListener("pointerdown",l=>{l.target!==t(this,O)&&(n(this,Kt,!0),t(this,O).style.transition="none",t(this,Xt).style.transition="none",h(this,L,Ar).call(this,l),t(this,O).setPointerCapture(l.pointerId))}),t(this,O).addEventListener("pointermove",l=>{t(this,Kt)&&h(this,L,Ar).call(this,l)});const d=()=>{t(this,Kt)&&(n(this,Kt,!1),t(this,O).style.transition="",t(this,Xt).style.transition="",t(this,ve).call(this))};t(this,O).addEventListener("pointerup",d),t(this,O).addEventListener("pointercancel",d)}t(this,U)&&t(this,U).addEventListener("input",()=>{const a=parseFloat(t(this,U).value);isNaN(a)||(n(this,V,Math.max(t(this,dt),Math.min(t(this,Ct),a))),h(this,L,Xi).call(this),h(this,L,Ki).call(this),t(this,ve).call(this))}),t(this,pe)&&t(this,pe).addEventListener("click",()=>{n(this,V,+Math.max(t(this,dt),t(this,V)-t(this,Jt)).toFixed(10)),h(this,L,Xi).call(this),t(this,U)&&(t(this,U).value=String(t(this,V))),h(this,L,Ki).call(this),t(this,ve).call(this)}),t(this,ue)&&t(this,ue).addEventListener("click",()=>{n(this,V,+Math.min(t(this,Ct),t(this,V)+t(this,Jt)).toFixed(10)),h(this,L,Xi).call(this),t(this,U)&&(t(this,U).value=String(t(this,V))),h(this,L,Ki).call(this),t(this,ve).call(this)}),this.renderCompanions(),z(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}applyState(e,i){const r=parseFloat(e);if(isNaN(r))return;n(this,V,r),t(this,Kt)||(h(this,L,Xi).call(this),t(this,U)&&!this.isFocused(t(this,U))&&(t(this,U).value=String(r))),h(this,L,Ki).call(this),t(this,ki)&&(t(this,ki).textContent=String(r));const s=this.def.unit_of_measurement??"";this.announceState(`${this.def.friendly_name}, ${r}${s?` ${s}`:""}`)}predictState(e,i){return e==="set_value"&&i.value!==void 0?{state:String(i.value),attributes:{}}:null}}Pe=new WeakMap,Xt=new WeakMap,O=new WeakMap,U=new WeakMap,ki=new WeakMap,pe=new WeakMap,ue=new WeakMap,Kt=new WeakMap,V=new WeakMap,dt=new WeakMap,Ct=new WeakMap,Jt=new WeakMap,ve=new WeakMap,L=new WeakSet,qn=function(e){const i=t(this,Ct)-t(this,dt);return i===0?0:Math.max(0,Math.min(100,(e-t(this,dt))/i*100))},In=function(e){const i=t(this,dt)+e/100*(t(this,Ct)-t(this,dt)),r=Math.round(i/t(this,Jt))*t(this,Jt);return Math.max(t(this,dt),Math.min(t(this,Ct),+r.toFixed(10)))},Xi=function(){const e=h(this,L,qn).call(this,t(this,V));t(this,Xt)&&(t(this,Xt).style.width=`${e}%`),t(this,O)&&(t(this,O).style.left=`${e}%`)},Ar=function(e){const i=t(this,Pe).getBoundingClientRect(),r=Math.max(0,Math.min(100,(e.clientX-i.left)/i.width*100));n(this,V,h(this,L,In).call(this,r)),h(this,L,Xi).call(this),t(this,U)&&(t(this,U).value=String(t(this,V))),h(this,L,Ki).call(this)},Dn=function(){this.config.card?.sendCommand("set_value",{value:t(this,V)})},Ki=function(){t(this,pe)&&(t(this,pe).disabled=t(this,V)<=t(this,dt)),t(this,ue)&&(t(this,ue).disabled=t(this,V)>=t(this,Ct))};const hs=`
    [part=card-body] {
      display: flex;
      flex-direction: column;
      align-items: stretch;
  ...
  `;class rn extends x{constructor(){super(...arguments);o(this,P);o(this,et,null);o(this,F,null);o(this,Be,null);o(this,ur,"");o(this,fe,[]);o(this,Li,"");o(this,Qt,!1);o(this,ze,[]);o(this,te,[]);o(this,me,"pills");o(this,ge,null);o(this,ht,null)}render(){const e=this.def.capabilities==="read-write",i=this.config.displayHints?.display_mode??this.def.display_hints?.display_mode??"pills";n(this,me,i==="dropdown"?"dropdown":"pills"),n(this,fe,this.def.feature_config?.options??[]);const r=e?t(this,me)==="dropdown"?`
      ...
      `,n(this,et,this.root.querySelector(".hrv-is-selected")),n(this,F,this.root.querySelector(".hrv-is-dropdown")),n(this,Be,this.root.querySelector(".hrv-is-grid")),n(this,ze,[]),n(this,te,[]),n(this,Li,""),t(this,et)&&e&&t(this,me)==="dropdown"&&(t(this,et).addEventListener("click",s=>{s.stopPropagation(),t(this,Qt)?h(this,P,Ji).call(this):h(this,P,Yr).call(this)}),t(this,et).addEventListener("keydown",s=>{(s.key==="Enter"||s.key===" "||s.key==="ArrowDown")&&!t(this,Qt)?(s.preventDefault(),h(this,P,Yr).call(this),t(this,te)[0]?.focus()):s.key==="Escape"&&t(this,Qt)&&(h(this,P,Ji).call(this),t(this,et).focus())}),n(this,ge,s=>{t(this,Qt)&&!this.root.host.contains(s.target)&&h(this,P,Ji).call(this)}),document.addEventListener("click",t(this,ge))),this.renderCompanions(),z(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}applyState(e,i){n(this,ur,e);const r=i?.options,s=Array.isArray(r)&&r.length?r:t(this,fe);n(this,fe,s);const a=s.join("|");if(a!==t(this,Li)&&(n(this,Li,a),t(this,me)==="dropdown"?h(this,P,Bn).call(this,s):h(this,P,Pn).call(this,s)),t(this,me)==="dropdown"){const d=this.root.querySelector(".hrv-is-label");d&&(d.textContent=e);for(const l of t(this,te))l.setAttribute("data-active",String(l.dataset.option===e))}else{for(const l of t(this,ze))l.setAttribute("data-active",String(l.dataset.option===e));const d=this.root.querySelector(".hrv-is-label");d&&(d.textContent=e)}this.announceState(`${this.def.friendly_name}, ${e}`)}predictState(e,i){return e==="select_option"&&i.option!==void 0?{state:String(i.option),attributes:{options:t(this,fe)}}:null}destroy(){t(this,ge)&&(document.removeEventListener("click",t(this,ge)),n(this,ge,null)),t(this,ht)&&(window.removeEventListener("scroll",t(this,ht),!0),window.removeEventListener("resize",t(this,ht)),n(this,ht,null));try{t(this,F)?.hidePopover?.()}catch{}}}et=new WeakMap,F=new WeakMap,Be=new WeakMap,ur=new WeakMap,fe=new WeakMap,Li=new WeakMap,Qt=new WeakMap,ze=new WeakMap,te=new WeakMap,me=new WeakMap,ge=new WeakMap,ht=new WeakMap,P=new WeakSet,Pn=function(e){if(t(this,Be)){t(this,Be).innerHTML="",n(this,ze,[]);for(const i of e){const r=document.createElement("button");r.type="button",r.className="hrv-is-pill",r.dataset.option=i,r.textContent=i,r.addEventListener("click",()=>{this.config.card?.sendCommand("select_option",{option:i})}),t(this,Be).appendChild(r),t(this,ze).push(r)}}},Bn=function(e){if(t(this,F)){t(this,F).innerHTML="",n(this,te,[]);for(const i of e){const r=document.createElement("button");r.type="button",r.className="hrv-is-option",r.role="option",r.dataset.option=i,r.textContent=i,r.addEventListener("click",()=>{this.config.card?.sendCommand("select_option",{option:i}),h(this,P,Ji).call(this),t(this,et)?.focus()}),r.addEventListener("keydown",s=>{const a=t(this,te),d=a.indexOf(r);s.key==="ArrowDown"?(s.preventDefault(),a[Math.min(d+1,a.length-1)]?.focus()):s.key==="ArrowUp"?(s.preventDefault(),d===0?t(this,et)?.focus():a[d-1]?.focus()):s.key==="Escape"&&(h(this,P,Ji).call(this),t(this,et)?.focus())}),t(this,F).appendChild(r),t(this,te).push(r)}}},Gr=function(){if(!t(this,F)||!t(this,et))return;const e=t(this,et).getBoundingClientRect(),i=window.innerHeight-e.bottom,r=e.top,s=Math.min(t(this,F).scrollHeight||280,280);t(this,F).style.left=`${Math.round(e.left)}px`,t(this,F).style.width=`${Math.round(e.width)}px`,i<s+8&&r>i?t(this,F).style.top=`${Math.max(8,Math.round(e.top-s-6))}px`:t(this,F).style.top=`${Math.round(e.bottom+6)}px`},Yr=function(){if(!(!t(this,F)||!t(this,fe).length)){try{t(this,F).showPopover?.()}catch{}t(this,et)?.setAttribute("aria-expanded","true"),h(this,P,Gr).call(this),n(this,ht,()=>h(this,P,Gr).call(this)),window.addEventListener("scroll",t(this,ht),!0),window.addEventListener("resize",t(this,ht)),n(this,Qt,!0)}},Ji=function(){try{t(this,F)?.hidePopover?.()}catch{}t(this,et)?.setAttribute("aria-expanded","false"),t(this,ht)&&(window.removeEventListener("scroll",t(this,ht),!0),window.removeEventListener("resize",t(this,ht)),n(this,ht,null)),n(this,Qt,!1)};const ls=`
    [part=card-body] {
      display: flex;
      flex-direction: column;
      gap: 10px;
  ...
  `;class ds extends x{constructor(e,i,r,s){super(e,i,r,s);o(this,be);o(this,ee,null);o(this,Mi,null);o(this,Hi,null);o(this,Re,null);o(this,je,null);o(this,jt,null);o(this,B,null);o(this,Oe,null);o(this,Ve,null);o(this,Fe,!1);o(this,Ot,0);o(this,ie,!1);o(this,We,"idle");o(this,Ne,{});o(this,rr);n(this,rr,this.debounce(h(this,be,zn).bind(this),200))}render(){const e=this.def.capabilities==="read-write",i=this.def.supported_features??[],r=this.config.displayHints??{},s=r.show_transport!==!1,a=i.includes("play_pause"),d=i.includes("previous_track"),l=i.includes("next_track"),u=r.show_volume!==!1&&i.includes("volume_set"),f=r.show_volume!==!1&&i.includes("volume_mute"),y=u||f;if(this.root.innerHTML=`
        <style>${ls}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class ps extends x{constructor(){super(...arguments);o(this,Ei,null);o(this,nr,!1)}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${cs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class dr extends x{constructor(){super(...arguments);o(this,Ti,null);o(this,qi,null)}render(){const e=this.def.unit_of_measurement??"";this.root.innerHTML=`
        <style>${us}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class nn extends x{constructor(){super(...arguments);o(this,Vt,null);o(this,Ii,null);o(this,ye,!1)}render(){const e=this.def.capabilities==="read-write";if(this.root.innerHTML=`
        <style>${vs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;function cr(c){c<0&&(c=0);const v=Math.floor(c/3600),e=Math.floor(c%3600/60),i=Math.floor(c%60),r=s=>String(s).padStart(2,"0");return v>0?`${v}:${r(e)}:${r(i)}`:`${r(e)}:${r(i)}`}function sn(c){if(typeof c=="number")return c;if(typeof c!="string")return 0;const v=c.split(":").map(Number);return v.length===3?v[0]*3600+v[1]*60+v[2]:v.length===2?v[0]*60+v[1]:v[0]||0}class ms extends x{constructor(){super(...arguments);o(this,ct);o(this,bt,null);o(this,re,null);o(this,xe,null);o(this,we,null);o(this,Ze,null);o(this,Di,"idle");o(this,Pi,{});o(this,At,null);o(this,Bi,null)}render(){const e=this.def.capabilities==="read-write";this.root.innerHTML=`
        <style>${fs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class on extends x{constructor(){super(...arguments);o(this,zi,null);o(this,Ft,null);o(this,Ge,!1);o(this,Ye,!1)}render(){const e=this.def.capabilities==="read-write";n(this,Ye,!1),this.root.innerHTML=`
        <style>${gs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class As extends x{constructor(){super(...arguments);o(this,k);o(this,Ri,null);o(this,Ue,null);o(this,ji,null);o(this,Oi,null);o(this,Vi,null);o(this,Fi,null);o(this,pt,null);o(this,Wt,null);o(this,yt,null);o(this,Wi,null);o(this,Ni,null);o(this,Xe,null);o(this,Ke,null)}render(){this.root.innerHTML=`
        <style>${Cs}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
      ...
      `,n(this,Ri,this.root.querySelector(".hrv-weather-icon")),n(this,Ue,this.root.querySelector(".hrv-weather-temp")),n(this,ji,this.root.querySelector(".hrv-weather-cond")),n(this,Oi,this.root.querySelector("[data-stat=humidity] [data-value]")),n(this,Vi,this.root.querySelector("[data-stat=wind] [data-value]")),n(this,Fi,this.root.querySelector("[data-stat=pressure] [data-value]")),n(this,pt,this.root.querySelector(".hrv-forecast-strip")),n(this,Wt,this.root.querySelector(".hrv-forecast-toggle")),n(this,yt,this.root.querySelector(".hrv-forecast-scroll-track")),n(this,Wi,this.root.querySelector(".hrv-forecast-scroll-thumb")),t(this,pt)&&(t(this,pt).addEventListener("scroll",()=>h(this,k,Kr).call(this),{passive:!0}),n(this,Ni,Fn(t(this,pt)))),t(this,yt)&&t(this,yt).addEventListener("pointerdown",e=>h(this,k,Vn).call(this,e)),this.renderCompanions(),z(this.root),this._attachGestureHandlers(this.root.querySelector("[part=card]"))}destroy(){var e;(e=t(this,Ni))==null||e.call(this),n(this,Ni,null)}applyState(e,i){const r=e||"cloudy";t(this,Ri)&&(t(this,Ri).innerHTML=Mr(r,44));const s=this.i18n.t(`weather.${r}`)!==`weather.${r}`?this.i18n.t(`weather.${r}`):r.replace(/-/g," ");t(this,ji)&&(t(this,ji).textContent=s);const a=i.temperature??i.native_temperature;let d=String(i.temperature_unit||i.native_temperature_unit||this.def.unit_of_measurement||"°C").trim();if(d&&!/^°/.test(d)&&d.length<=2&&(d=`°${d}`),t(this,Ue)){const u=t(this,Ue).querySelector(".hrv-weather-unit");t(this,Ue).firstChild.textContent=a!=null?Math.round(Number(a)):"--",u&&(u.textContent=d)}if(t(this,Oi)){const u=i.humidity;t(this,Oi).textContent=u!=null?`${u}%`:"--"}if(t(this,Vi)){const u=i.wind_speed,f=i.wind_speed_unit??"";t(this,Vi).textContent=u!=null?`${u} ${f}`.trim():"--"}if(t(this,Fi)){const u=i.pressure,f=i.pressure_unit??"";t(this,Fi).textContent=u!=null?`${u} ${f}`.trim():"--"}const l=(this.config.displayHints??this.def.display_hints??{}).show_forecast===!0;n(this,Xe,l?i.forecast_daily??i.forecast??null:null),n(this,Ke,l?i.forecast_hourly??null:null),h(this,k,Ur).call(this),h(this,k,Xr).call(this),this.announceState(`${this.def.friendly_name}, ${s}, ${a??"--"} ${d}`)}}Ri=new WeakMap,Ue=new WeakMap,ji=new WeakMap,Oi=new WeakMap,Vi=new WeakMap,Fi=new WeakMap,pt=new WeakMap,Wt=new WeakMap,yt=new WeakMap,Wi=new WeakMap,Ni=new WeakMap,k=new WeakSet,Se=function(){return this.config._forecastMode??"daily"},$r=function(e){this.config._forecastMode=e},Xe=new WeakMap,Ke=new WeakMap,Ur=function(){if(!t(this,Wt))return;const e=Array.isArray(t(this,Xe))&&t(this,Xe).length>0,i=Array.isArray(t(this,Ke))&&t(this,Ke).length>0;if(!e&&!i){t(this,Wt).textContent="";return}e&&!i&&n(this,k,"daily",$r),!e&&i&&n(this,k,"hourly",$r),e&&i?(t(this,Wt).textContent=t(this,k,Se)==="daily"?"Hourly":"5-Day",t(this,Wt).onclick=()=>{n(this,k,t(this,k,Se)==="daily"?"hourly":"daily",$r),h(this,k,Ur).call(this),h(this,k,Xr).call(this)}):(t(this,Wt).textContent="",t(this,Wt).onclick=null)},Xr=function(){if(!t(this,pt))return;const e=t(this,k,Se)==="hourly"?t(this,Ke):t(this,Xe);if(t(this,pt).setAttribute("data-mode",t(this,k,Se)),!Array.isArray(e)||e.length===0){t(this,pt).innerHTML="",t(this,yt)&&(t(this,yt).hidden=!0);return}const i=t(this,k,Se)==="daily"?e.slice(0,5):e;t(this,pt).innerHTML=i.map(r=>{const s=new Date(r.datetime);let a;t(this,k,Se)==="hourly"?a=s.toLocaleTimeString([],{hour:"numeric"}):a=_s[s.getDay()]??"";const d=(r.temperature??r.native_temperature)!=null?Math.round(r.temperature??r.native_temperature):"--",l=(r.templow??r.native_templow)!=null?Math.round(r.templow??r.native_templow):null;return`
          ...
          </div>`}).join(""),t(this,k,Se)==="hourly"?requestAnimationFrame(()=>h(this,k,Kr).call(this)):t(this,yt)&&(t(this,yt).hidden=!0)},Kr=function(){const e=t(this,pt),i=t(this,yt),r=t(this,Wi);if(!e||!i||!r)return;const s=e.scrollWidth>e.clientWidth?e.clientWidth/e.scrollWidth:1;if(s>=1){i.hidden=!0;return}i.hidden=!1;const a=i.clientWidth,d=Math.max(20,s*a),l=a-d,u=e.scrollLeft/(e.scrollWidth-e.clientWidth);r.style.width=`${d}px`,r.style.left=`${u*l}px`},Vn=function(e){const i=t(this,pt),r=t(this,yt),s=t(this,Wi);if(!i||!r||!s)return;e.preventDefault();const a=r.getBoundingClientRect(),d=parseFloat(s.style.width)||20,l=y=>{const C=y-a.left-d/2,q=a.width-d,b=Math.max(0,Math.min(1,C/q));i.scrollLeft=b*(i.scrollWidth-i.clientWidth)};l(e.clientX);const u=y=>l(y.clientX),f=()=>{window.removeEventListener("pointermove",u),window.removeEventListener("pointerup",f)};window.addEventListener("pointermove",u),window.addEventListener("pointerup",f)};const Ss=`
    [part=card-body] {
      display: flex;
      flex-direction: column;
      align-items: center;
  ...
  `;class $s extends x{constructor(){super(...arguments);o(this,ne,null);o(this,Zi,null);o(this,se,!1);o(this,vr,"unknown")}render(){const e=this.def.capabilities==="read-write";if(this.root.innerHTML=`
        <style>${Ss}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class hn extends x{constructor(){super(...arguments);o(this,oe,null);o(this,fr,"unknown")}render(){const e=this.def.capabilities==="read-write";if(this.root.innerHTML=`
        <style>${Er}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
  ...
  `;class qr extends x{constructor(){super(...arguments);o(this,Gi,null)}render(){this.root.innerHTML=`
        <style>${ks}${W}</style>
        <div part="card">
          <div part="card-header">
            <span part="card-name">${p(this.def.friendly_name)}</span>
      ...
      `,n(this,Gi,this.root.querySelector(".hrv-person-circle")),this.renderIcon(this.resolveIcon(this.def.icon,"mdi:account"),"person-icon"),this.renderCompanions(),z(this.root)}applyState(e,i){const r=e==="home";t(this,Gi)&&t(this,Gi).setAttribute("data-home",String(r));const s=e==="not_home"?"Away":e==="home"?"Home":it(e),a=this.root.querySelector("[part=row-value]");a&&(a.textContent=s);const d=e==="not_home"?"mdi:account-off":"mdi:home-account",l=this.def.icon_state_map?.[e]??this.def.icon??d;this.renderIcon(this.resolveIcon(l,d),"person-icon"),this.announceState(`${this.def.friendly_name}, ${e}`)}}Gi=new WeakMap,sr(qr,"staleOnMount",!0),S._renderers=S._renderers||{};const Ls=document.currentScript&&document.currentScript.dataset.rendererId||"minimus";S._renderers[Ls]={light:Kn,fan:Qn,lock:$s,script:hn,automation:ln,button:Tr,input_button:Tr,climate:is,binary_sensor:ns,cover:os,input_boolean:nn,input_number:en,number:en,input_select:rn,select:rn,media_player:ds,remote:ps,sensor:dr,"sensor.temperature":dr,"sensor.humidity":dr,"sensor.battery":dr,switch:nn,person:qr,device_tracker:qr,event:on,timer:ms,weather:As,generic:on,badge:null}})();})();
